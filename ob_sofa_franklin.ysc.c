	...
	switch (iLocal_304)
	{
		...
		case 5:
			...
			if (unk_0xBFC0798A6E3417F9(2, 51))
			{
				if (!iLocal_320)
				{
					if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_tv_watched"), &iLocal_329, -1))
					{
		...
		case 13:
			...
			if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_sofa_used"), &iLocal_330, -1))
			{
...
void func_49(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				iLocal_325 = unk_0xC1879030EB463216("scr_sh_lighter_flame", func_52(), 0f, 0f, 0.05f, 0f, 0f, 0f, 1f, 0, 0, 0);
				iLocal_306 = 1;
			}
			...
			{
				iLocal_324 = unk_0xC1879030EB463216("scr_sh_cig_smoke", func_54(), -0.09f, 0f, 0f, 0f, 0f, 0f, 1f, 0, 0, 0);
				iLocal_321 = 1;
			}
...
void func_64()
{
	if (unk_0xBFC0798A6E3417F9(2, 224))
	{
		...
		if (unk_0x6FB46C25CCB7E6D5(joaat("num_sh_sofa_smoked"), &iLocal_328, -1))
		{
