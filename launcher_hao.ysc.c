...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			if (!func_199(-72.323f, -1258.643f, 28.648f, unk_0x68F4C0EC296D3901(Var0.f_35[0], true), 1056964608))
			{
...
int func_183(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(uParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - uParam0->f_60) > iParam6) && func_187(unk_0x16F2683693E537C9(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_35[0]))
			{
				...
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 0, 2, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 1, 1, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 2, 1, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 3, 1, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 4, 1, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 6, 0, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 7, 2, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 10, 0, false);
				unk_0xEE6A1776A67F70C1(uParam0->f_35[0], 23, 20, false);
				unk_0x73BEC6F1685574E6(uParam0->f_35[0], 18, true);
				unk_0x73BEC6F1685574E6(uParam0->f_35[0], 17, true);
				unk_0x73BEC6F1685574E6(uParam0->f_35[0], 22, true);
		...
		case 3:
			...
			{
				iVar5 = unk_0xF653B9B22DA806A9(uParam0->f_35[0], "chassis_dummy");
				vVar6 = { unk_0xBF584557291FDD31(uParam0->f_35[0], iVar5) };
				iVar2 = unk_0xE9744DB7B8CA6965(vVar6, unk_0x835730A2D89F6093(uParam0->f_35[0], 2), 2);
				unk_0xC90224D9E95E5E3A(iVar2, true);
				unk_0xEFC3DF9D33E248D8(iVar2, false);
				unk_0x915804B434753CBD(uParam0->f_28[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
