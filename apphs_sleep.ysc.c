...
void func_12()
{
	if (Global_19464 == 0)
	{
		if (func_11(2, Global_19455, 0))
		{
			...
			Global_8161[Global_19486 /*2811*/][iLocal_23 /*281*/].f_259 = iLocal_18[unk_0xA52833FE33F41C53(uLocal_21)];
		...
		while (iVar2 < 9)
		{
			if (Global_8161[Global_19486 /*2811*/][iLocal_23 /*281*/].f_124[iVar2] == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					...
					{
						iVar3 = iVar2;
						func_20(Global_19467, "SET_DATA_SLOT", to_float(13), to_float(iVar1), to_float(Global_8161[Global_19486 /*2811*/][iLocal_23 /*281*/].f_104[iVar3]), -1f, -1f, &(Global_8161[Global_19486 /*2811*/][iLocal_23 /*281*/].f_7[iVar3 /*4*/]), 0, 0, 0, 0);
					}
				}
			}
			iVar2++;
			...
			if (Global_8161[Global_19486 /*2811*/][iVar2 /*281*/].f_280 == 1)
			{
				if (iVar0[iVar2] == 0)
				{
					if (iVar2 == 0)
					{
						...
						{
							iVar3 = iVar2;
							func_20(Global_19467, "SET_DATA_SLOT", to_float(2), to_float(iVar1), -1f, -1f, -1f, &(Global_8161[Global_19486 /*2811*/][iVar3 /*281*/].f_2), 0, 0, 0, 0);
						}
					}
				}
			}
