	...
	while (iVar0 < 20)
	{
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0xA6FF0828D17CF374(iVar1, vVar2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				else if (vdist2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x2D7B5CDDF12654D2(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
{
	return (shift_right(iParam0, 26) & 31 * func_12(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
