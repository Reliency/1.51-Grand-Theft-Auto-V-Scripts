	...
	while (true)
	{
		if (Global_41431 != 15)
		{
			if (Global_41394 != 0)
			{
				if (Global_41393 != -1)
				{
					if (!unk_0x1727A44C562FBED2(Global_41394))
					{
		...
		if (Global_41392 > 0)
		{
			...
			if (Global_41392 == iVar0)
			{
				...
				if (Global_41392 > 1)
				{
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < Global_41392)
					{
						if (func_15(Global_41398[iVar4 /*4*/].f_2))
						{
							iVar2[iVar4] = 0;
						}
						else
					...
					iVar4 = 0;
					iVar4 = 0;
					while (iVar4 < (Global_41392 - 1))
					{
						if (!iVar2[iVar4 + 1])
						{
							if (Global_41398[iVar4 + 1 /*4*/].f_1 < Global_41398[iVar5 /*4*/].f_1)
							{
								iVar5 = iVar4 + 1;
							}
						}
					...
					iVar3 = iVar5;
					if (Global_41398[iVar3 /*4*/].f_2 == 15)
					{
						iVar3 = -1;
					}
					if (iVar3 != -1)
					{
						if (!func_15(Global_41398[iVar3 /*4*/].f_2))
						{
							iVar3 = -1;
						}
					}
				...
				if (iVar3 > -1)
				{
					Global_41393 = Global_41398[iVar3 /*4*/];
					Global_41394 = Global_41398[iVar3 /*4*/].f_3;
					Global_41431 = Global_41398[iVar3 /*4*/].f_2;
					Global_41392 = 0;
					Global_41397 = 0;
				}
				else
		...
		Global_31043 = unk_0xDDD4A799D5B1FDA5();
		wait(0);
	}
	Global_41397 = 0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_7(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
