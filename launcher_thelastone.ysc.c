...
int func_184(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(unk_0x16F2683693E537C9()) && func_127(uParam0->f_28[0])) && (unk_0x1C0640BA9A7327B3() - uParam0->f_60) > iParam6) && func_190(unk_0x16F2683693E537C9(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
...
int func_238(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0x36F2404464202779(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
