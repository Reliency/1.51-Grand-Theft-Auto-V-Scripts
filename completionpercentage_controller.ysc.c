	...
	while (true)
	{
		...
		if (iLocal_49 == 1)
		{
			if (!iLocal_46)
			{
				if (!iLocal_47)
				{
					...
					unk_0x52B251794E939181(iLocal_50, "tot_pc", Global_111638.f_10189.f_3853);
					...
					while (iLocal_58 < 321)
					{
						if (!Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 0)
						{
							if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 1 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 2)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_28[iLocal_34] = unk_0x0A4390627648FB60(uLocal_53);
									unk_0xA5E4E40E663470ED(uLocal_28[iLocal_34], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_28[iLocal_34], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 1)
									{
										unk_0x831B5C68F1E66F2D(uLocal_28[iLocal_34], "100", 1);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_28[iLocal_34], "100", 0);
									}
									vLocal_40 = { func_125(iLocal_58) };
									unk_0x23AFD3CA3C9BE63F(uLocal_28[iLocal_34], "x", round(vLocal_40.x));
									unk_0x23AFD3CA3C9BE63F(uLocal_28[iLocal_34], "y", round(vLocal_40.y));
									iLocal_34++;
								}
							}
							if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 3 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 4)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_29[iLocal_35] = unk_0x0A4390627648FB60(uLocal_52);
									unk_0xA5E4E40E663470ED(uLocal_29[iLocal_35], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_29[iLocal_35], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 3)
									{
										unk_0x831B5C68F1E66F2D(uLocal_29[iLocal_35], "100", 1);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_29[iLocal_35], "100", 0);
									}
									vLocal_40 = { func_125(iLocal_58) };
									unk_0x23AFD3CA3C9BE63F(uLocal_29[iLocal_35], "x", round(vLocal_40.x));
									unk_0x23AFD3CA3C9BE63F(uLocal_29[iLocal_35], "y", round(vLocal_40.y));
									iLocal_35++;
								}
							}
							if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 5 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 6)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_30[iLocal_36] = unk_0x0A4390627648FB60(uLocal_54);
									unk_0xA5E4E40E663470ED(uLocal_30[iLocal_36], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_30[iLocal_36], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 5)
									{
										unk_0x831B5C68F1E66F2D(uLocal_30[iLocal_36], "100", 1);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_30[iLocal_36], "100", 0);
									}
									vLocal_40 = { func_125(iLocal_58) };
									unk_0x23AFD3CA3C9BE63F(uLocal_30[iLocal_36], "x", round(vLocal_40.x));
									unk_0x23AFD3CA3C9BE63F(uLocal_30[iLocal_36], "y", round(vLocal_40.y));
									iLocal_36++;
								}
							}
							if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 7 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 8)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_32[iLocal_37] = unk_0x0A4390627648FB60(uLocal_55);
									unk_0xA5E4E40E663470ED(uLocal_32[iLocal_37], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_32[iLocal_37], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 7)
									{
										unk_0x831B5C68F1E66F2D(uLocal_32[iLocal_37], "100", 1);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_32[iLocal_37], "100", 0);
									}
									vLocal_40 = { func_125(iLocal_58) };
									unk_0x23AFD3CA3C9BE63F(uLocal_32[iLocal_37], "x", round(vLocal_40.x));
									unk_0x23AFD3CA3C9BE63F(uLocal_32[iLocal_37], "y", round(vLocal_40.y));
									iLocal_37++;
								}
							}
							if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 9 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 10)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_31[iLocal_38] = unk_0x0A4390627648FB60(uLocal_56);
									unk_0xA5E4E40E663470ED(uLocal_31[iLocal_38], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_31[iLocal_38], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 9)
									{
										unk_0x831B5C68F1E66F2D(uLocal_31[iLocal_38], "100", 0);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_31[iLocal_38], "100", 0);
									}
									unk_0x23AFD3CA3C9BE63F(uLocal_31[iLocal_38], "x", round(Global_111638.f_10189[iLocal_58 /*12*/].f_10));
									unk_0x23AFD3CA3C9BE63F(uLocal_31[iLocal_38], "y", round(Global_111638.f_10189[iLocal_58 /*12*/].f_11));
									iLocal_38++;
								}
							}
							if (((Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 11 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 13) || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 12) || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 14)
							{
								if (Global_111638.f_10189[iLocal_58 /*12*/].f_5 || Global_111373 == 1)
								{
									uLocal_33[iLocal_39] = unk_0x0A4390627648FB60(uLocal_57);
									unk_0xA5E4E40E663470ED(uLocal_33[iLocal_39], "nm", &(Global_111638.f_10189[iLocal_58 /*12*/]));
									unk_0x831B5C68F1E66F2D(uLocal_33[iLocal_39], "cmp", Global_111638.f_10189[iLocal_58 /*12*/].f_5);
									if (Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 11 || Global_111638.f_10189[iLocal_58 /*12*/].f_6 == 13)
									{
										unk_0x831B5C68F1E66F2D(uLocal_33[iLocal_39], "100", 1);
									}
									else
									{
										unk_0x831B5C68F1E66F2D(uLocal_33[iLocal_39], "100", 0);
									}
									vLocal_40 = { func_125(iLocal_58) };
									unk_0x23AFD3CA3C9BE63F(uLocal_33[iLocal_39], "x", round(vLocal_40.x));
									unk_0x23AFD3CA3C9BE63F(uLocal_33[iLocal_39], "y", round(vLocal_40.y));
									iLocal_39++;
								}
							}
						}
		...
		if (Global_111638.f_10189.f_3854 == 0)
		{
			if (Global_111638.f_10189.f_3853 == 100f || Global_111638.f_10189.f_3853 > 100f)
			{
				...
				func_28(57);
				unk_0x5D96D8530B3D0904(&(Global_111638.f_18569[57 /*6*/]), 1);
				func_15(13, 1);
			}
		}
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_38(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_49(int iParam0)
{
	...
	func_50(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_50(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_50(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_38(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
Vector3 func_125(int iParam0)
{
	...
	switch (func_140(iParam0))
	{
		case 1:
			...
			if (iVar0 != -1)
			{
				iVar2 = Global_89532[iVar0 /*34*/].f_10;
				if (iVar2 != 263)
				{
...
{
	return shift_right(Global_111638.f_10189[iParam0 /*12*/].f_8, 7) & 127;
}
...
void func_149()
{
	...
	if (fVar0 > (1609.344f * 50000f))
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_111638.f_10189.f_3855, 2))
		{
			...
			unk_0x5D96D8530B3D0904(&(Global_111638.f_10189.f_3855), 0);
			unk_0x5D96D8530B3D0904(&(Global_111638.f_10189.f_3855), 1);
			unk_0x5D96D8530B3D0904(&(Global_111638.f_10189.f_3855), 2);
		}
	}
	if (fVar0 > (1609.344f * 5000f))
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_111638.f_10189.f_3855, 1))
		{
	...
	if (fVar0 > (1609.344f * 500f))
	{
		if (!unk_0xEAE0D21A50E6C7F4(Global_111638.f_10189.f_3855, 0))
		{
