...
void func_4()
{
	...
	if (Global_19482 == 0)
	{
		while (iVar0 < 5)
		{
			func_7(Global_19467, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar0 /*6*/]), 0, 0, 0, 0);
	...
	if (Global_19482 == 1)
	{
		...
		while (iVar0 < 5)
		{
			if (Local_32[iVar1 /*6*/].f_5 > 0)
			{
				...
				{
					func_7(Global_19467, "SET_DATA_SLOT", to_float(18), to_float(iLocal_21), to_float(0), -1f, -1f, &(Local_32[iVar1 /*6*/]), 0, 0, 0, 0);
...
void func_10()
{
	...
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			uLocal_30 = unk_0x7A8BB56B212464AC();
			while (!unk_0xC95D7AEEDEF4946B(uLocal_30))
			{
				wait(0);
			}
			iVar0 = unk_0xA52833FE33F41C53(uLocal_30);
...
void func_15()
{
	if (Global_19464 == 0)
	{
		if (func_9(2, Global_19455, 0))
		{
			...
			iLocal_29 = unk_0xA52833FE33F41C53(uLocal_30);
			if (Global_19486.f_1 > 3)
			{
				Global_19486.f_1 = 8;
				if (iLocal_29 == 0)
...
void func_16()
{
	...
	else
	{
		...
		{
			func_7(Global_19467, "SET_DATA_SLOT", to_float(18), to_float(iVar0), to_float(0), -1f, -1f, &(Global_93536[iVar0 /*4*/]), 0, 0, 0, 0);
			iLocal_21++;
