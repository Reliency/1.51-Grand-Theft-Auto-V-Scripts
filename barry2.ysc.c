...
void __EntryFunction__()
{
	...
	if (unk_0x2EBF608FFE6CA406(19))
	{
		...
		unk_0xC92DB9682A650680("RC18B_END");
		func_631(1);
		func_626();
	}
	func_593();
	unk_0x752C7D5696C0D8A0(1);
	func_592(vLocal_105, 200f, &vVar0, &vVar1);
	func_591(iLocal_287);
	func_591(iLocal_290);
	func_591(iLocal_285);
	if (func_590(0))
	...
	while (true)
	{
		unk_0x1A6DFFFEEC27BF4F("SF_GRT", 0);
		func_574(Local_94.f_9, 0, 0, 0, 0, 0);
		iLocal_118 = 0;
		iLocal_513 = 0;
		fLocal_297 = (fLocal_297 + unk_0x6117725E0134737F());
		func_573();
		...
		if (func_37())
		{
			if (unk_0x562F77A7F33D2E46(sLocal_248))
			{
				unk_0x58350770D73D313A(sLocal_248, "DrugsEffect", ((sin((((to_float(unk_0x1C0640BA9A7327B3()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
			func_32();
			func_1();
		}
...
void func_1()
{
	...
	if (unk_0x1C0640BA9A7327B3() < iLocal_309)
	{
		return;
	}
	if (!bLocal_306)
	...
	func_25(&uLocal_335, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
	if (func_2(&uLocal_335, "BARY2AU", "BARY2_FREAK", 6, 0, 0, 0))
	{
		iLocal_309 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(20000, 40000));
		if ((iLocal_308 - unk_0x1C0640BA9A7327B3()) < 2500)
		{
			iLocal_308 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(3000, 5000));
		}
	}
}
...
void func_32()
{
	if (bLocal_114)
	{
		if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_111[0 /*3*/], Local_111[1 /*3*/], Local_111.f_7, 0, 1, 0))
		{
			func_36("B2_WARN", 7500, 1);
			func_35(&iLocal_116);
			iLocal_116 = func_34(vLocal_105, 5, 1);
			iLocal_115 = unk_0x1C0640BA9A7327B3() + 10000;
			bLocal_114 = false;
		}
	}
	else if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_112[0 /*3*/], Local_112[1 /*3*/], Local_112.f_7, 0, 1, 0))
	{
		func_36("B2_PRIME", 7500, 1);
		func_35(&iLocal_116);
		bLocal_114 = true;
	}
	else if (!unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), Local_110[0 /*3*/], Local_110[1 /*3*/], Local_110.f_7, 0, 1, 0))
	{
		if (unk_0x1C0640BA9A7327B3() > iLocal_115)
		{
		}
		func_33("B2_FAIL2");
	}
...
int func_34(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
...
void func_38(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_77();
			func_72(1);
			unk_0x13896FDECC859926("RC18B_END");
			if (unk_0xEA6BC48857E0AC4C(sLocal_96))
			{
				func_631(1);
			}
			else
		...
		case 2:
			...
			else if (unk_0x7F8A39872A07D2CE(sLocal_96, "B2_FAIL2"))
			{
...
int func_39(int iParam0)
{
	...
	if (unk_0x75EECC9B0572F772())
	{
		...
		unk_0xA2888AACD3C45CCA(sLocal_239, 1, 0, 0, 0);
	}
	switch (iLocal_98)
	{
		case 0:
			...
			iLocal_98 = 1;
			unk_0x7800CEC090C01D4D(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 2f);
			break;
		...
		case 1:
			if (iParam0 == 0)
			{
				...
				{
					unk_0x15AFB6CBDE990FB6(iLocal_100, 1, 0);
				}
			}
			iVar2 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", unk_0x07DAF5424BC6779A(), unk_0x3B276DB863622D2E(2), unk_0xE758B7099799F42F(), 1, 2);
			vVar0 = { unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1) - unk_0x07DAF5424BC6779A() };
			unk_0xC5940439E4EB9A33(iVar2, unk_0x16F2683693E537C9(), -vVar0, 1);
			if (unk_0x9F4FE516EAACCFC5(iVar2))
			{
				unk_0xE3BB8E05FCEB3FBE(iVar2, true);
			}
			iLocal_95 = unk_0x1C0640BA9A7327B3() + 6000;
			func_25(&uLocal_335, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
			iLocal_98 = 2;
			break;
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_2(&uLocal_335, "BARY2AU", "BARY2_PREOUT", 8, 0, 0, 0) || unk_0x1C0640BA9A7327B3() > iLocal_95)
				{
					if (unk_0x1C0640BA9A7327B3() < iLocal_95)
					{
					}
					iLocal_95 = unk_0x1C0640BA9A7327B3() + 5000;
					bVar1 = true;
				}
			}
			else
			{
				iLocal_95 = unk_0x1C0640BA9A7327B3() + 2000;
				bVar1 = true;
			}
			if (bVar1 == 1)
			{
		...
		case 3:
			...
			if (iParam0 == 1)
			{
				...
				{
					func_49();
					unk_0x82A772610883F395(sLocal_245, 0, 0);
					iLocal_95 = unk_0x1C0640BA9A7327B3() + 3500;
					bVar1 = true;
				}
			}
			else
		...
		case 4:
			if (iParam0 == 1)
			{
				bVar1 = unk_0x1C0640BA9A7327B3() > iLocal_95;
			}
			else
			{
				if (unk_0x1C0640BA9A7327B3() < iLocal_95)
				...
				iLocal_100 = func_41(unk_0x16F2683693E537C9(), 1, 0, 0, 0, 0);
				if (unk_0xC844350D5D58C99A(iLocal_100))
				{
					if (func_50(unk_0x16F2683693E537C9()))
					{
						...
						if (func_50(iLocal_100) && unk_0xD59B17D2DFF98E26(iLocal_100))
						{
							unk_0x15AFB6CBDE990FB6(iLocal_100, 1, 0);
						}
						bVar1 = true;
		...
		case 5:
			if (unk_0x1C0640BA9A7327B3() > iLocal_95)
			{
				if (iParam0 == 1)
				{
					...
					if (unk_0x9F4FE516EAACCFC5(iVar2))
					{
						unk_0xE3BB8E05FCEB3FBE(iVar2, false);
						unk_0x9A8DDC7C522F5BF5(iVar2, 0);
					}
					unk_0x0525F87A0751EA62("DRUNK_SHAKE", 0f);
					unk_0x9A82EEAF6CA12AEE(1f);
					unk_0xBA4AFD9D5C7A6F8D("BARRY_02_SLOWMO");
					unk_0x7352ACF3368DF65F("AllowScriptedSpeechInSlowMo", 0);
					unk_0x7352ACF3368DF65F("AllowAmbientSpeechInSlowMo", 0);
					unk_0x28F5E4DA506AC0CA(vLocal_107, 200f, 0, 0, 0, 0, false, 0);
					unk_0x58B5D6A0F1D7754D(vLocal_107, 500f);
					if (func_50(unk_0x16F2683693E537C9()))
					{
...
int func_42(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)
{
	...
	while (func_46(iVar2, iVar6) != 0)
	{
		if (!unk_0x437347B10A200C4B(iParam0, 0))
		{
			if (unk_0xAFB8387ED2D7213E(iParam0, iVar2, func_46(iVar2, iVar6)))
			{
				if (func_45(func_46(iVar2, iVar6)))
				{
					iVar7 = unk_0xE8213142E3A84F79(func_46(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_46(iVar2, iVar6) != 0)
	{
		if (!unk_0x437347B10A200C4B(iParam0, 0))
		{
			if (unk_0xAFB8387ED2D7213E(iParam0, iVar2, func_46(iVar2, iVar6)))
			{
				unk_0x3599C729CF725E87(iVar1, func_46(iVar2, iVar6));
...
void func_49()
{
	if (unk_0xED4934AFB6EC6451(sLocal_243))
	{
		unk_0x9A1335ECD7BD117F(sLocal_243);
	}
	if (unk_0xED4934AFB6EC6451(sLocal_244))
	{
		unk_0x9A1335ECD7BD117F(sLocal_244);
	}
	if (unk_0xED4934AFB6EC6451(sLocal_245))
	{
		unk_0x9A1335ECD7BD117F(sLocal_245);
	}
}
...
{
	func_66(&(Global_105187.f_2890), vParam0, fParam1);
}
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		...
		while (iVar0 < Local_250)
		{
			if (func_78(&(Local_250[iVar0 /*19*/])))
			{
				...
				unk_0xEEB67C3D0A71A47B(Local_250[iVar0 /*19*/].f_3, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 400f, -1, 0, 0);
			}
			iVar0++;
		}
	}
...
bool func_78(var uParam0)
{
	...
	return ((!uParam0->f_1 && !uParam0->f_2 == 17) && !unk_0xEB6A8945D1AC98A1(uParam0->f_3));
}
...
void func_81(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			func_51("bar_4_rcm", 0);
			func_388(vLocal_107, 1112014848, 12, 5000, 0, 0);
		...
		case 1:
			...
			unk_0x3AD9788FCCF30A22(sLocal_500, 1);
			if (func_309(1, 1093140480, 0) && unk_0x1FBF08B001C4788A("postRC_Barry1and2"))
			{
				if (func_50(unk_0x16F2683693E537C9()))
				{
					unk_0x759A5E1D0F0A31A1(unk_0x16F2683693E537C9());
				...
				func_303();
				iLocal_249 = 0;
				unk_0x28F5E4DA506AC0CA(vLocal_107, 250f, 0, 0, 0, 0, false, 0);
				unk_0x745CE398A4B0A3C6(vLocal_107, 50f, 0);
				unk_0x75CFD6AD66ADFDD1(vLocal_107, 30f, 0);
				unk_0x58B5D6A0F1D7754D(vLocal_107, 500f);
				unk_0x29E8331978B73E7F(0, sLocal_239, 2, func_648(49), 0);
				unk_0x29E8331978B73E7F(0, sLocal_241, 2, joaat("prop_protest_table_01"), 0);
				unk_0x29E8331978B73E7F(0, sLocal_240, 2, joaat("prop_chair_08"), 0);
				if (func_62(unk_0x16F2683693E537C9()))
				{
				...
				unk_0x43CACCFE7097F6AD(183.434f, -949.1876f, 30.8535f, func_299(-3f, 0f, 72.9999f));
				*iParam0 = 2;
			}
			break;
		...
		case 2:
			...
			else
			{
				...
				if (iVar0 > 15000)
				{
					if (func_295(unk_0x16F2683693E537C9(), 10000, 0))
					{
					}
				}
				if (!iLocal_249)
				...
				{
					func_294(unk_0x16F2683693E537C9(), 180.1684f, -948.6075f, 29.0919f);
					unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 73f);
					unk_0xBD453909DC26A85D(unk_0x16F2683693E537C9(), -530524, 0, 1, 0);
					unk_0x5A9FF5F994E904B8(unk_0xD803B885F5E47A62(), 2f, 750, 0, 1, 0);
					iLocal_249 = 1;
				}
				...
				{
					if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_239, 0)))
					{
						Local_94.f_28[0] = unk_0x940C1429253D3B1B(unk_0x6450C2A9FBA3C3BF(sLocal_239, 0));
						unk_0x9A28E8CB86CD4694(Local_94.f_28[0], 1, 0, 0, false);
					}
				}
				if (!func_62(Local_94.f_41[0]))
				{
					if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_241, 0)))
					{
						Local_94.f_41[0] = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_241, 0));
					}
				}
				if (!func_62(Local_94.f_41[1]))
				{
					if (unk_0xC844350D5D58C99A(unk_0x6450C2A9FBA3C3BF(sLocal_240, 0)))
					{
						Local_94.f_41[1] = unk_0x486F67509A82DB2D(unk_0x6450C2A9FBA3C3BF(sLocal_240, 0));
					}
				}
				if (unk_0x6C5C04371BEAC34E(sLocal_241, 0))
				{
					if (func_62(Local_94.f_41[0]) && func_62(Local_94.f_41[2]))
					{
						unk_0x9F528B1B53FBC5D9(Local_94.f_41[2], Local_94.f_41[0], 0, 0f, -0.25f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
					}
				}
			}
			break;
		...
		case 3:
			...
			func_63(1, 1, 1, 1);
			func_294(unk_0x16F2683693E537C9(), vLocal_107);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), fLocal_108);
			unk_0xEF6276132B396452(0f, 1065353216);
			unk_0x2FB9A57162E54BAB(0f);
			wait(250);
			func_302(250, 0);
...
void func_82()
{
	if (unk_0x440C646F2F11A2A1(unk_0x16F2683693E537C9(), iLocal_255, 0))
	{
		unk_0xDAB3108F02A4255A(unk_0x16F2683693E537C9(), 0, iLocal_255);
	}
	unk_0xE3A2D2E900FEFBE7(unk_0x16F2683693E537C9(), 1);
	func_288(&Global_102203);
	if (func_62(unk_0x16F2683693E537C9()))
	{
		func_275(unk_0x16F2683693E537C9(), 1, 0);
	}
...
void func_86()
{
	...
	{
		func_88(13, floor(Global_111638.f_10189.f_3853));
	}
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		if (unk_0xD2C792E5A65B6BF1(iParam0, func_153(iParam1)) > 0 && unk_0x0F84621831DD8D8A(iParam0, func_153(iParam1), Global_76434[1 /*14*/].f_3) > 0)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, 0);
		}
	}
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xEAE0D21A50E6C7F4(Global_76434[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_153(iVar0), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_153(iVar0)));
						}
						else
						{
							unk_0x64F9F278AB9DCA2C(iParam0, func_153(iVar0), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, iParam4);
						}
						func_144(iVar0);
						if (Global_76432 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, unk_0xAA973E78065E07A0(iParam0, func_153(iParam1)));
		}
		else
		{
			unk_0x64F9F278AB9DCA2C(iParam0, func_153(iParam1), Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4, iParam4);
		}
		if (Global_76432 == 1)
		{
			iVar2 = 0;
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_136(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_153(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_131(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_131(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_131(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_131(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_164(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_164(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_153(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
int func_225(int iParam0, int iParam1, int iParam2)
{
	...
	else if (Global_76434[1 /*14*/].f_3 == unk_0x36C584991B4C183F(iParam0, func_153(iParam1)) && Global_76434[1 /*14*/].f_4 == unk_0xDADA8E1DD0D0D9D9(iParam0, func_153(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_232(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_233(&sVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_275(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_16(iVar0) && !unk_0xEB6A8945D1AC98A1(iParam0))
	{
		...
		while (iVar1 <= (8 - 1))
		{
			...
			if (bParam2)
			{
				if (iVar1 == Global_111638.f_2358.f_539.f_1763 || (Global_111638.f_2358.f_539.f_1763 == -1 && iVar1 == 4))
				{
					...
					{
						if (unk_0x440C646F2F11A2A1(iParam0, Global_111638.f_2358.f_539.f_1730[iVar1 /*4*/][iVar0], 0))
						{
							unk_0x5745EA6329A91E29(iParam0, Global_111638.f_2358.f_539.f_1730[iVar1 /*4*/][iVar0], true);
						}
					}
				}
			}
		...
		if (iVar0 == 0)
		{
			unk_0x6FB46C25CCB7E6D5(joaat("sp0_parachute_current_tint"), &uVar2, -1);
		}
		else if (iVar0 == 1)
		{
			unk_0x6FB46C25CCB7E6D5(joaat("sp1_parachute_current_tint"), &uVar2, -1);
		}
		else if (iVar0 == 2)
		{
			unk_0x6FB46C25CCB7E6D5(joaat("sp2_parachute_current_tint"), &uVar2, -1);
		}
		unk_0xF8918B9BC7ADC372(unk_0xD803B885F5E47A62(), uVar2);
	}
}
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar13)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!unk_0x232048AB4B0E0259(Var9) && !func_282(Var9.f_1))
						{
							if (iVar7 == 0)
							{
			...
			if ((iVar8 != -1 && iVar8 < 51) && !func_282(Var9.f_1))
			{
				...
				if (iVar3 != 0)
				{
					if (iVar3 != joaat("weapon_unarmed"))
					{
						...
						if (unk_0x440C646F2F11A2A1(iParam0, iVar3, 0))
						{
							unk_0x85B7F19165B3206C(iParam0, iVar3, uParam1->f_221[iVar11 /*5*/].f_3);
						}
						iVar12 = 0;
						iVar6 = 0;
						while (iVar6 < unk_0xAD2A7A6DFF55841B(iVar8))
						{
							if (unk_0x31D5E073B6F93CDC(iVar8, iVar6, &Var10))
							{
								...
								{
									if (unk_0xEAE0D21A50E6C7F4(uParam1->f_221[iVar11 /*5*/].f_2, iVar12))
									{
										if (!unk_0xAFB8387ED2D7213E(iParam0, iVar3, Var10.f_3))
										{
											...
											{
												unk_0x0E8D2351A8BAC879(iParam0, iVar3, Var10.f_3, uParam1->f_221[iVar11 /*5*/].f_4);
...
bool func_283(int iParam0)
{
	...
	if (iParam0 == -61829581)
	{
		if (unk_0x8CD06866876216F2() && func_286())
		{
			return 1;
		}
		else
	...
	switch (iParam0)
	{
		...
		case joaat("weapon_railgun"):
			if (!func_284() || unk_0x8CD06866876216F2())
			{
				return 0;
			}
			break;
	...
	while (iVar0 < unk_0x037F36BEA9A47381())
	{
		if (unk_0x6532540B34EE6273(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0x232048AB4B0E0259(Var1) || func_282(Var1.f_1))
				{
					return 0;
				}
			}
...
void func_289(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			case 0:
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_purch_0"), uParam0->f_2244[iVar0 /*32*/][0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_purch_1"), uParam0->f_2244[iVar0 /*32*/][1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_addon_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_addon_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_addon_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_addon_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_addon_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_5"), uParam0->f_2244[iVar0 /*32*/].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_6"), uParam0->f_2244[iVar0 /*32*/].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_7"), uParam0->f_2244[iVar0 /*32*/].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_8"), uParam0->f_2244[iVar0 /*32*/].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_9"), uParam0->f_2244[iVar0 /*32*/].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_10"), uParam0->f_2244[iVar0 /*32*/].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp0_weap_tint_purch_11"), uParam0->f_2244[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 1:
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_purch_0"), uParam0->f_2244[iVar0 /*32*/][0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_purch_1"), uParam0->f_2244[iVar0 /*32*/][1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_addon_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_addon_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_addon_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_addon_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_addon_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_5"), uParam0->f_2244[iVar0 /*32*/].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_6"), uParam0->f_2244[iVar0 /*32*/].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_7"), uParam0->f_2244[iVar0 /*32*/].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_8"), uParam0->f_2244[iVar0 /*32*/].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_9"), uParam0->f_2244[iVar0 /*32*/].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_10"), uParam0->f_2244[iVar0 /*32*/].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp1_weap_tint_purch_11"), uParam0->f_2244[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 2:
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_purch_0"), uParam0->f_2244[iVar0 /*32*/][0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_purch_1"), uParam0->f_2244[iVar0 /*32*/][1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_addon_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_5[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_addon_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_5[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_addon_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_5[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_addon_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_5[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_addon_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_5[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_0"), uParam0->f_2244[iVar0 /*32*/].f_16[0], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_1"), uParam0->f_2244[iVar0 /*32*/].f_16[1], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_2"), uParam0->f_2244[iVar0 /*32*/].f_16[2], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_3"), uParam0->f_2244[iVar0 /*32*/].f_16[3], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_4"), uParam0->f_2244[iVar0 /*32*/].f_16[4], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_5"), uParam0->f_2244[iVar0 /*32*/].f_16[5], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_6"), uParam0->f_2244[iVar0 /*32*/].f_16[6], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_7"), uParam0->f_2244[iVar0 /*32*/].f_16[7], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_8"), uParam0->f_2244[iVar0 /*32*/].f_16[8], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_9"), uParam0->f_2244[iVar0 /*32*/].f_16[9], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_10"), uParam0->f_2244[iVar0 /*32*/].f_16[10], 1);
				unk_0xCDC520E5E48E63D9(joaat("sp2_weap_tint_purch_11"), uParam0->f_2244[iVar0 /*32*/].f_16[11], 1);
				break;
		}
		iVar0++;
	}
...
void func_292(int iParam0, int iParam1)
{
	...
	fVar1 = 23.45f;
	func_293(iParam0, iParam1, vVar0, fVar1);
}

void func_293(int iParam0, int iParam1, vector3 vParam2, float fParam3)
{
	func_40(iParam0);
	*iParam0 = unk_0x7707E48765093646(iParam1, vParam2, 1, true, 0);
...
void func_300(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)
{
	...
	if (unk_0xE1DBBD6CE209517C(iVar0))
	{
		...
		if (iParam4 == 1)
		{
			unk_0x745CE398A4B0A3C6(func_301(unk_0xA30EC016B12C03E4()), 50f, 0);
		}
		if (iParam5 == 1)
		{
...
void func_303()
{
	if (unk_0x562F77A7F33D2E46(sLocal_248))
	{
		unk_0x8910D3D58E0132B8(sLocal_248);
	}
	func_75(&iLocal_514);
	func_79(1);
	func_77();
	func_72(1);
	func_305();
	if (unk_0xC844350D5D58C99A(Local_94.f_28[0]))
	{
		unk_0xEBA53F35D0085654(&(Local_94.f_28[0]));
	}
	...
	unk_0x9D1B62B436217CA4(func_18(2), 0);
	unk_0xD5EF6A937E06E46F(unk_0x16F2683693E537C9(), 0, -1, 0);
	func_35(&iLocal_116);
	func_304();
	unk_0x00AFF34626D62011(0);
}

void func_304()
{
	if (unk_0x9F4FE516EAACCFC5(iLocal_510))
	{
		unk_0xE3BB8E05FCEB3FBE(iLocal_510, false);
		unk_0x9A8DDC7C522F5BF5(iLocal_510, 0);
	}
}
...
void func_306(var uParam0)
{
	...
	unk_0x1FC8B874F2C46E6E(uParam0->f_3, 0);
	unk_0xE2F0767314863BD8(uParam0->f_3, 0, 0);
...
int func_309(int iParam0, float fParam1, int iParam2)
{
	...
	if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
	{
		...
		{
			if (!func_314(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_313(unk_0x16F2683693E537C9(), -828834893))
				{
...
int func_316()
{
	...
	sVar0 = func_317(0);
	unk_0x4E09E67A27F104A7(sVar0);
	if (!unk_0x59F02DA2266A744C(sVar0))
	{
		return 0;
	}
	return 1;
...
void func_318(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (iVar0 == 1)
	{
		...
		iVar1 = func_385(unk_0xBB0808A181D4745C(), 1);
		if (iVar1 != -1 && iVar1 != 94)
		{
		...
		{
			iVar4 = func_274(unk_0xBB0808A181D4745C(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_382(&(Global_98744.f_3));
				if (iVar6 > -1)
				{
...
{
	func_320(&Global_105187, unk_0xBB0808A181D4745C(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_320(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	*uParam0 = func_14();
	...
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		...
		func_345(unk_0x16F2683693E537C9());
		func_343(unk_0x16F2683693E537C9(), 0);
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_342())
		{
			func_338(unk_0x16F2683693E537C9(), &(uParam0->f_616[iVar1 /*65*/]), 1, -1);
		}
		else
		{
			iVar0 = 0;
	...
	while (iVar0 < 9)
	{
		if (unk_0xC844350D5D58C99A(Global_96075[iVar0]))
		{
			if (Global_96075[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || unk_0x134B62B726CEC8E6(iParam0) == func_329(iParam1, iParam2))
					{
						return 1;
					}
				}
	...
	if (unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		*uParam1 = unk_0x4EB64970EC291A00(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0x5D96D8530B3D0904(&(uParam1->f_77), func_332(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_339(int iParam0, int iParam1)
{
	...
	uVar0 = Global_2583656[iParam0 /*3*/][func_147(iParam1)];
...
void func_344(int iParam0, var uParam1)
{
	...
	if (!unk_0xEB6A8945D1AC98A1(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x3F0B5EEC37A0EDD3(iParam0, func_287(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x310836EE7129BA33(iVar5, &Var7) && !func_282(Var7.f_1)) && iVar9 < 51)
			{
...
int func_347(vector3 vParam0, char* sParam1, vector3 vParam2)
{
	int iVar0;
	int iVar1;
...
int func_349(var uParam0)
{
	if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (func_370())
		{
			*uParam0 = func_354(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), 6, -1, 0, 1, -1);
...
int func_351(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_87() == 0)
		{
			return unk_0xEAE0D21A50E6C7F4(func_148(func_352(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_354(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_369(iVar0))
		{
			...
			{
				fVar1 = unk_0x0EB28750412C3A5A(vParam0, func_355(iVar0, 0), true);
...
int func_358(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	vVar3 = { Var2 - Var0 };
	vVar3 = { func_359(vVar3, -Var0.f_3.f_2) };
	vVar3 = { func_359(vVar3, vVar1.f_3.f_2) };
	*uParam2 = { unk_0x8A5E176FF719A014(vVar1, 0f, vVar3) };
	uParam2->f_3 = { Var2.f_3 };
	return 1;
}

Vector3 func_359(vector3 vParam0, float fParam1)
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_366()
{
	return func_367(unk_0xD803B885F5E47A62());
}
...
var func_371()
{
	...
	func_381(&uVar0, unk_0x4460E481B9E33ADA());
	func_380(&uVar0, unk_0x8D199E381D262EEF());
	func_379(&uVar0, unk_0xD8A54335F18763BA());
	func_374(&uVar0, unk_0x972A296334C9D57B());
	func_373(&uVar0, unk_0x118229AD063C3C1D());
	func_372(&uVar0, unk_0x1A61A218F5C5EB02());
	return uVar0;
}
...
{
	return (shift_right(iParam0, 26) & 31 * func_377(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
...
void func_388(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)
{
	var uVar0;
	int iVar1;
	...
	if (!*bParam0)
	{
		if (iLocal_289 == 1)
		{
			...
			if (iVar0 != -1)
			{
				...
				Local_250[iVar0 /*19*/].f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_304, (iLocal_304 + iLocal_303)));
				unk_0xB3F77607A42FF835(Local_250[iVar0 /*19*/].f_3, 0);
			}
			*bParam0 = 1;
		}
	}
...
void func_393(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		unk_0xAFF39FB306F8E232(uParam0->f_3, 24, bParam1);
	}
	else
	{
		unk_0xAFF39FB306F8E232(uParam0->f_3, 50, true);
	}
	unk_0xAFF39FB306F8E232(uParam0->f_3, 13, bParam1);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 0, !bParam1);
	if (bParam1)
	{
		if (!bParam2)
		{
			unk_0x083F03A847B640E9(uParam0->f_3, 2);
			unk_0x298903DD96203C2C(uParam0->f_3, 70);
		}
		else
		{
			unk_0x298903DD96203C2C(uParam0->f_3, 12);
			unk_0x083F03A847B640E9(uParam0->f_3, 1);
			unk_0xB3F77607A42FF835(uParam0->f_3, 1);
			unk_0x05FE17D2660001CF(uParam0->f_3, unk_0x16F2683693E537C9(), 0f, 0f, 0f, unk_0x79833B02DBD2A244(20f, 40f), 0);
		}
		unk_0x3CC33E4E9CE523F4(uParam0->f_3, 2);
		unk_0xB35CCEC0D4946813(uParam0->f_3, 0);
	}
	else
	{
		unk_0x298903DD96203C2C(uParam0->f_3, 12);
		unk_0x3CC33E4E9CE523F4(uParam0->f_3, 1);
		unk_0xB35CCEC0D4946813(uParam0->f_3, 1);
		unk_0x083F03A847B640E9(uParam0->f_3, 1);
	}
}
...
bool func_396(var uParam0)
{
	...
	return unk_0x437347B10A200C4B(uParam0->f_3, 0);
}
...
float func_400(var uParam0)
{
	if (func_403(uParam0))
	{
		...
		{
			return (func_401(unk_0xEAE0D21A50E6C7F4(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
{
	iParam0->f_1 = (func_401(unk_0xEAE0D21A50E6C7F4(*iParam0, 4)) - fParam1);
...
int func_408(var uParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	var uVar1;
	...
	if (iLocal_97 != 9)
	{
		if (unk_0xE82754C349C7B581(vParam1, &uVar1, 0, 0))
		{
			vParam1.z = uVar1;
		}
		if (vParam1.z < 28f)
	...
	uParam0->f_3 = unk_0x36F2404464202779(26, iLocal_252, vParam1, fParam2, 1, true);
	if (!unk_0xC844350D5D58C99A(uParam0->f_3))
	{
		return 0;
	}
	...
	unk_0xAFF39FB306F8E232(uParam0->f_3, 24, false);
	unk_0xC743BD39A24D0583(uParam0->f_3, 0);
	unk_0x6DF7BF67E86AAE86(uParam0->f_3, -2065892691);
	unk_0x11AD11297DC58CC7(uParam0->f_3, 1);
	iVar0 = (unk_0xC08489BCA49ECCA8(uParam0->f_3) / 2);
	unk_0xD458AC1C1D29C3B4(uParam0->f_3, iVar0, 0);
	unk_0x722454E43E496678(uParam0->f_3, iVar0);
	unk_0xE2F0767314863BD8(uParam0->f_3, 1, 0);
	unk_0x6D80F1AEBA734886(uParam0->f_3, 0);
	unk_0xEBE904C8FC460B66(uParam0->f_3, 3);
	unk_0x26A6B1686E33113F(uParam0->f_3, 1);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 13, false);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 0, true);
	unk_0x3CC33E4E9CE523F4(uParam0->f_3, 1);
	unk_0x33CE5A9E32EA10B2(uParam0->f_3, true);
	unk_0x4F39CC3882DD074E(uParam0->f_3, "CLOWNS");
	if (!bParam4)
	{
		if (!bParam3)
		{
			...
			if (iVar0 == 0)
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, joaat("weapon_smg"), -1, true, true);
			}
			else
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, joaat("weapon_pistol"), -1, true, true);
			}
		}
		else
		{
	...
	switch (iVar0)
	{
		...
		case 2:
			unk_0x3CC33E4E9CE523F4(uParam0->f_3, 3);
			break;
	}
	*uParam0 = 1;
	uParam0->f_1 = 0;
	...
	unk_0xAADFCECF0BE76858(uParam0->f_3, 1);
	func_35(&(uParam0->f_4));
	if (func_410())
	{
		unk_0x9A28E8CB86CD4694(uParam0->f_3, 0, 0, 0, false);
	}
	unk_0x554BF1F380170E11(uParam0->f_3, 0);
	unk_0xAADFCECF0BE76858(uParam0->f_3, 1);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 1, false);
	unk_0x20EC6650986ACDC7(uParam0->f_3, 1);
	unk_0x1365063FA6365BE8(uParam0->f_3, true);
	unk_0x00A6D36F507FD6EA(uParam0->f_3, 1);
	unk_0x05FE17D2660001CF(uParam0->f_3, unk_0x16F2683693E537C9(), 0f, 0f, 0f, unk_0x79833B02DBD2A244(12f, 50f), 0);
	unk_0x11AD11297DC58CC7(uParam0->f_3, 1);
	unk_0xE121AE1BBF90E186(uParam0->f_3, true);
	unk_0x4A4806F9D471E491(uParam0->f_3, false, 0);
	unk_0x1E9649458B15960F(uParam0->f_3, true);
	uParam0->f_12 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(125, 1000));
	func_409(uParam0->f_3, &uLocal_256, 0);
	StringCopy(&(uParam0->f_7), "clown_idle_", 16);
	StringIntConCat(&(uParam0->f_7), unk_0x09AC81E49EA267F7(0, 6), 16);
	unk_0xC6EB89C59F2AF6B8(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -2f, -1, 0, 0, 0, 0, 0);
	uParam0->f_13 = unk_0x1C0640BA9A7327B3() + 30000;
	iLocal_284++;
	return 1;
}
...
void func_409(int iParam0, var uParam1, bool bParam2)
{
	...
	unk_0x9FC2699ACD081EC0(iParam0, uParam1->f_6, uParam1->f_7);
	unk_0x29CD9554726C7577(iParam0, unk_0x09AC81E49EA267F7(uParam1->f_16, uParam1->f_17));
	unk_0xAA714ADDDC372E0F(iParam0, *uParam1);
	unk_0x67415F01577A142E(iParam0, 3, unk_0x79833B02DBD2A244(uParam1->f_12, uParam1->f_13));
	unk_0x67415F01577A142E(iParam0, 4, unk_0x79833B02DBD2A244(uParam1->f_10, uParam1->f_11));
	unk_0x67415F01577A142E(iParam0, 1, unk_0x79833B02DBD2A244(uParam1->f_14, uParam1->f_15));
	if (bParam2)
	{
		unk_0x67415F01577A142E(iParam0, 6, uParam1->f_5);
	}
	else
	{
		unk_0x67415F01577A142E(iParam0, 6, uParam1->f_4);
	}
	unk_0x5BF70D3A674F3E1C(unk_0xD803B885F5E47A62(), uParam1->f_1);
	unk_0x7EADCF510F11328E(unk_0xD803B885F5E47A62(), uParam1->f_2);
	unk_0xD4455D6023C608A8(unk_0xD803B885F5E47A62(), uParam1->f_3);
	unk_0xAFF39FB306F8E232(iParam0, 13, unk_0x79833B02DBD2A244(0f, 1f) < uParam1->f_20);
	unk_0xAFF39FB306F8E232(iParam0, 42, unk_0x79833B02DBD2A244(0f, 1f) < uParam1->f_8);
	unk_0xAFF39FB306F8E232(iParam0, 11, unk_0x79833B02DBD2A244(0f, 1f) < uParam1->f_9);
	if (uParam1->f_19 != -1)
	{
		iVar0 = uParam1->f_19;
	}
	...
	{
		case 0:
			unk_0x083F03A847B640E9(iParam0, 0);
			break;
...
void func_412(int iParam0)
{
	...
	fVar0 = func_413(unk_0x68F4C0EC296D3901(iParam0, 1), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 1);
...
void func_417(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			func_404(&iLocal_531);
			fLocal_534 = unk_0x79833B02DBD2A244(5f, 8f);
			*iParam0 = 2;
			break;
		...
		case 2:
			if (!iLocal_503)
			{
				...
				{
					func_418(2, 5, 5, 0);
					fLocal_534 = unk_0x79833B02DBD2A244(20f, 30f);
					func_404(&iLocal_531);
				}
			}
			if (iLocal_284 >= 5)
...
void func_418(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar1 = unk_0x09AC81E49EA267F7(iParam1, iParam2);
...
void func_419(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < iParam1)
	{
		if (func_423(&iVar1))
		{
			vVar3 = { unk_0x8A5E176FF719A014(uParam0->f_1, uParam0->f_4, vLocal_521[iVar0 /*3*/]) };
			if (bParam2)
			{
			...
			{
				unk_0xCEAA091B490F8407(iLocal_514, "CROWD_WATCHING", Local_522[iVar1 /*11*/], 0, 0, 0);
			}
...
int func_420(int iParam0)
{
	...
	if (unk_0xE82754C349C7B581(Local_522[iParam0 /*11*/].f_2, &uVar0, 0, 0))
	{
	...
	Local_522[iParam0 /*11*/] = unk_0x36F2404464202779(26, Local_522[iParam0 /*11*/].f_1, Local_522[iParam0 /*11*/].f_2, Local_522[iParam0 /*11*/].f_5, 1, true);
	if (!unk_0xC844350D5D58C99A(Local_522[iParam0 /*11*/]))
	{
		return 0;
	}
	unk_0xFBAC0F6D4E00C891(Local_522[iParam0 /*11*/]);
	unk_0x33CE5A9E32EA10B2(Local_522[iParam0 /*11*/], true);
	unk_0x1365063FA6365BE8(Local_522[iParam0 /*11*/], true);
	unk_0x11AD11297DC58CC7(Local_522[iParam0 /*11*/], 1);
	unk_0x6D80F1AEBA734886(Local_522[iParam0 /*11*/], 0);
	unk_0xD458AC1C1D29C3B4(Local_522[iParam0 /*11*/], 100, 0);
...
void func_421(int iParam0, vector3 vParam1, var uParam2)
{
	if (func_410())
	{
...
int func_424(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar0 < 15)
	{
		if (Local_527[iVar0 /*7*/] == iParam0)
		{
			if (Local_527[iVar0 /*7*/].f_6 == bParam2)
			{
				if (iVar1 < Local_528)
				{
					if (!unk_0xEA19D5D9230DBB67(Local_527[iVar0 /*7*/].f_1, 7f))
					{
	...
	{
		*uParam1 = unk_0x09AC81E49EA267F7(0, iVar1);
		return 1;
	}
	return 0;
}
...
int func_427()
{
	...
	while (iVar0 < Local_522)
	{
		if (unk_0xC844350D5D58C99A(Local_522[iVar0 /*11*/]))
		{
			if (!unk_0xEB6A8945D1AC98A1(Local_522[iVar0 /*11*/]))
			{
				iVar1++;
			}
		}
...
int func_429(var uParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	float fVar0;
	
	unk_0x28F5E4DA506AC0CA(vParam1, 5f, 0, 0, 0, 0, false, 0);
	if (unk_0xE82754C349C7B581(vParam1 + Vector(0.23f, 0f, 0f), &fVar0, 0, 0))
	{
		vParam1.z = fVar0;
	}
	uParam0->f_3 = unk_0x122AAB0B1D6F55AD(iLocal_253, vParam1, fParam2, 1, 1, 0);
	if (!unk_0xC844350D5D58C99A(uParam0->f_3))
	{
		return 0;
	}
	fVar0 = (to_float(unk_0x7F6DC62EA9922664(uParam0->f_3)) / 1.5f);
	unk_0xD458AC1C1D29C3B4(uParam0->f_3, floor(fVar0), 0);
	uParam0->f_8 = 0;
	uParam0->f_9 = 0;
	unk_0xCC7D8FBD1C29250B(uParam0->f_3, 1, 1862763509);
	unk_0x1FC8B874F2C46E6E(uParam0->f_3, 1);
	unk_0xE2F0767314863BD8(uParam0->f_3, 1, 0);
	unk_0x4A4806F9D471E491(uParam0->f_3, false, 0);
	unk_0xE121AE1BBF90E186(uParam0->f_3, true);
	unk_0x20641932E5104B25(uParam0->f_3, false, 0);
	unk_0x1E9649458B15960F(uParam0->f_3, true);
	unk_0xAA6B3A4292417750(uParam0->f_3, false, true, false, false, false, 0, 0, 0);
	unk_0xB26AC67EF006D7D4(uParam0->f_3, 0);
	*uParam0 = 1;
	uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + iParam4);
	uParam0->f_7 = 0;
	uParam0->f_2 = 1;
	uParam0->f_10 = 0;
...
void func_431(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_289 > 1)
			{
				if (func_428(&iLocal_531, unk_0x79833B02DBD2A244(9f, 12f)))
				{
					func_418(1, 5, 5, 0);
				}
			}
...
void func_437(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 1:
			unk_0x790015DC92C918E2();
			func_439(unk_0x16F2683693E537C9(), -1);
			if (!unk_0x562F77A7F33D2E46(sLocal_248))
			{
				unk_0x8BC9595FD2792B5D(sLocal_248);
			}
			unk_0xADCFE13F048E110C(unk_0x16F2683693E537C9());
			unk_0x5BED90AC1E2BC558(sLocal_500, 1, 0);
			func_438();
			func_453();
			func_302(500, 0);
			*iParam0 = 2;
...
{
	func_25(&uLocal_335, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
	iLocal_309 = unk_0x09AC81E49EA267F7(20000, 30000);
	iLocal_308 = unk_0x09AC81E49EA267F7(10000, 20000);
	bLocal_306 = false;
}
...
int func_453()
{
	...
	func_50(unk_0x16F2683693E537C9());
	if (!iLocal_509)
	{
		if (iLocal_523 == 9 && unk_0x1C0640BA9A7327B3() > iLocal_307)
		{
			func_25(&uLocal_335, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
	...
	switch (iLocal_523)
	{
		case 0:
			...
			{
				iLocal_119 = 1;
				unk_0xC92DB9682A650680("RC18B_START");
			}
		...
		case 1:
			if (!unk_0x65636D4556D82155(Local_250[iLocal_508 /*19*/].f_3))
			{
				func_458(Local_250[iLocal_508 /*19*/].f_3, "CLOWN_LAUGH", "CLOWNS", 10);
			}
			if (unk_0x9F4FE516EAACCFC5(iLocal_510))
			{
				if (unk_0xFBB4F23D534EB790(iLocal_510))
				{
					func_457(unk_0x16F2683693E537C9(), 187.789f, -959.6204f, 29.00801f, 85f, 0, 1);
					func_415(&uLocal_524);
					iLocal_523 = 6;
				}
			}
		...
		case 6:
			...
			if (func_456(&(Local_250[iLocal_506 /*19*/])))
			{
				...
				{
					unk_0xB3A1B75CB59FEB56(false, 0, 2000, 1, 0, 0);
				}
				else
				{
					unk_0xB3A1B75CB59FEB56(false, 1, 2000, 1, 0, 0);
				}
				unk_0xE3BB8E05FCEB3FBE(iLocal_510, false);
				iLocal_523 = 7;
			}
		...
		case 8:
			...
			{
				iLocal_307 = unk_0x1C0640BA9A7327B3() + 1500;
				iLocal_523 = 9;
			}
			break;
...
int func_454(var uParam0)
{
	...
	if (unk_0xD1960163A3042274(uParam0->f_3, 780511057) > 1)
	{
		if (!unk_0xB4ECF989E2C1DAC8(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_303, iLocal_304));
			uParam0->f_2 = 12;
			unk_0x6C3AE6E278DB3D0E(uParam0->f_3, unk_0x16F2683693E537C9(), 134217728, 16);
			return 1;
		}
	}
	else
...
void func_455()
{
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		if (!unk_0x440C646F2F11A2A1(unk_0x16F2683693E537C9(), iLocal_255, 0))
		{
			unk_0x262EF6C6306BEA6C(unk_0x16F2683693E537C9(), iLocal_255, -1, true, true);
		}
		else if (!unk_0xCAE036C45E7FC720(unk_0x16F2683693E537C9(), &iVar0, 1) || iVar0 != iLocal_255)
		{
			unk_0x5745EA6329A91E29(unk_0x16F2683693E537C9(), iLocal_255, true);
		}
		unk_0x744B6A2DDB2E7563(unk_0x16F2683693E537C9(), iLocal_255, 10000);
		unk_0xDAB3108F02A4255A(unk_0x16F2683693E537C9(), 1, iLocal_255);
		unk_0x76B892E21D01B885(unk_0x16F2683693E537C9(), 1, 1, 1, 0);
		unk_0xE69C5AEBE90D20B1(unk_0x16F2683693E537C9(), false);
		if (unk_0x2399B47AC91F054A(iLocal_255, joaat("component_assaultshotgun_clip_02")))
		{
			unk_0x1F6FCCC72D02C71A(unk_0x16F2683693E537C9(), iLocal_255, joaat("component_assaultshotgun_clip_02"));
		}
...
int func_456(var uParam0)
{
	...
	if (unk_0xD1960163A3042274(uParam0->f_3, 1630799643) > 1)
	{
		if (!unk_0xB4ECF989E2C1DAC8(uParam0->f_3, sLocal_247, &(uParam0->f_7), 3))
		{
			uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_303, iLocal_304));
			unk_0x9BE7E7B6B488CC55(uParam0->f_3, unk_0x16F2683693E537C9(), -1, 1);
			return 1;
		}
	}
	else
...
int func_457(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	float fVar1;
...
{
	unk_0xEB0A515D699A7E90(iParam0, sParam1, sParam2, func_459(iParam3), 0);
}
...
int func_460(var uParam0, char* sParam1, int iParam2)
{
	if (uParam0->f_2 == 0)
	{
		if (!unk_0xB4ECF989E2C1DAC8(uParam0->f_3, sLocal_247, sParam1, 3))
		{
			StringCopy(&(uParam0->f_7), sParam1, 16);
			unk_0xC6EB89C59F2AF6B8(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, iParam2, 0, 0, 0);
		}
		else
		{
			return 1;
...
int func_463(var uParam0, int iParam1)
{
	...
	switch ((*uParam0)[iParam1 /*7*/])
	{
		...
		case 4:
			if (!unk_0xAE317D00A5A55DF6((uParam0[iParam1 /*7*/])->f_3, false, -1))
			{
				return 0;
			}
			break;
...
int func_464(var uParam0, int iParam1)
{
	...
	switch ((*uParam0)[iParam1 /*7*/])
	{
		...
		case 4:
			unk_0xAE317D00A5A55DF6((uParam0[iParam1 /*7*/])->f_3, false, -1);
			break;
...
void func_467(var uParam0)
{
	...
	if (func_50(unk_0x16F2683693E537C9()))
	{
		if (unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), uParam0->f_3, 0))
		{
			func_308(&(uParam0->f_3));
		}
		else
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_309(1, 1093140480, 0))
			{
				if (func_62(Local_94.f_28[0]))
				{
					unk_0x29E8331978B73E7F(Local_94.f_28[0], sLocal_239, 0, 0, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(Local_94.f_28[0], sLocal_239, 2, func_648(49), 0);
				}
				if (func_62(Local_94.f_41[0]))
				{
					unk_0x29E8331978B73E7F(Local_94.f_41[0], sLocal_241, 0, 0, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(Local_94.f_41[0], sLocal_241, 2, joaat("prop_protest_table_01"), 0);
				}
				if (func_62(Local_94.f_41[1]))
				{
					unk_0x29E8331978B73E7F(Local_94.f_41[1], sLocal_240, 0, 0, 0);
				}
				else
				{
					unk_0x29E8331978B73E7F(Local_94.f_41[1], sLocal_240, 2, joaat("prop_chair_08"), 0);
				}
				if (func_62(Local_94.f_41[2]))
				{
					unk_0xEEEE2E5FA6F78DF0(&(Local_94.f_41[2]));
					func_523(sLocal_242);
				}
				if (func_62(unk_0x16F2683693E537C9()))
				{
				...
				iLocal_510 = unk_0x764D630505EFC040("DEFAULT_SCRIPTED_CAMERA", 188.1366f, -957.7827f, 30.6514f, -5.5067f, -8f, 92.8053f, 40f, 0, 2);
				func_522();
				unk_0x4C902758BEA97C68(0);
				unk_0x420FE818E70BB523(1);
				...
				func_521(0, 0, 1, 0);
				func_483();
				func_300(vLocal_107, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1);
		...
		case 2:
			if (!unk_0x22A8E52414415B76())
			{
				unk_0x9A82EEAF6CA12AEE(fLocal_109);
				unk_0x62956E22F3B365FF("BARRY_02_SLOWMO");
			...
			else
			{
				...
				if (unk_0xEABED1927EFB48CA(0))
				{
					...
					if (unk_0x9F4FE516EAACCFC5(iLocal_510))
					{
						unk_0xE3BB8E05FCEB3FBE(iLocal_510, true);
						unk_0xB3A1B75CB59FEB56(true, 0, 3000, 1, 0, 0);
						unk_0x91F5B0244AAE6222(iLocal_510, "DRUNK_SHAKE", 1f);
					}
				}
				if (unk_0x3148AE92ED70DC30("Trevor", 0))
				{
		...
		case 3:
			...
			if (iLocal_119 == 0)
			{
				...
				if (!unk_0xED4934AFB6EC6451(sLocal_244))
				{
					unk_0x82A772610883F395(sLocal_244, 0, 1);
				}
			}
			unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), false, 0);
			if (unk_0x9F4FE516EAACCFC5(iLocal_510))
...
int func_481(var uParam0, int iParam1, int iParam2, char* sParam3, char* sParam4)
{
	...
	switch (iParam2)
	{
		...
		case 4:
			unk_0xAE317D00A5A55DF6(sParam3, false, -1);
			break;
		
		case 5:
			unk_0xE3934829A331AF92(sParam3, sParam4);
			break;
...
void func_482(int iParam0, int iParam1)
{
	...
	*iParam0 = unk_0x7D6CA5F52B3748BF(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	...
	if (func_50(unk_0x16F2683693E537C9()) && iParam1 == 1)
	{
...
void func_483()
{
	...
	if (!func_62(unk_0x728870EB733D12A1()))
	{
		return;
	}
	iVar0 = unk_0x134B62B726CEC8E6(unk_0x728870EB733D12A1());
	if (unk_0xAFB8495D36825275(iVar0) || unk_0xC41A9202669A24C4(iVar0))
	{
		vLocal_103 = { 180.47f, -1017.79f, 30.01f };
		fLocal_104 = 206.45f;
		func_514(Local_113[0 /*3*/], Local_113[1 /*3*/], Local_113.f_7, vLocal_103, fLocal_104, 0f, 0f, 0f, 1, 0, 1, 0, 0);
		func_487(vLocal_103, fLocal_104, 0, 145);
	}
	else
	{
		func_514(Local_113[0 /*3*/], Local_113[1 /*3*/], Local_113.f_7, vLocal_103, fLocal_104, func_486(), 1, 0, 1, 0, 0);
...
bool func_484(vector3 vParam0, int iParam1)
{
	return func_485(Global_102203.f_2890.f_12.f_66, vParam0, iParam1);
}

int func_485(int iParam0, vector3 vParam1, int iParam2)
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_487(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	vector3 vVar0;
	var uVar1;
	...
	if (unk_0xC844350D5D58C99A(Global_102203.f_4))
	{
		if (unk_0xDF1306B443CD3D15(Global_102203.f_4, 0))
		{
			if (func_513(24) != Global_102203.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_510(unk_0x68F4C0EC296D3901(Global_102203.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_488(Global_102203.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_488(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)
{
	struct<60> Var0;
	...
	if (unk_0xC844350D5D58C99A(iParam0) && unk_0xDF1306B443CD3D15(iParam0, 0))
	{
		...
		func_506(iParam3, &Var0, vParam1, fParam2, func_327(iParam0));
...
{
	if ((((((((((!unk_0xC844350D5D58C99A(iParam0) || !unk_0xDF1306B443CD3D15(iParam0, 0)) || func_336(iParam0, 0, 0)) || func_336(iParam0, 1, 0)) || func_336(iParam0, 2, 0)) || func_327(iParam0) != 145) || func_504(iParam0)) || func_503(iParam0)) || func_502(iParam0)) || func_501(iParam0)) || !func_492(unk_0x134B62B726CEC8E6(iParam0)))
	{
		if (func_503(iParam0))
		{
		}
...
void func_506(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)
{
	if (func_505(&(Global_75441.f_555[0 /*21*/]), iParam0))
	{
...
int func_510(vector3 vParam0, int iParam1, var uParam2, var uParam3)
{
	int iVar0;
	
	iVar0 = func_511(vParam0, iParam1, 1);
	switch (iVar0)
	{
		case 0:
...
int func_511(vector3 vParam0, int iParam1, int iParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
{
	func_515(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_515(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (unk_0xC844350D5D58C99A(iVar0))
	{
		...
		if (unk_0xDF1306B443CD3D15(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_517(iVar0, vParam0, vParam1, fParam2))
					{
						bVar1 = true;
					}
				}
...
int func_517(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vParam1.z = vParam2.z;
		vVar0 = { func_519(vParam1 - vParam2) };
		vVar1 = { vVar0 };
		vVar0.x = -vVar1.y;
		vVar0.y = vVar1.x;
		vVar0.z = 0f;
		...
		if (((((((((((((((func_518(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar3) || func_518(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar3, vVar5)) || func_518(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar4, vVar5)) || func_518(vVar6[0 /*3*/], vVar6[1 /*3*/], vVar2, vVar4)) || func_518(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar3)) || func_518(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar3, vVar5)) || func_518(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar4, vVar5)) || func_518(vVar6[1 /*3*/], vVar6[3 /*3*/], vVar2, vVar4)) || func_518(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar3)) || func_518(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar3, vVar5)) || func_518(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar4, vVar5)) || func_518(vVar6[3 /*3*/], vVar6[2 /*3*/], vVar2, vVar4)) || func_518(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar3)) || func_518(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar3, vVar5)) || func_518(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar4, vVar5)) || func_518(vVar6[2 /*3*/], vVar6[0 /*3*/], vVar2, vVar4))
		{
			return 1;
		}
	}
...
void func_521(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (func_50(unk_0x16F2683693E537C9()))
	{
		if (iParam2 == 1)
		{
			unk_0x745CE398A4B0A3C6(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 100f, 0);
		}
		if (iParam3 == 1)
		{
...
void func_524(int iParam0)
{
	...
	switch (*iParam0)
	{
		case 0:
			...
			*iParam0 = 1;
			if (func_62(Local_94.f_28[0]))
			{
				if (unk_0xA4FD7964FEE91ED8(0) == 4)
				{
					unk_0xC0B0B9E466C0ED17(Local_94.f_28[0], 0f, 0f, 0.3f, 1, -1, 3000, 2000, 0);
					unk_0x4BF9B75F44D4B6CE(0f);
				}
				else
				{
					unk_0xC0B0B9E466C0ED17(Local_94.f_28[0], 0.6f, 0f, 0.3f, 1, -1, 3000, 2000, 0);
				...
				if (func_62(unk_0x16F2683693E537C9()))
				{
					unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_94.f_28[0], -1, 0, 2);
				}
			}
			break;
		
		case 1:
			if (unk_0xB4AE0788C1587752(sLocal_247) && !func_29())
			{
				uVar0 = 16;
				func_25(&uVar0, 1, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
				func_25(&uVar0, 0, Local_94.f_28[0], "BARRY", 0, 1);
				if (func_2(&uVar0, "BARY2AU", "BAR_3_RCM_LI", 7, 0, 0, 0))
				{
					unk_0xC6EB89C59F2AF6B8(Local_94.f_28[0], sLocal_247, "lead_in", 8f, -4f, -1, 2, 0, 0, 0, 0);
					unk_0x0C8C0C840C2D1AD2(Local_94.f_28[0], unk_0x16F2683693E537C9(), -1, 2048, 4);
					*iParam0 = 2;
					iLocal_298 = unk_0x1C0640BA9A7327B3() + 30000;
				}
			}
			break;
		...
		case 2:
			if (func_62(Local_94.f_28[0]))
			{
				if (!func_29() || unk_0x1C0640BA9A7327B3() > iLocal_298)
				{
					if (func_62(unk_0x16F2683693E537C9()))
					{
...
void func_526()
{
	if (func_62(unk_0x16F2683693E537C9()))
	{
		if (unk_0x93B62D155C014521(unk_0xD803B885F5E47A62()))
		{
			if (unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 189.1399f, -955.8049f, 29.09192f, 187.5274f, -955.0106f, 31.09192f, 2.5f, 0, 1, 0))
			{
				unk_0x98E4DC66A651C9FA(unk_0xD803B885F5E47A62(), false, 256);
				if (func_62(Local_94.f_28[0]))
				{
					unk_0xF96A174EE26D7588(unk_0x16F2683693E537C9(), Local_94.f_28[0], 0);
				}
			}
		}
	}
...
void func_528()
{
	if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
	{
		if (unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
		{
			if (func_314(unk_0x6937EA2286828455(unk_0x16F2683693E537C9(), 0), 10.5f, 1, 1056964608, 0, 1, 0))
			{
...
void func_529()
{
	...
	if (unk_0x1C0640BA9A7327B3() < iLocal_277)
	{
		return;
	}
	if (!func_414(&iVar0))
	...
	if (iLocal_293)
	{
		vVar1 = { func_533(vLocal_294, fLocal_291, 2f) };
	}
	else
	{
		vVar1 = { func_533(vLocal_105, fLocal_291, 2f) };
	}
	if (!func_530(&vVar1))
	{
		return;
	}
	if (func_408(&(Local_250[iVar0 /*19*/]), vVar1, 0, 0, 0))
	{
		if (iLocal_97 == 9)
		{
			iLocal_277 = unk_0x1C0640BA9A7327B3() + 25;
			iLocal_535++;
		}
		else
		{
			iLocal_277 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_278, iLocal_279));
		}
	}
}
...
int func_530(var uParam0)
{
	...
	if (iLocal_97 != 9)
	{
		if (unk_0x0EB28750412C3A5A(vVar0, vLocal_105, true) > fLocal_106)
		{
			return 0;
		}
	}
	if (func_532(unk_0x16F2683693E537C9(), vVar0, 1) < fLocal_282)
	{
		return 0;
	}
	if (bLocal_299)
	{
		if (func_531(vVar0, fVar2, unk_0x16F2683693E537C9(), 1))
		{
			return 0;
		}
	}
	else if (unk_0xEA19D5D9230DBB67(vVar0, fVar2))
	{
		return 0;
	}
	if (iLocal_97 == 9)
	{
		vVar3 = { vVar0 };
		if (!unk_0xB885EF0389689E54(vVar0, 0, &vVar3, 14))
		{
			return 0;
		}
	}
	if (unk_0x0399732A9EBC368E(vVar0, 211.8852f, -931.1685f, 29.6915f, 220.7504f, -918.6229f, 32.44152f, 2f, 0, 1))
	{
		return 0;
	}
	if (vVar0.z < 28.58f)
...
bool func_531(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	return unk_0xF65264B66E133BD8(vParam0, fParam1, 0, 0, 1, 0, 0, iParam2, iParam3);
}

float func_532(int iParam0, vector3 vParam1, bool bParam2)
{
	vector3 vVar0;
...
Vector3 func_533(vector3 vParam0, float fParam1, float fParam2)
{
	vector3 vVar0;
	float fVar1;
	...
	fVar1 = (fParam2 / 2f);
	vVar0 = { func_534(vVar0, unk_0x79833B02DBD2A244(0f, fParam1)) };
	vVar0.z = unk_0x79833B02DBD2A244(-fVar1, fVar1);
	return vParam0 + vVar0;
}

Vector3 func_534(vector3 vParam0, float fParam1)
{
	float fVar0;
...
int func_536(var uParam0)
{
	...
	if (uParam0->f_2 < 15)
	{
		vVar3 = { unk_0x68F4C0EC296D3901(uParam0->f_3, 1) };
		if (vVar3.z < 21f)
		{
		}
	...
	if (uParam0->f_9 == 0)
	{
		if (func_546(uParam0->f_3, unk_0x16F2683693E537C9(), 1) < fLocal_288 || unk_0xB87D13D0C064E9D1(uParam0->f_3, unk_0x16F2683693E537C9(), 1))
		{
			uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + iVar4);
			uParam0->f_9 = 1;
		}
	}
	if (bLocal_117)
	{
		if (uParam0->f_9 == 0)
		{
			func_545(unk_0x68F4C0EC296D3901(uParam0->f_3, 1), fLocal_288, 255, 0, 0, 255, 32);
		}
		else
		{
			func_545(unk_0x68F4C0EC296D3901(uParam0->f_3, 1), fLocal_288, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2)
	{
		case 1:
			if (unk_0x1C0640BA9A7327B3() >= uParam0->f_6)
			{
				unk_0xE81656B429E5C4B5("scr_clown_appears", uParam0->f_3, 0f, 0f, 0f, 0f, 0f, 0f, 3f, 0, 0, 0);
				uParam0->f_6 = unk_0x1C0640BA9A7327B3() + 250;
				uParam0->f_2 = 2;
				uParam0->f_5 = 0f;
				func_544(uParam0->f_3, floor(uParam0->f_5), &iLocal_118);
				unk_0x4A4806F9D471E491(uParam0->f_3, true, 0);
				if (uParam0->f_7 == 0)
				{
					unk_0x2E1E5367A885F9B7(uParam0->f_3, "BARRY_02_VEHICLE_SETTING", 0);
					uParam0->f_7 = 1;
				}
				if (!unk_0x0A059E0DB9253280(uParam0->f_3))
				{
					uParam0->f_5 = 255f;
				}
			}
		...
		case 2:
			uParam0->f_5 = (uParam0->f_5 + (unk_0x6117725E0134737F() * 1024f));
			if (uParam0->f_5 > 255f)
			{
				uParam0->f_5 = 255f;
			}
			...
			{
				unk_0x672BED15BAF1B335(uParam0->f_3);
			}
			if (unk_0x1C0640BA9A7327B3() >= uParam0->f_6 || uParam0->f_5 >= 255f)
			{
				unk_0x4A4806F9D471E491(uParam0->f_3, true, 0);
				unk_0x20641932E5104B25(uParam0->f_3, true, 0);
				unk_0xE121AE1BBF90E186(uParam0->f_3, false);
				unk_0x1E9649458B15960F(uParam0->f_3, false);
				unk_0x672BED15BAF1B335(uParam0->f_3);
				func_35(&(uParam0->f_4));
				uParam0->f_4 = func_543(uParam0->f_3, 0, 5);
				uParam0->f_2 = 12;
				unk_0x67B9E919FADF78E0(uParam0->f_3, 4000, 0, 0);
				unk_0x56FDC9ADE35F7DB0(uParam0->f_3, true, 1, 0);
				unk_0x1AEF7184B203A58D(uParam0->f_3, fLocal_305);
				uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_280, iLocal_281));
				if (uParam0->f_13 != 0)
				{
					uParam0->f_2 = 10;
				}
		...
		case 10:
			...
			if (func_414(&iVar0))
			{
				...
				if (func_541(&(Local_250[uParam0->f_14 /*19*/]), uParam0->f_3, 1))
				{
					...
					unk_0xA3BF0AA5A2608191(Local_250[uParam0->f_14 /*19*/].f_3);
					unk_0xDD353D0E9C789D0E(&uVar2);
					unk_0xD1F0F33C375B8446(0, uParam0->f_3, 32, uParam0->f_11);
					if (uParam0->f_13 == 1)
					{
						unk_0xD1F0F33C375B8446(0, uParam0->f_3, 5, uParam0->f_12);
					}
					else if (uParam0->f_13 == -1)
					{
						unk_0xD1F0F33C375B8446(0, uParam0->f_3, 4, uParam0->f_12);
					}
					unk_0x75ABDC5F81978924(uVar2);
					unk_0x78ADC381772E3D54(Local_250[uParam0->f_14 /*19*/].f_3, uVar2);
		...
		case 11:
			...
			{
				if (unk_0xD1960163A3042274(Local_250[uParam0->f_14 /*19*/].f_3, 242628503) == 7)
				{
					unk_0xDD353D0E9C789D0E(&uVar5);
					unk_0x45F014B3D0466974(0, uParam0->f_3, 0);
					unk_0x6C3AE6E278DB3D0E(0, unk_0x16F2683693E537C9(), 0, 16);
					unk_0x75ABDC5F81978924(uVar5);
					unk_0x78ADC381772E3D54(Local_250[uParam0->f_14 /*19*/].f_3, uVar5);
			...
			{
				unk_0x7F5117A322CC23E3(uParam0->f_3);
				uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + iVar4);
				uParam0->f_2 = 12;
			}
			break;
		...
		case 12:
			...
			{
				if (unk_0x1C0640BA9A7327B3() > iLocal_302 && unk_0x0A059E0DB9253280(uParam0->f_3))
				{
					if (func_546(unk_0x16F2683693E537C9(), uParam0->f_3, 1) < 50f)
					{
						func_539();
					}
				}
			...
			vVar6 = { unk_0x68E4ADDDDCD7BDDE(uParam0->f_3, 0f, -3.3f, -0.7f) };
			if (bLocal_117)
			{
				func_545(vVar6, 1.5f, 255, 0, 0, 255, 32);
			}
			if (func_538(vVar6, 1.5f))
			{
				return 1;
			}
			if (func_414(&iVar0))
			{
				...
				{
					unk_0xE81656B429E5C4B5("scr_clown_appears", uParam0->f_3, vLocal_295, 0f, 0f, 0f, fLocal_296, 0, 0, 0);
					Local_250[iVar0 /*19*/].f_2 = 14;
					func_411(&(Local_250[iVar0 /*19*/]), 4);
					uParam0->f_8 = 1;
					uParam0->f_10++;
					uParam0->f_5 = 0f;
					unk_0x4A4806F9D471E491(Local_250[iVar0 /*19*/].f_3, false, 0);
					vVar6 = { unk_0x68E4ADDDDCD7BDDE(uParam0->f_3, unk_0x79833B02DBD2A244(-2.5f, 2.5f), unk_0x79833B02DBD2A244(-6.5f, -10f), -0.7f) };
					unk_0xDD353D0E9C789D0E(&uVar7);
					unk_0x9294582561BECEE7(0, 1);
					unk_0x45F014B3D0466974(0, uParam0->f_3, 256);
					unk_0xE20F700AC2AFCA92(0, vVar6, unk_0x16F2683693E537C9(), 1f, 1, 1.5f, 2f, 1, 0, 0, -957453492, 20000);
					unk_0x75ABDC5F81978924(uVar7);
					unk_0x78ADC381772E3D54(Local_250[iVar0 /*19*/].f_3, uVar7);
					unk_0xF82EA857DA10E0CD(&uVar7);
					if (uParam0->f_9 == 0)
					{
						uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_280 * 4, iLocal_281 * 4));
					}
					else
					{
						uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_280 + 500, iLocal_281));
					}
					if (uParam0->f_10 > 5)
					{
						uParam0->f_6 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_280 * 4, iLocal_281 * 4));
					...
					if (!iLocal_529)
					{
						iLocal_302 = (unk_0x1C0640BA9A7327B3() + iLocal_281 + 500);
						iLocal_529 = 1;
					}
				}
			}
		...
		case 15:
			...
			if (uParam0->f_7)
			{
				unk_0x06FF977AA95DCCE3(uParam0->f_3, 0);
				uParam0->f_7 = 0;
			}
			unk_0x1E9649458B15960F(uParam0->f_3, false);
			unk_0x0DC87D17DC2658DC(uParam0->f_3, 1, 0);
			unk_0x4D7F4CC43D4D0DE3(-1, "HOORAY", "BARRY_02_SOUNDSET", 1);
			uParam0->f_2 = 16;
			uParam0->f_6 = unk_0x1C0640BA9A7327B3() + 1500;
			uParam0->f_5 = 255f;
			if (!bLocal_301)
			{
				if (iLocal_529)
		...
		case 16:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_6)
			{
				unk_0xBA3209FB359D3EA4("scr_clown_death", unk_0x68F4C0EC296D3901(uParam0->f_3, 0), unk_0x835730A2D89F6093(uParam0->f_3, 2), 3f, 0, 0, 0);
				uParam0->f_6 = unk_0x1C0640BA9A7327B3() + 400;
				uParam0->f_2 = 17;
			}
			break;
		...
		case 17:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_6)
			{
				uParam0->f_5 = (uParam0->f_5 - (unk_0x6117725E0134737F() * 512f));
				if (uParam0->f_5 < 0f)
				{
					uParam0->f_5 = 0f;
				}
				...
				if (uParam0->f_5 <= 0f)
				{
					unk_0x7800CEC090C01D4D(unk_0x68F4C0EC296D3901(uParam0->f_3, 1), 2f);
					unk_0x8B4C4CA774181102(4f, 1073741824, 3);
					func_467(uParam0);
					return 0;
				}
			}
...
int func_538(vector3 vParam0, float fParam1)
{
	int iVar0;
	...
	while (iVar0 < Local_250)
	{
		if (unk_0xC844350D5D58C99A(Local_250[iVar0 /*19*/].f_3))
		{
			if (func_532(Local_250[iVar0 /*19*/].f_3, vParam0, 1) < fParam1)
			{
				return 1;
			}
		}
...
int func_541(var uParam0, int iParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		else if (unk_0xBBA8A868118C90ED(iParam1, 2, 0))
		{
			iVar1 = 2;
		}
		else
	...
	uParam0->f_3 = unk_0x852A19533F896693(iParam1, 26, iLocal_252, iVar1, 1, true);
	func_35(&(uParam0->f_4));
	...
	*uParam0 = 1;
	...
	uParam0->f_2 = 0;
	func_411(uParam0, 0);
	uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(round((IntToFloat(iLocal_303) * 1.5f)), iLocal_304));
	unk_0x554BF1F380170E11(uParam0->f_3, 0);
	unk_0xAADFCECF0BE76858(uParam0->f_3, 1);
	unk_0xAFF39FB306F8E232(uParam0->f_3, 1, false);
	unk_0x20EC6650986ACDC7(uParam0->f_3, 1);
	...
	uParam0->f_13 = (unk_0x1C0640BA9A7327B3() + (30000 + round((30000f * 0.5f))));
	iLocal_284++;
	return 1;
}
...
void func_544(int iParam0, int iParam1, int iParam2)
{
	...
	unk_0x4FB9A846E72E2F23(iParam0, iParam1, 0);
	*iParam2++;
}

void func_545(vector3 vParam0, float fParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	float fVar1;
	vector3 vVar2;
...
void func_551(var uParam0)
{
	...
	if (!func_562(uParam0))
	{
		if ((unk_0x437347B10A200C4B(uParam0->f_3, 0) || unk_0xEB6A8945D1AC98A1(uParam0->f_3)) || unk_0x28072FDD60CE3A6E(uParam0->f_3, 0))
		{
			iVar2 = 500;
			...
			func_561("CLOWN_DEATH", "CLOWNS", unk_0x68F4C0EC296D3901(uParam0->f_3, 1), 10);
			uParam0->f_2 = 15;
			uParam0->f_12 = (unk_0x1C0640BA9A7327B3() + iVar2);
			func_75(&(uParam0->f_5));
			...
			if (!unk_0x437347B10A200C4B(uParam0->f_3, 0))
			{
				unk_0xBC3E304ACAF897E2(uParam0->f_3, joaat("weapon_sniperrifle"));
			}
			if (unk_0xB87D13D0C064E9D1(uParam0->f_3, unk_0x16F2683693E537C9(), 1))
			{
				func_559();
			}
			if (iLocal_97 == 9)
			{
				uParam0->f_16 = { unk_0x68F4C0EC296D3901(uParam0->f_3, 1) };
			}
			func_35(&(uParam0->f_4));
			iLocal_285++;
		}
	...
	{
		case 1:
			if (unk_0x1C0640BA9A7327B3() >= uParam0->f_12 || iLocal_97 == 9)
			{
				unk_0x1E9649458B15960F(uParam0->f_3, true);
				unk_0xE81656B429E5C4B5("scr_clown_appears", uParam0->f_3, 0f, 0f, -0.1f, 0f, 0f, 0f, 1.5f, 0, 0, 0);
				uParam0->f_12 = unk_0x1C0640BA9A7327B3() + 250;
				vVar0 = { unk_0x68F4C0EC296D3901(uParam0->f_3, 1) };
				uParam0->f_2 = 2;
			}
			break;
		
		case 2:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_12)
			{
				unk_0x4A4806F9D471E491(uParam0->f_3, true, 0);
				unk_0x1E9649458B15960F(uParam0->f_3, false);
				unk_0xE121AE1BBF90E186(uParam0->f_3, false);
		...
		case 3:
			...
			unk_0x1E9649458B15960F(uParam0->f_3, true);
			unk_0xE121AE1BBF90E186(uParam0->f_3, true);
			unk_0xBA3209FB359D3EA4("scr_clown_appears", unk_0x68F4C0EC296D3901(uParam0->f_3, 1), unk_0x835730A2D89F6093(uParam0->f_3, 2), 1.5f, 0, 0, 0);
			uParam0->f_12 = unk_0x1C0640BA9A7327B3() + 125;
			uParam0->f_2 = 4;
			break;
		...
		case 12:
			...
			if (func_560(uParam0) == 4 && unk_0xD1960163A3042274(uParam0->f_3, 242628503) <= 1)
			{
				return;
			}
			...
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_11)
			{
				if (!unk_0xC379FAA7E9DFE7A4(uParam0->f_3, 0))
				{
					func_393(uParam0, 0, 0);
					uParam0->f_2 = 6;
				}
				...
				{
					uParam0->f_11 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(iLocal_303, (iLocal_304 / 2)));
				}
			}
			vVar0 = { unk_0x68F4C0EC296D3901(uParam0->f_3, 1) };
			if (vVar0.z < 27.7f)
			...
			if (unk_0x3D1053F9EB43B7AD(uParam0->f_3, 220.5318f, -918.4567f, 27.53389f, 211.7581f, -931.4215f, 39.6918f, 2.5f, 0, 1, 0))
			{
				uParam0->f_2 = 4;
				return;
			}
		...
		case 9:
			if (unk_0x7F8A39872A07D2CE(&(uParam0->f_7), sLocal_520))
			{
				sVar3 = sLocal_519;
				fVar4 = 0.802f;
				fVar5 = 0.815f;
		...
		case 14:
			uParam0->f_6 = (uParam0->f_6 + (unk_0x6117725E0134737F() * 512f));
			if (uParam0->f_6 < 2f)
			{
				unk_0x4A4806F9D471E491(uParam0->f_3, false, 0);
			}
			else
			{
				...
				else if (unk_0x0A059E0DB9253280(uParam0->f_3))
				{
		...
		case 15:
			...
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_12)
			{
				if (unk_0x437347B10A200C4B(uParam0->f_3, 0) || unk_0xEB6A8945D1AC98A1(uParam0->f_3))
				{
					func_75(&(uParam0->f_5));
					if (!unk_0xE934758D273C899A(uParam0->f_3))
					{
						vVar0 = { unk_0x68F4C0EC296D3901(uParam0->f_3, 1) };
						if (unk_0xE82754C349C7B581(vVar0, &uVar1, 0, 0))
						{
						...
						unk_0xBA3209FB359D3EA4("scr_clown_death", vVar0, unk_0x835730A2D89F6093(uParam0->f_3, 2), 2f, 0, 0, 0);
						unk_0xEB819BD1E585E9CB(-1, "clown_die_wrapper", vVar0, "BARRY_02_SOUNDSET", 0, 0, 0);
						uParam0->f_2 = 17;
						if (iLocal_97 == 9)
						{
							uParam0->f_12 = unk_0x1C0640BA9A7327B3() + 100;
						}
						else
						{
							uParam0->f_12 = unk_0x1C0640BA9A7327B3() + 500;
						}
						uParam0->f_6 = 255f;
						func_35(&(uParam0->f_4));
					}
		...
		case 17:
			if (unk_0x1C0640BA9A7327B3() > uParam0->f_12)
			{
				...
				func_552(uParam0->f_3, floor(uParam0->f_6), &iLocal_118);
				if (uParam0->f_6 <= 0f || !unk_0x0A059E0DB9253280(uParam0->f_3))
				{
					uParam0->f_1 = 1;
					func_75(&(uParam0->f_5));
					func_469(uParam0);
...
{
	if (unk_0xB4ECF989E2C1DAC8(uParam0->f_3, sParam1, &(uParam0->f_7), 3))
	{
		if (!*iParam4)
		{
			if (unk_0x8CA9406E01C7EE58(uParam0->f_3, sParam1, &(uParam0->f_7)) >= fParam2 && !unk_0x440C646F2F11A2A1(uParam0->f_3, joaat("weapon_smg"), 0))
			{
				unk_0xBA3209FB359D3EA4("scr_clown_appears", unk_0x64430C979F516F7A(uParam0->f_3, 57005, 0f, 0f, 0f), 0f, 0f, 0f, 0.3f, 0, 0, 0);
				*iParam4 = 1;
			}
		}
		if (unk_0x8CA9406E01C7EE58(uParam0->f_3, sParam1, &(uParam0->f_7)) >= fParam3)
		{
			if (!unk_0x440C646F2F11A2A1(uParam0->f_3, joaat("weapon_smg"), 0))
			{
				unk_0x262EF6C6306BEA6C(uParam0->f_3, joaat("weapon_smg"), -1, true, true);
			}
			*iParam4 = 0;
...
void func_554(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 0)
	{
		...
		unk_0xC6EB89C59F2AF6B8(uParam0->f_3, sLocal_519, &(uParam0->f_7), 8f, -4f, -1, 0, 0.625f, 0, 0, 0);
	}
	else
	{
		StringCopy(&(uParam0->f_7), "clown_idle_", 16);
		StringIntConCat(&(uParam0->f_7), unk_0x09AC81E49EA267F7(0, 6), 16);
		unk_0xC6EB89C59F2AF6B8(uParam0->f_3, sLocal_247, &(uParam0->f_7), 8f, -1f, -1, 0, 0, 0, 0, 0);
	}
}
...
void func_555(var uParam0)
{
	...
	if (unk_0xEB6A8945D1AC98A1(uParam0->f_3) || unk_0xEB6A8945D1AC98A1(uParam0->f_15))
	{
		return;
	}
	if (unk_0xD1960163A3042274(uParam0->f_3, 242628503) != 1)
	{
		unk_0xDD353D0E9C789D0E(&uVar0);
		if (func_546(uParam0->f_3, uParam0->f_15, 0) <= 5f)
		{
			unk_0x9BE7E7B6B488CC55(0, uParam0->f_15, unk_0x09AC81E49EA267F7(250, 500), 0);
			unk_0x2C4A1A0F54A166E8(0, uParam0->f_15, unk_0x09AC81E49EA267F7(250, 500), -957453492);
		}
		unk_0x161356BF7864C47B(0, uParam0->f_15, uParam0->f_15, 2f, 1, 3f, 4.5f, 1, 0, -957453492);
		unk_0x6C3AE6E278DB3D0E(0, uParam0->f_15, 67108864, 16);
...
int func_557(var uParam0)
{
	if (func_78(uParam0))
	{
		if (uParam0->f_15 != 0)
		{
			if (!unk_0x437347B10A200C4B(uParam0->f_15, 0))
			{
				if (!unk_0xEB6A8945D1AC98A1(uParam0->f_15) && !unk_0x28072FDD60CE3A6E(uParam0->f_15, 1))
				{
					return 1;
				}
			}
...
int func_558(int iParam0, var uParam1, float fParam2)
{
	...
	*uParam1 = 0;
	...
	while (iVar0 <= (Local_522 - 1))
	{
		if (unk_0xC844350D5D58C99A(Local_522[iVar0 /*11*/]))
		{
			if (!unk_0x437347B10A200C4B(Local_522[iVar0 /*11*/], 0))
			{
				if (!unk_0xEB6A8945D1AC98A1(Local_522[iVar0 /*11*/]) && !unk_0x28072FDD60CE3A6E(Local_522[iVar0 /*11*/], 1))
				{
...
void func_559()
{
	...
	if (unk_0x1C0640BA9A7327B3() < iLocal_308)
	{
		return;
	}
	if (!bLocal_306)
	...
	{
		iLocal_308 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(10000, 20000));
		if ((iLocal_309 - unk_0x1C0640BA9A7327B3()) < 2500)
		{
			iLocal_309 = (unk_0x1C0640BA9A7327B3() + unk_0x09AC81E49EA267F7(3000, 5000));
		}
	}
}
...
void func_561(char* sParam0, char* sParam1, vector3 vParam2, int iParam3)
{
	unk_0xCAB39E12D9493B73(sParam0, sParam1, vParam2, func_459(iParam3));
}
...
void func_564(int iParam0)
{
	...
	if (unk_0x437347B10A200C4B(Local_522[iParam0 /*11*/], 0) || unk_0x28072FDD60CE3A6E(Local_522[iParam0 /*11*/], 1))
	{
		if (Local_522[iParam0 /*11*/].f_6 < 5)
		{
			if (unk_0x0361981EE62202D8(Local_522[iParam0 /*11*/], iLocal_255, 0))
			{
			}
			func_75(&iLocal_514);
			Local_522[iParam0 /*11*/].f_8 = unk_0x1C0640BA9A7327B3() + 500;
	...
	{
		case 0:
			Local_522[iParam0 /*11*/].f_9 = (Local_522[iParam0 /*11*/].f_9 + (unk_0x6117725E0134737F() * 512f));
			if (Local_522[iParam0 /*11*/].f_9 < 2f)
			{
				unk_0x4A4806F9D471E491(Local_522[iParam0 /*11*/], false, 0);
			}
			else
			{
				unk_0x4A4806F9D471E491(Local_522[iParam0 /*11*/], true, 0);
				if (Local_522[iParam0 /*11*/].f_9 > 255f)
				{
					Local_522[iParam0 /*11*/].f_9 = 255f;
					unk_0x672BED15BAF1B335(Local_522[iParam0 /*11*/]);
					Local_522[iParam0 /*11*/].f_6 = 1;
				}
				else if (unk_0x0A059E0DB9253280(Local_522[iParam0 /*11*/]))
				{
		...
		case 1:
			if (unk_0x688A90832774AB83(Local_522[iParam0 /*11*/]))
			{
		...
		case 2:
			if (func_62(unk_0x16F2683693E537C9()))
			{
				if (func_62(Local_522[iParam0 /*11*/]))
				{
					...
					unk_0xEEB67C3D0A71A47B(0, unk_0x68E4ADDDDCD7BDDE(Local_522[iParam0 /*11*/], vVar0), 200f, -1, 0, 0);
					unk_0x75ABDC5F81978924(uVar1);
					unk_0xA3BF0AA5A2608191(Local_522[iParam0 /*11*/]);
					unk_0x78ADC381772E3D54(Local_522[iParam0 /*11*/], uVar1);
		...
		case 3:
			if (!unk_0x3D1053F9EB43B7AD(Local_522[iParam0 /*11*/], Local_110[0 /*3*/], Local_110[1 /*3*/], Local_110.f_7, 0, 1, 0))
			{
				Local_522[iParam0 /*11*/].f_8 = unk_0x1C0640BA9A7327B3() + 500;
				Local_522[iParam0 /*11*/].f_6 = 4;
			}
		...
		case 4:
			unk_0xBC3E304ACAF897E2(Local_522[iParam0 /*11*/], joaat("weapon_sniperrifle"));
			unk_0xCEE7E5D42799D65A(Local_522[iParam0 /*11*/], 1000, 1, 0);
			Local_522[iParam0 /*11*/].f_8 = unk_0x1C0640BA9A7327B3() + 500;
			Local_522[iParam0 /*11*/].f_6 = 5;
			break;
		
		case 5:
			if (unk_0x1C0640BA9A7327B3() > Local_522[iParam0 /*11*/].f_8)
			{
				if (unk_0x437347B10A200C4B(Local_522[iParam0 /*11*/], 0) || unk_0xEB6A8945D1AC98A1(Local_522[iParam0 /*11*/]))
				{
					Local_522[iParam0 /*11*/].f_8 = unk_0x1C0640BA9A7327B3() + 500;
					Local_522[iParam0 /*11*/].f_9 = 255f;
		...
		case 6:
			if (unk_0x1C0640BA9A7327B3() > Local_522[iParam0 /*11*/].f_8)
			{
				Local_522[iParam0 /*11*/].f_9 = (Local_522[iParam0 /*11*/].f_9 - (unk_0x6117725E0134737F() * 1024f));
				if (Local_522[iParam0 /*11*/].f_9 < 0f)
				{
					Local_522[iParam0 /*11*/].f_9 = 0f;
				}
				func_552(Local_522[iParam0 /*11*/], floor(Local_522[iParam0 /*11*/].f_9), &iLocal_513);
				if (Local_522[iParam0 /*11*/].f_9 <= 0f || !unk_0x0A059E0DB9253280(Local_522[iParam0 /*11*/]))
				{
					Local_522[iParam0 /*11*/].f_7 = 0;
...
void func_565(int iParam0)
{
	...
	{
		if (!unk_0xB4ECF989E2C1DAC8(Local_522[iParam0 /*11*/], sLocal_517, sLocal_518, 3))
		{
			unk_0xC6EB89C59F2AF6B8(Local_522[iParam0 /*11*/], sLocal_517, sLocal_518, 8f, -8f, -1, 1, unk_0x79833B02DBD2A244(0f, 0.5f), 0, 0, 0);
		}
	}
	else if (!unk_0xB4ECF989E2C1DAC8(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 3))
	{
		unk_0xC6EB89C59F2AF6B8(Local_522[iParam0 /*11*/], sLocal_515, sLocal_516, 8f, -8f, -1, 1, unk_0x79833B02DBD2A244(0f, 0.5f), 0, 0, 0);
	}
}
...
int func_566(int iParam0)
{
	...
	vVar0 = { unk_0x68F4C0EC296D3901(Local_522[iParam0 /*11*/], 0) };
	if (Local_522[iParam0 /*11*/].f_10)
	{
		return 1;
	}
	if (unk_0xD15F544473A95FE8(vVar0, (5f - 1f), 1, 1))
	{
		return 1;
	}
	iVar1 = 0;
	while (iVar1 < Local_522)
	{
		if (iVar1 != iParam0)
		{
			if (unk_0xC844350D5D58C99A(Local_522[iVar1 /*11*/]))
			{
				if (unk_0x28072FDD60CE3A6E(Local_522[iVar1 /*11*/], 1) || unk_0xEB6A8945D1AC98A1(Local_522[iVar1 /*11*/]))
				{
					if (unk_0x0EB28750412C3A5A(vVar0, unk_0x68F4C0EC296D3901(Local_522[iVar1 /*11*/], 0), false) < 20f)
					{
						return 1;
					}
				}
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x757EF87A33649210())
			{
				...
				Var4 = { func_576(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
{
	if (((!func_587(0) || Global_76891) || Global_76880 == 1) || !unk_0x0F1CCD77290EE12F())
	{
		return 0;
	}
	switch (Global_76876)
	{
		...
		case 5:
			if ((unk_0x22A8E52414415B76() || func_571(0)) || func_586(1))
			{
			}
			else
			{
...
void func_592(vector3 vParam0, float fParam1, var uParam2, var uParam3)
{
	vector3 vVar0;
...
void func_593()
{
	...
	if (func_611() == 1)
	{
		...
		{
			case 0:
				func_600(vLocal_107, fLocal_108, 0, 0);
				func_595(1);
				if (!unk_0xED4934AFB6EC6451(sLocal_244))
				{
					unk_0x82A772610883F395(sLocal_244, 0, 1);
...
void func_595(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 3:
			func_294(unk_0x16F2683693E537C9(), 179.1285f, -961.58f, 29.0923f);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 143.3596f);
			iLocal_101 = 4;
			break;
		
		case 4:
			func_294(unk_0x16F2683693E537C9(), 176.0677f, -976.4255f, 29.0923f);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 324.8268f);
			iLocal_101 = 5;
			break;
		
		case 5:
			func_294(unk_0x16F2683693E537C9(), 188.0644f, -948.7751f, 29.0923f);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 329.9782f);
			iLocal_101 = 6;
			break;
		...
		case 6:
			if (!func_598())
			{
				func_294(unk_0x16F2683693E537C9(), 188.932f, -952.0983f, 29.0923f);
				unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 325.7944f);
			}
			iLocal_101 = 7;
			break;
		
		case 7:
			func_294(unk_0x16F2683693E537C9(), 213.3817f, -919.8522f, 29.6929f);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 323.943f);
			iLocal_101 = 8;
			break;
		
		case 8:
			func_294(unk_0x16F2683693E537C9(), 209.8298f, -912.4507f, 29.6921f);
			unk_0xD8F6A53F4799FAFE(unk_0x16F2683693E537C9(), 138.4911f);
			iLocal_101 = 9;
			break;
	...
	unk_0x2FB9A57162E54BAB(0f);
	unk_0xEF6276132B396452(0f, 1065353216);
	unk_0x82A772610883F395(sLocal_243, 0, 1);
}
...
void func_600(vector3 vParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_611())
	{
...
int func_602(var uParam0)
{
	...
	switch (iLocal_80)
	{
		...
		case 2:
			...
			{
				if (func_604(&(uParam0->f_28[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 2", 1))
				{
					unk_0x9A28E8CB86CD4694(uParam0->f_28[0], 1, 0, 0, false);
				}
				else
				{
					bVar4 = false;
		...
		case 3:
			if (func_62(uParam0->f_28[0]))
			{
				...
				unk_0xA47B46945FF6DE74(uParam0->f_28[0], vVar1, 1, 0, 0, 1);
				unk_0xD8F6A53F4799FAFE(uParam0->f_28[0], fVar2);
				unk_0x1E9649458B15960F(uParam0->f_28[0], true);
				unk_0xC6EB89C59F2AF6B8(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 9, 0, 0, 0, 0);
...
int func_604(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)
{
	if (func_605(iParam0, iParam1, vParam2, fParam3, 1))
	{
		if (unk_0xC844350D5D58C99A(*iParam0))
		{
			if (!unk_0x437347B10A200C4B(*iParam0, 0))
...
int func_605(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)
{
	int iVar0;
...
struct<8> func_624(struct<8> Param0, float fParam1)
{
	...
	Var0 = 2;
	vVar1 = { func_519(Param0[1 /*3*/] - Param0[0 /*3*/]) * Vector(fParam1, fParam1, fParam1) };
...
void func_625(var uParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	*(uParam0[0 /*3*/]) = { vParam1 };
	*(uParam0[1 /*3*/]) = { vParam2 };
	uParam0->f_7 = fParam3;
...
void func_626()
{
	...
	if (func_62(unk_0x16F2683693E537C9()))
	{
		unk_0x0B42C743EF171FF5(unk_0x16F2683693E537C9(), iLocal_502);
	}
	func_35(&iLocal_116);
	func_72(1);
	unk_0xADCFE13F048E110C(unk_0x16F2683693E537C9());
...
void func_631(bool bParam0)
{
	...
	if (!func_643())
	{
		...
		{
			func_232(iVar0, 1, 0);
			func_632(unk_0xBB0808A181D4745C(), iVar0);
		}
		else
		{
			if (Global_110725[iVar0 /*10*/].f_9 == -1)
...
int func_633(char* sParam0, int iParam1, int iParam2)
{
	...
	if (func_636())
	{
		...
		{
			iVar2 = func_382(unk_0xBB0808A181D4745C());
			if (iVar2 > -1)
			{
