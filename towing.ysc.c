				...
				case 0:
					...
					if (!bLocal_779)
					{
						if (unk_0xC844350D5D58C99A(iLocal_816) && !unk_0x437347B10A200C4B(iLocal_816, 0))
						{
							...
							{
								bLocal_776 = true;
								unk_0xF3268524E9BE6D6E(iLocal_816, unk_0x16F2683693E537C9(), 1000f, -1, 0, 0);
							}
							if (func_173())
							{
								bLocal_777 = true;
					...
					if (bLocal_190 && !bLocal_798)
					{
						if (func_175(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 1, 1, 0))
						{
							...
							if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/], 0))
							{
								...
								unk_0xF3268524E9BE6D6E(Local_824[0 /*20*/], unk_0x16F2683693E537C9(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
						...
						if (func_175(Local_824[0 /*20*/].f_1, Local_824[0 /*20*/].f_6, &uLocal_162, &iLocal_169, 0, 1, 0, 1, 0))
						{
							...
							if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_1, 0))
							{
								unk_0xA3BF0AA5A2608191(Local_824[0 /*20*/].f_1);
								unk_0xFADC0A217229F6B5(Local_824[0 /*20*/].f_1, true);
								unk_0xF3268524E9BE6D6E(Local_824[0 /*20*/].f_1, unk_0x16F2683693E537C9(), 1000f, -1, 0, 0);
								iLocal_875 = 18;
							}
						}
					}
...
int func_55()
{
	...
	switch (iLocal_906)
	{
		...
		case 15:
			...
			func_101(&iLocal_454, "TOW_UI07", 500, round(fLocal_178), round(fLocal_179), "TOW_UI08", 4000, 1);
			if (iLocal_220 > 0)
			{
...
void func_113()
{
	...
	if (((!unk_0x437347B10A200C4B(iLocal_900, 0) && !unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0)) && unk_0x6D18156F72BE0773(iLocal_900, Local_824[0 /*20*/].f_6)) || (Global_111638.f_19968.f_3 == 0 || Global_111638.f_19968.f_3 > 2))
	{
		return;
	}
	switch (iLocal_852)
			...
			if (!bLocal_792)
			{
				if ((func_123(Local_824[iParam1 /*20*/].f_6, iLocal_900, &iLocal_449, 10, 150f, 4f, 1) || iLocal_787) || iLocal_216)
				{
					if (!bLocal_770)
					{
						iLocal_449 = 0;
						func_122(&iLocal_444);
						if (unk_0xD1960163A3042274(Local_824[iParam1 /*20*/], -875674219) != 1)
						{
							unk_0xF96A174EE26D7588(Local_824[iParam1 /*20*/], unk_0x16F2683693E537C9(), -1);
						}
						bLocal_770 = true;
					}
					if (bLocal_770)
...
void func_124()
{
	...
	if (!bLocal_774)
	{
		iVar0 = round(((300f - func_128(&iLocal_891)) * 1000f));
		if (iLocal_170 == 3)
		{
			if ((iVar0 / 1000) < 60)
			{
...
int func_133(bool bParam0, int iParam1)
{
	...
	else if (Local_393[iLocal_450 /*23*/] == 4)
	{
		fLocal_864 = -1f;
		iLocal_784 = 1;
		iLocal_901 = unk_0x122AAB0B1D6F55AD(joaat("ambulance"), Local_394[func_256() /*28*/].f_23, Local_394[func_256() /*28*/].f_26, true, true, false);
		if (!unk_0x437347B10A200C4B(iLocal_901, 0))
		{
			...
			iLocal_902 = unk_0x852A19533F896693(iLocal_901, 4, joaat("s_m_m_paramedic_01"), -1, 1, true);
		}
	...
	if (bParam0)
	{
		...
		if (Global_111638.f_19968.f_5 == 0 || Global_111638.f_19968.f_5 == 1)
		{
			Local_824[0 /*20*/] = unk_0x852A19533F896693(Local_824[0 /*20*/].f_6, 26, joaat("a_f_m_bevhills_01"), -1, 1, true);
		}
		else if (Global_111638.f_19968.f_5 == 2)
		{
			Local_824[0 /*20*/] = unk_0x852A19533F896693(Local_824[0 /*20*/].f_6, 26, joaat("a_m_y_genstreet_02"), -1, 1, true);
		}
		else
		{
...
int func_135(vector3 vParam0, float fParam1, int iParam2, bool bParam3, var uParam4)
{
	...
	*iParam2 = func_136(&Local_824);
	...
	{
		Local_824[*iParam2 /*20*/].f_17 = unk_0xA4B9EE930B45BDFA(Local_393[iLocal_450 /*23*/].f_10, fVar0, 0f, 0);
	}
	else
	{
		Local_824[*iParam2 /*20*/].f_17 = unk_0xA4B9EE930B45BDFA(vParam0, fVar0, 0f, 0);
	}
	Local_824[*iParam2 /*20*/].f_18 = unk_0xA4B9EE930B45BDFA(vParam0, fVar1, 2.5f, 0);
	Local_824[*iParam2 /*20*/].f_19 = unk_0xA4B9EE930B45BDFA(vParam0, fVar2, 4f, 0);
	if (bParam3)
	{
...
int func_139(var uParam0, float fParam1, var uParam2, var uParam3)
{
	...
	unk_0x4A13F7D4B1E239A0(vVar3, 2, uParam2, fParam1, &uVar1, 1, 3f, 0f);
	*uParam0 = { vVar3 };
...
void func_187(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		Local_438[iVar0 /*18*/] = unk_0x1776B2F0999C29AC(Local_438[iVar0 /*18*/].f_1, Local_438[iVar0 /*18*/].f_2, Local_438[iVar0 /*18*/].f_5, Local_438[iVar0 /*18*/].f_8, Local_438[iVar0 /*18*/].f_11, Local_438[iVar0 /*18*/].f_12, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
		iVar0++;
	}
}
	...
	switch (iLocal_911)
	{
		...
		case 2:
			if (!func_11(Local_393[iLocal_450 /*23*/].f_13))
			{
				...
				if (!unk_0x3D1053F9EB43B7AD(Local_824[0 /*20*/].f_6, Local_393[iLocal_450 /*23*/].f_13, Local_393[iLocal_450 /*23*/].f_16, Local_393[iLocal_450 /*23*/].f_19, 0, true, 0))
				{
					func_122(&iLocal_444);
					iLocal_781 = 1;
					iLocal_788 = 1;
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843 + 15))
			{
				...
				func_122(&iLocal_444);
				unk_0x0C8C0C840C2D1AD2(Local_824[0 /*20*/], Local_824[0 /*20*/].f_7, -1, 2, 2);
				settimerb(0);
				iLocal_911 = 3;
			}
			break;
			...
			if (func_10(Local_824[0 /*20*/].f_7, Local_393[iLocal_450 /*23*/].f_1, 1) < IntToFloat(iLocal_843))
			{
				if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/], 0))
				{
					...
					if (unk_0x405E212DDE472467(Local_824[0 /*20*/], 0))
					{
						unk_0xDD353D0E9C789D0E(&iLocal_171);
						unk_0x75CDA8644CD3B5F5(0, 0, 0);
						unk_0xB87AD42E3FA06BDE(0, unk_0x8A5E176FF719A014(Local_393[iLocal_450 /*23*/].f_1, Local_393[iLocal_450 /*23*/].f_4, 0f, 15f, 0f), 3f, 0, 0, 786603, -1082130432);
						unk_0xF96A174EE26D7588(0, unk_0x16F2683693E537C9(), -1);
						unk_0x75ABDC5F81978924(iLocal_171);
...
void func_193()
{
	...
	while (iVar0 < 1)
	{
		unk_0x5A5CC21130AD387A(Local_824[iVar0 /*20*/].f_17);
		unk_0x5A5CC21130AD387A(Local_824[iVar0 /*20*/].f_18);
		unk_0x5A5CC21130AD387A(Local_824[iVar0 /*20*/].f_19);
		iVar0++;
	}
	if (!func_11(Local_394[func_256() /*28*/].f_17))
	{
...
int func_196()
{
	...
	if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/], 0) && !unk_0x437347B10A200C4B(iLocal_900, 0))
	{
		...
		{
			if (unk_0xE4EDC4B0E92C078B(Local_824[0 /*20*/].f_10))
			{
				unk_0x142CC44DB769B57E(&(Local_824[0 /*20*/].f_10));
				func_122(&iLocal_444);
			}
		}
	...
	switch (iLocal_910)
	{
		case 0:
			if (func_9(Local_393[iLocal_450 /*23*/].f_1, 1) < 100f)
			{
				...
				{
					Local_824[0 /*20*/].f_10 = unk_0x5C3B41825F6AC5A0(Local_824[0 /*20*/].f_7);
				}
				iLocal_815 = unk_0x852A19533F896693(Local_824[0 /*20*/].f_7, 4, joaat("s_m_m_lsmetro_01"), -1, 1, true);
		...
		case 4:
			if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_7, 0) && !unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
			{
				...
				else if (func_10(Local_824[0 /*20*/].f_6, vVar0, 1) < 10f && unk_0x3D1053F9EB43B7AD(Local_824[0 /*20*/].f_6, Local_393[iLocal_450 /*23*/].f_13, Local_393[iLocal_450 /*23*/].f_16, Local_393[iLocal_450 /*23*/].f_19, 0, true, 0))
				{
					iLocal_768 = 1;
					if (!unk_0x437347B10A200C4B(iLocal_900, 0) && !unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
					{
		...
		case 0:
			if (bLocal_799)
			{
				if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
				{
					...
					unk_0xC6EB89C59F2AF6B8(Local_824[0 /*20*/], "oddjobs@towing", "m_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xC6EB89C59F2AF6B8(Local_824[0 /*20*/].f_1, "oddjobs@towing", "f_blow_job_loop", 1000f, -8f, -1, 1, 0, 0, 0, 0);
					if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
					{
						unk_0x71EDC33E5A423750(Local_824[0 /*20*/].f_6, 10);
					}
			...
			else if (bLocal_800)
			{
				if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
				{
					...
					unk_0xC6EB89C59F2AF6B8(Local_824[0 /*20*/], "RANDOM@CAR_SLEEPING", "Sleeping_Idle", 8f, -8f, -1, 1, 0, 0, 0, 0);
					bLocal_190 = true;
				}
			}
			else if (func_209())
			...
			if (func_7(&iLocal_894) && func_4(&iLocal_894) > 1f)
			{
				if (bLocal_799 && func_7(&iLocal_894))
				{
					...
					if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/], 0))
					{
						...
						unk_0xF3268524E9BE6D6E(0, Local_824[0 /*20*/], 1000f, -1, 0, 0);
						unk_0x01E4BB5190DF7317(0, 1193033728, 0);
						unk_0x75ABDC5F81978924(iLocal_171);
						if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_1, 0))
						{
						...
						if (!func_47())
						{
							if (unk_0xD1960163A3042274(Local_824[0 /*20*/], 242628503) == 1)
							{
								if (unk_0x4F1B602325013CC2(Local_824[0 /*20*/]) == 2)
								{
									...
									if (vdist2(vVar1, unk_0x68F4C0EC296D3901(Local_824[0 /*20*/], true)) < 400f)
									{
										if ((Global_111638.f_19968.f_4 % 2) == 0)
										{
		...
		case 5:
			if (!func_47())
			{
				...
				if ((!unk_0x437347B10A200C4B(Local_824[0 /*20*/], 0) && !unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0)) && !unk_0x437347B10A200C4B(iLocal_900, 0))
				{
					if (unk_0x6D18156F72BE0773(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						unk_0xA8CC11FF8D2962D4(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0f, 0f, 0f, 3f, -1, 10f, 1);
					}
					else
					{
						if (!unk_0x437347B10A200C4B(Local_824[0 /*20*/].f_6, 0))
						...
						unk_0x5B1D360B9C6F0A09(0, Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
					...
					if (!unk_0x6D18156F72BE0773(iLocal_900, Local_824[0 /*20*/].f_6))
					{
						if (bLocal_799)
						{
							if (timerb() > 8000)
							{
								...
								{
									unk_0x71EDC33E5A423750(Local_824[0 /*20*/].f_6, 1);
									unk_0x5B1D360B9C6F0A09(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 20000, -1, 2f, 1, 0);
								}
								iLocal_909 = 7;
							}
						}
							...
							if (!bLocal_798)
							{
								if (unk_0xC42A92762C58E1B9(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, 0))
								{
									if (!unk_0x437347B10A200C4B(iLocal_900, 0))
									{
										...
										{
											if (unk_0xD1960163A3042274(Local_824[0 /*20*/], -258271821) != 1)
											{
								...
								else if (!unk_0x437347B10A200C4B(iLocal_900, 0))
								{
									...
									{
										if (unk_0xD1960163A3042274(Local_824[0 /*20*/], -1794415470) != 1)
										{
											if (unk_0xBBA8A868118C90ED(Local_824[0 /*20*/].f_6, -1, 0))
											{
												unk_0x5B1D360B9C6F0A09(Local_824[0 /*20*/], Local_824[0 /*20*/].f_6, -1, -1, 2f, 1, 0);
											}
										}
									}
		...
		case 1:
			if (bLocal_807 && !iLocal_808)
			{
				if (!func_47())
				{
					...
					{
						if (unk_0xD1960163A3042274(Local_824[0 /*20*/], -875674219) != 1)
						{
	...
	if (!bLocal_215)
	{
		...
		switch (iLocal_447)
		{
			...
			case 4:
				...
				{
					if ((timera() > 12000 || func_119(iParam0, iParam1, 1) < 7.5f) || (iLocal_216 && func_119(iParam0, iParam1, 1) < 30f))
					{
						iLocal_191 = 1;
			...
			case 6:
				...
				if (unk_0x3D1053F9EB43B7AD(iParam0, Param2, Param2.f_3, Param2.f_6, 0, false, 0))
				{
					...
					*iParam16 = unk_0x6CC513A908911CF0(Param2.f_14);
					settimerb(0);
					iLocal_447 = 7;
				}
				break;
