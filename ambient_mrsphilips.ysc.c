...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
...
int func_77(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 <= 52)
	{
		if (iParam1 == 6 || iParam1 == func_93(iVar0))
		{
			...
			{
				fVar1 = unk_0x0EB28750412C3A5A(vParam0, func_78(iVar0, 0), 1);
...
{
	return (shift_right(iParam0, 26) & 31 * func_101(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
