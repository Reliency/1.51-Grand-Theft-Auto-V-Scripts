		...
		if (unk_0xB4ECF989E2C1DAC8(unk_0x16F2683693E537C9(), &sLocal_110, &cLocal_126, 2))
		{
			...
			switch (iLocal_170)
			{
				case 0:
					...
					if (fVar1 > fLocal_108)
					{
						if (!unk_0xC844350D5D58C99A(iLocal_68) || iLocal_79 != -1)
						{
...
int func_3(int iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			if (((unk_0x134B62B726CEC8E6(*iParam0) != -1593767197 && unk_0x134B62B726CEC8E6(*iParam0) != joaat("v_res_tt_flusher")) && unk_0x134B62B726CEC8E6(*iParam0) != joaat("v_ilev_fh_lampa_on")) && unk_0x134B62B726CEC8E6(*iParam0) != joaat("prop_cs_remote_01"))
			{
				unk_0x1BF8B16C32704027(*iParam0, -8f, 1);
			}
		...
		case 5:
			unk_0xDA55CDFB97015579(unk_0x68F4C0EC296D3901(*iParam0, true), 0, 0.5f, 1, 0, 1f, 0);
			unk_0xF690C84DADBB3551(iParam0);
			return 1;
			break;
		...
		case 8:
			...
			unk_0xBA3209FB359D3EA4(sVar10, vVar8, vVar9, 1065353216, 0, 0, 0);
			unk_0xF690C84DADBB3551(iParam0);
			return 1;
			break;
		...
		case 9:
			...
			unk_0xBA3209FB359D3EA4(sVar13, vVar11, vVar12, 1065353216, 0, 0, 0);
			unk_0xF690C84DADBB3551(iParam0);
			*iParam0 = unk_0x7707E48765093646(iVar14, vVar11, true, true, false);
			...
			if (func_6(iVar0, &sVar15, &cVar16, &iVar17))
			{
				if (func_4(iVar0, &sVar18, &cVar19, &cVar20, &uVar21, &uVar22))
				{
					...
					{
						unk_0xE14EC663EED44AD5(*iParam0, Global_96074, &sVar15, &sVar18, 1000f, -8f, iVar17, 1148846080);
					}
				}
			}
...
void func_52()
{
	...
	while (!bVar1 && iVar0 < 400)
	{
		...
		{
			if (!unk_0x64F604CF561734A9(&cLocal_142, 0, -1))
			{
				bVar1 = false;
			}
		}
