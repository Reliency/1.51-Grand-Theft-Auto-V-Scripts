	...
	if (!unk_0xEB6A8945D1AC98A1(*iParam0))
	{
		...
		switch (iLocal_258)
		{
			...
			case 1:
				...
				else if (unk_0x69DF961355195C3C(Global_96074))
				{
					...
					if (!unk_0xB4ECF989E2C1DAC8(*iParam0, &cLocal_268, &cLocal_286, 2))
					{
						...
						unk_0x96167B03C5A77156(*iParam0, vLocal_264 + vLocal_266, 1f, -1, (fLocal_267 * 0.1f), 0, 1193033728);
			...
			case 3:
				...
				{
					if (vdist2(unk_0x68F4C0EC296D3901(*iParam0, true), vLocal_264 + vLocal_266) < (fLocal_267 * fLocal_267))
					{
						if (fLocal_267 == 0f)
						{
							fLocal_267 = (vmag(vLocal_266) * 0.75f);
						}
						unk_0xA371FDC12D462090(*iParam0, vLocal_264 + vLocal_266, fLocal_267, 1077936128, 1086324736);
						func_135(4, 0);
						return 1;
					}
				}
			...
			case 5:
				...
				else
				{
					...
					{
						if (vdist2(unk_0x68F4C0EC296D3901(*iParam0, true), vVar5) > 100f)
						{
							unk_0x96167B03C5A77156(*iParam0, vVar5, 1f, -1, 1048576000, 0, 1193033728);
...
void func_52(int iParam0)
{
	...
	else if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_20559.f_471, iParam0) || unk_0xEAE0D21A50E6C7F4(Global_2097152[func_54() /*10930*/].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x0674E58A79778E99(&(Global_111638.f_20559.f_471), iParam0);
		unk_0x0674E58A79778E99(&(Global_2097152[func_54() /*10930*/].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_60(int iParam0)
{
	...
	return unk_0xEAE0D21A50E6C7F4(Global_2097152[func_54() /*10930*/].f_6174.f_10, iParam0);
}
