...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_29[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_27[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_24[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_14()
{
	switch (Global_31011)
	{
		...
		case 1:
			...
			{
				case 0:
					if (unk_0x762119754C50557A(iLocal_20[Global_31013]) && unk_0x797C48AACDB248B0(iLocal_20[Global_31013]))
					{
						Global_31014 = 0;
					}
					else
				...
				case 1:
					if (unk_0x762119754C50557A(iLocal_22[Global_31013]) && unk_0x797C48AACDB248B0(iLocal_22[Global_31013]))
					{
						Global_31014 = 0;
					}
					else
				...
				case 2:
					if (unk_0x762119754C50557A(iLocal_23[Global_31013]) && unk_0x797C48AACDB248B0(iLocal_23[Global_31013]))
					{
						Global_31014 = 0;
					}
					else
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	iLocal_23[iParam0] = unk_0x2D7B5CDDF12654D2(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)
{
	...
	iLocal_22[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)
{
	...
	iLocal_21[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iLocal_20[iParam0] = unk_0x2D7B5CDDF12654D2(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
