...
int func_2()
{
	...
	if (!unk_0xEA6BC48857E0AC4C(&Local_464))
	{
		...
		fVar3 = vdist2(unk_0x68F4C0EC296D3901(iLocal_447[iVar1], false), unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false));
...
int func_3(char* sParam0, int iParam1, int iParam2)
{
	...
	fVar2 = vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iLocal_447[*iParam2], false));
	if (fVar2 > (30f * 30f))
	{
		if (fVar2 > (150f * 150f))
		{
	...
	func_30(&uLocal_269, 2, unk_0x16F2683693E537C9(), "TREVOR", 0, 1);
...
int func_69(int iParam0, int iParam1)
{
	...
	switch (iLocal_480[iParam0])
	{
		case 0:
			...
			if (fLocal_463 >= 0f)
			{
				if (unk_0xDF1306B443CD3D15(iLocal_450[iParam0], 0))
				{
					if (!unk_0x20D6474D5F4B9FC6(iLocal_450[iParam0]))
					{
						unk_0x4D3C3C0B0DE2663E(iLocal_450[iParam0], iLocal_461[iParam0], &Local_458, 1);
					}
		...
		case 1:
			...
			if (unk_0x20D6474D5F4B9FC6(iLocal_450[iParam0]))
			{
				...
				{
					bVar1 = false;
					if (!unk_0x0A5D59F37DC7E974(iLocal_447[iParam0]) == 6)
					{
				...
				if (!unk_0xE0058AC511E68F8A(iLocal_450[iParam0]))
				{
					if (!unk_0x0A5D59F37DC7E974(iLocal_447[iParam0]) == 6)
					{
						if (unk_0x7AABDE381A013256(unk_0x68F4C0EC296D3901(iLocal_450[iParam0], true) - Vector(1f, 1f, 1f), unk_0x68F4C0EC296D3901(iLocal_450[iParam0], true) + Vector(1f, 1f, 1f), 0, 1, 0, 0, 0, 0, 0))
						{
				...
				if (unk_0xB87D13D0C064E9D1(iLocal_447[iParam0], unk_0x16F2683693E537C9(), 1) || unk_0xB87D13D0C064E9D1(iLocal_450[iParam0], unk_0x16F2683693E537C9(), 1))
				{
					unk_0xC55F2A0377488064(iLocal_450[iParam0]);
					return 0;
				}
			...
			else
			{
				...
				if (!unk_0x0A5D59F37DC7E974(iLocal_447[iParam0]) == 6)
				{
					...
					unk_0xFADC0A217229F6B5(iLocal_447[iParam0], true);
					if (iLocal_268 == 281)
					{
				...
				{
					unk_0x6C3AE6E278DB3D0E(iLocal_447[iParam0], unk_0x16F2683693E537C9(), 0, 16);
					unk_0xAFF39FB306F8E232(iLocal_447[iParam0], 1, true);
					unk_0xFADC0A217229F6B5(iLocal_447[iParam0], true);
					unk_0x3245169DF7F47EAF(unk_0xD803B885F5E47A62());
					unk_0xB61FC7262CB2E7A1(unk_0xD803B885F5E47A62());
		...
		case 2:
			...
			if (unk_0x82CCEAB29E9451DD(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				if (unk_0xD1960163A3042274(iLocal_447[iParam0], -258271821) != 1)
				{
					unk_0xE072601B4380E9DF(iLocal_447[iParam0], iLocal_450[iParam0], fLocal_265, iLocal_266);
				}
				else
		...
		case 4:
			...
			if (!unk_0x82CCEAB29E9451DD(iLocal_447[iParam0], iLocal_450[iParam0]))
			{
				...
				{
					unk_0x5B1D360B9C6F0A09(iLocal_447[iParam0], iLocal_450[iParam0], 20000, -1, 2f, 1, 0);
				}
			}
			else
			{
		...
		case -2:
			if (!unk_0xEB6A8945D1AC98A1(iLocal_447[iParam0]))
			{
				if (unk_0xD1960163A3042274(iLocal_447[iParam0], 1805844857) != 1)
				{
					unk_0x4E885A246A9D983A(iLocal_447[iParam0], 29, true);
					unk_0xF3268524E9BE6D6E(iLocal_447[iParam0], unk_0x16F2683693E537C9(), 150f, -1, 0, 0);
				}
			}
			else
			{
...
int func_80()
{
	...
	if (!unk_0x437347B10A200C4B(iVar0, 0))
	{
		...
		else
		{
			...
			while (iVar1 < 4)
			{
				if (unk_0xDF1306B443CD3D15(iLocal_450[iVar1], 0) && !unk_0xEB6A8945D1AC98A1(iLocal_447[iVar1]))
				{
					if (!unk_0xEA6BC48857E0AC4C(&Local_458) && iLocal_461[iVar1] > 0)
					{
						unk_0x4D3C3C0B0DE2663E(iLocal_450[iVar1], iLocal_461[iVar1], &Local_458, 1);
						unk_0xF12C1D85AFEE8FAD(iLocal_450[iVar1], fLocal_462);
						unk_0x60274E99F9B27DEA(iLocal_447[iVar1], iLocal_450[iVar1], 0, 15, 20f, iLocal_266, 0.5f, 2f, 1);
						if (unk_0x0A5D59F37DC7E974(iLocal_447[iVar1]) == 6)
						{
							unk_0xAA280AF45BCCCF21(iLocal_450[iVar1], 1);
						}
					}
				}
				iVar1++;
...
void func_89()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < 4)
		{
			...
			if (!unk_0xEA6BC48857E0AC4C(&Local_458) && iLocal_461[iVar0] > 0)
			{
	...
	unk_0x0E2400AB9174FA81(3, iLocal_455, 1862763509);
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (iLocal_451[iVar0] != 0)
		{
			unk_0x536F1BE96C726C4B(vLocal_456 + vLocal_452[iVar0 /*3*/], 20f, 1, 0, 0, false);
			iLocal_450[iVar0] = unk_0x122AAB0B1D6F55AD(iLocal_451[iVar0], vLocal_456 + vLocal_452[iVar0 /*3*/], (fLocal_457 + fLocal_453[iVar0]), true, true, false);
			unk_0xC6A6B4DDD6DC073A(iLocal_450[iVar0], iLocal_454);
			unk_0x71199B01895C6202(iLocal_451[iVar0]);
			unk_0x120A395B0ECB8EA5(iLocal_450[iVar0], true);
		}
		if (iLocal_448[iVar0] != 0)
		{
			iLocal_447[iVar0] = unk_0x852A19533F896693(iLocal_450[iVar0], iLocal_449, iLocal_448[iVar0], -1, 1, true);
			unk_0xC743BD39A24D0583(iLocal_447[iVar0], 0);
			unk_0x71199B01895C6202(iLocal_448[iVar0]);
			unk_0x6DF7BF67E86AAE86(iLocal_447[iVar0], iLocal_455);
			unk_0x11AD11297DC58CC7(iLocal_447[iVar0], true);
			if (iLocal_448[iVar0] == joaat("a_m_y_roadcyc_01"))
			{
				unk_0xCC095276B3DD380E(iLocal_447[iVar0], 1);
			}
			if (iLocal_449 != 6)
			{
				unk_0x3CC33E4E9CE523F4(iLocal_447[iVar0], 3);
				unk_0xAFF39FB306F8E232(iLocal_447[iVar0], 17, true);
				unk_0xBAFED2F6486F771A(iLocal_447[iVar0], 1, true);
				unk_0xBAFED2F6486F771A(iLocal_447[iVar0], 2, true);
			}
		}
		iVar0++;
	}
...
void func_90()
{
	...
	switch (iLocal_268)
	{
		...
		case 275:
			...
			fLocal_453[1] = unk_0x79833B02DBD2A244(-5f, 5f);
			fLocal_453[2] = unk_0x79833B02DBD2A244(-5f, 5f);
			fLocal_453[3] = unk_0x79833B02DBD2A244(-5f, 5f);
		...
		case 277:
			...
			fLocal_453[0] = unk_0x79833B02DBD2A244(-5f, 5f);
			fLocal_453[1] = unk_0x79833B02DBD2A244(-5f, 5f);
			fLocal_453[2] = unk_0x79833B02DBD2A244(-5f, 5f);
			fLocal_453[3] = unk_0x79833B02DBD2A244(-5f, 5f);
			iLocal_448[0] = joaat("s_m_y_ranger_01");
		...
		default:
			...
			vLocal_452[0 /*3*/] = { Vector(0f, cos(fVar5), sin(fVar5)) * FtoV(unk_0x79833B02DBD2A244(15f, 25f)) };
			fLocal_453[0] = unk_0x79833B02DBD2A244(-5f, 5f);
			iLocal_454 = 0;
			iLocal_448[0] = joaat("a_m_y_genstreet_01");
			iLocal_448[1] = 0;
