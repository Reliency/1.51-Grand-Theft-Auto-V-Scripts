		...
		if (!func_104(0) && !func_103(14))
		{
			if (iLocal_47 == 0)
			{
				if (func_113())
				{
					...
					bLocal_59 = unk_0xEAE0D21A50E6C7F4(Global_7357, 28);
					if (iLocal_48 != -1)
					{
						if (fVar0 < fLocal_46)
						{
...
void func_2(int iParam0, bool bParam1)
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			unk_0x5D96D8530B3D0904(&(Global_111638.f_24990), iVar0);
		}
		else
		{
			unk_0x0674E58A79778E99(&(Global_111638.f_24990), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			unk_0x5D96D8530B3D0904(&(Global_111638.f_24990.f_1), iVar0);
		}
		else
		{
			unk_0x0674E58A79778E99(&(Global_111638.f_24990.f_1), iVar0);
		}
	}
}
...
void func_23(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_13(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_13(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_24(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			{
				unk_0x5D96D8530B3D0904(&(Global_111638.f_2358.f_539.f_3816[0 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
		...
		case joaat("player_two"):
			...
			{
				unk_0x5D96D8530B3D0904(&(Global_111638.f_2358.f_539.f_3816[1 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			if (!bParam3 || unk_0xEAE0D21A50E6C7F4(Global_111638.f_7224[4], 0))
			{
				unk_0x5D96D8530B3D0904(&(Global_111638.f_2358.f_539.f_3816[2 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
	}
}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_24(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
bool func_93(int iParam0)
{
	...
	return unk_0xEAE0D21A50E6C7F4(Global_111638.f_10044.f_135[iVar0], iVar1);
}
...
void func_95(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		unk_0x5D96D8530B3D0904(&(Global_111638.f_10044.f_135[iVar0]), iVar1);
	}
	else
	{
		unk_0x0674E58A79778E99(&(Global_111638.f_10044.f_135[iVar0]), iVar1);
	}
}
...
void func_98(vector3 vParam0, vector3 vParam1, vector3 vParam2, float fParam3, float fParam4)
{
	...
	*fParam3 = vdist(vVar0, vVar1);
	*fParam4 = vdist(vVar0, vVar2);
}
...
int func_102(float fParam0)
{
	...
	while (iVar0 < 50)
	{
		if (!func_93(iVar0))
		{
			fVar3 = vdist2(vVar2, Local_54[iVar0 /*8*/]);
...
bool func_105()
{
	...
	return Global_111638.f_10044.f_135[iVar0] == (round(pow(2f, to_float(iVar1 + 1))) - 1);
}
