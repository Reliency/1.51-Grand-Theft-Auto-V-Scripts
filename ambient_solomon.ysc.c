...
{
	iParam0->f_1 = unk_0x122AAB0B1D6F55AD(joaat("akuma"), vParam1, fParam2, 1, 1, 0);
	if (func_75(iParam0->f_1))
	{
		...
		unk_0x56FDC9ADE35F7DB0(iParam0->f_1, 0, 1, 0);
		*iParam0 = unk_0x852A19533F896693(iParam0->f_1, 26, unk_0x134B62B726CEC8E6(unk_0x16F2683693E537C9()), -1, 1, 1);
		if (func_75(*iParam0))
		{
			unk_0x11AD11297DC58CC7(*iParam0, 1);
			unk_0x4A4806F9D471E491(*iParam0, false, 0);
			unk_0x33CE5A9E32EA10B2(*iParam0, 1);
		}
	}
}
...
void func_9(int iParam0)
{
	...
	bVar1 = false;
	bVar2 = false;
	fVar4 = unk_0x0EB28750412C3A5A(Var0, unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), 1), 1);
...
int func_57(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)
{
	...
	if (unk_0x3D1053F9EB43B7AD(iParam0, vParam1, vParam2, fParam3, 0, 1, 0))
	{
		return 1;
	}
	...
	if (unk_0x0399732A9EBC368E(vVar0, vParam1, vParam2, fParam3, 0, 1))
	{
		return 1;
	}
