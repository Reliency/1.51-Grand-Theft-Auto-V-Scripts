					...
					if (unk_0xE1DBBD6CE209517C(unk_0xD803B885F5E47A62()))
					{
						switch (iLocal_47)
						{
							...
							case 1:
								if (!func_145())
								{
									if ((unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_59, 75f, 75f, 75f, false, true, 0) && !unk_0x03068588A1FCED1A(iLocal_58)) || unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_58, 15f, 15f, 15f, 0, 1, 0))
									{
										if (!func_168())
										{
											unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), iLocal_58, -1, 0, 2);
							...
							case 3:
								...
								if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
								{
									unk_0x08082071A5F7C155(iLocal_58, 3, 0f, 0);
							...
							case 4:
								if (!bLocal_64)
								{
									if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
									{
										...
										{
											unk_0xC6EB89C59F2AF6B8(iLocal_58, "random@homelandsecurity", "knees_to_stand_girl", 4f, -4f, -1, 0, 0.3f, 0, 0, 0);
										}
										else
										{
							...
							case 5:
								...
								if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
								{
									if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_67, Global_22, true, true, 0) && unk_0x12DE711B1C681E9E(iLocal_58, unk_0x16F2683693E537C9(), 8f, 8f, 8f, 0, 1, 0))
									{
										if (unk_0x16102BEDC7435774(iLocal_58))
										{
											if (unk_0xE4EDC4B0E92C078B(iLocal_88))
											...
											else
											{
												...
												if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
												{
													...
													unk_0x96167B03C5A77156(0, vLocal_68, 1f, -1, 0.25f, 0, 38.9844f);
...
void func_39(int iParam0)
{
	...
	else if (unk_0xEAE0D21A50E6C7F4(Global_111638.f_20559.f_471, iParam0) || unk_0xEAE0D21A50E6C7F4(Global_2097152[func_41() /*10930*/].f_6174.f_10, iParam0))
	{
		bVar0 = true;
		unk_0x0674E58A79778E99(&(Global_111638.f_20559.f_471), iParam0);
		unk_0x0674E58A79778E99(&(Global_2097152[func_41() /*10930*/].f_6174.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_45(int iParam0)
{
	...
	return unk_0xEAE0D21A50E6C7F4(Global_2097152[func_41() /*10930*/].f_6174.f_10, iParam0);
}
	...
	if (!bLocal_104)
	{
		switch (iLocal_49)
		{
			...
			case 5:
				...
				{
					unk_0xDD353D0E9C789D0E(&iLocal_102);
					unk_0x0C8C0C840C2D1AD2(0, iLocal_58, -1, 2054, 2);
					unk_0xF96A174EE26D7588(0, iLocal_58, -1);
					unk_0x75ABDC5F81978924(iLocal_102);
					unk_0x78ADC381772E3D54(iLocal_50[0], iLocal_102);
					unk_0xFADC0A217229F6B5(iLocal_50[0], true);
					iLocal_83 = 1;
								...
								if (!func_118())
								{
									if (unk_0x7069CC4DE1EA3FAA(iLocal_50[0], iLocal_58, 10f))
									{
										if (func_116(&uLocal_120, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
										{
											...
											unk_0xD65E6E13E145467B(iLocal_53, "exit_car", "random@homelandsecurity", 4f, false, 0, 0, 0f, 0);
											iLocal_116 = 1;
											iLocal_93 = unk_0x1C0640BA9A7327B3();
											iLocal_49 = 6;
										}
						...
						if (!func_118())
						{
							if (unk_0x7069CC4DE1EA3FAA(iLocal_50[0], iLocal_58, 10f))
							{
								if (func_116(&uLocal_120, "REHOMAU", "REHOM_ARR", 4, 0, 0, 0))
								{
									...
									unk_0x915804B434753CBD(iLocal_50[0], iLocal_115, "random@homelandsecurity", "exit_cop_gun", 2f, -4f, 1, 0, 1148846080, 0);
									unk_0x915804B434753CBD(iLocal_50[1], iLocal_115, "random@homelandsecurity", "exit_cop_ground", 2f, -4f, 1, 0, 1148846080, 0);
									unk_0xD65E6E13E145467B(iLocal_53, "exit_car", "random@homelandsecurity", 2f, false, 0, 0, 0f, 0);
									iLocal_116 = 1;
									iLocal_93 = unk_0x1C0640BA9A7327B3();
									iLocal_49 = 6;
								}
				...
				if (unk_0x69DF961355195C3C(iLocal_115))
				{
					if (unk_0xA45992A6CE82FB43(iLocal_115) > 0.9f)
					{
						if (unk_0xDF1306B443CD3D15(iLocal_53, 0))
						{
							if (!unk_0xEB6A8945D1AC98A1(iLocal_50[0]))
							{
								unk_0x5B1D360B9C6F0A09(iLocal_50[0], iLocal_53, -1, -1, 1f, 9, 0);
								iLocal_49 = 7;
							}
						}
					}
				...
				if (unk_0x69DF961355195C3C(iLocal_115))
				{
					if (unk_0xA45992A6CE82FB43(iLocal_115) > 0.95f)
					{
						if (unk_0xDF1306B443CD3D15(iLocal_53, 0))
						{
							if (!unk_0xEB6A8945D1AC98A1(iLocal_50[1]))
							{
								unk_0x5B1D360B9C6F0A09(iLocal_50[1], iLocal_53, -1, 0, 1f, 9, 0);
								unk_0xFADC0A217229F6B5(iLocal_50[1], true);
								iLocal_49 = 8;
							}
						}
			...
			case 8:
				...
				if ((unk_0xDF1306B443CD3D15(iLocal_53, 0) && !unk_0xEB6A8945D1AC98A1(iLocal_50[0])) && !unk_0xEB6A8945D1AC98A1(iLocal_50[1]))
				{
					if ((unk_0x82CCEAB29E9451DD(iLocal_58, iLocal_53) && unk_0x82CCEAB29E9451DD(iLocal_50[0], iLocal_53)) && unk_0x82CCEAB29E9451DD(iLocal_50[1], iLocal_53))
					{
						...
						unk_0xAA280AF45BCCCF21(iLocal_53, 1);
						bLocal_104 = true;
					}
				}
				break;
			...
			case 13:
				...
				if (iLocal_107)
				{
					if (!unk_0xEB6A8945D1AC98A1(iLocal_50[1]))
					{
						if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
						{
							if (unk_0xD1960163A3042274(iLocal_50[1], 1785177548) != 1)
							{
								...
								unk_0xA8CC11FF8D2962D4(0, iLocal_58, -1f, 0f, 0f, 1f, -1, 1036831949, 1);
								unk_0x75ABDC5F81978924(iLocal_102);
								unk_0x78ADC381772E3D54(iLocal_50[1], iLocal_102);
								unk_0xF82EA857DA10E0CD(&iLocal_102);
							}
					...
					if (!unk_0xEB6A8945D1AC98A1(iLocal_58))
					{
						...
						{
							unk_0x5DA3F35E3BFDEE66(iLocal_58, unk_0x16F2683693E537C9(), -1, 0);
							unk_0xFADC0A217229F6B5(iLocal_58, true);
						}
					}
				}
...
void func_146()
{
	...
	unk_0x262EF6C6306BEA6C(iLocal_50[0], joaat("weapon_pistol"), -1, true, true);
	unk_0x262EF6C6306BEA6C(iLocal_50[1], joaat("weapon_pistol"), -1, false, true);
	unk_0x0E2400AB9174FA81(5, iLocal_119, 1862763509);
	unk_0x0E2400AB9174FA81(1, iLocal_119, -1533126372);
	unk_0x0E2400AB9174FA81(1, -1533126372, iLocal_119);
		...
		while (iVar0 < iLocal_50)
		{
			if (unk_0xC844350D5D58C99A(iLocal_50[iVar0]))
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_50[iVar0]))
				{
					if (unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
					{
						unk_0x731C6942D48648D6(iLocal_50[iVar0], func_226(unk_0xD803B885F5E47A62()), -1, 0, 0);
