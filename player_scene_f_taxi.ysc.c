...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0x68F4C0EC296D3901(iLocal_68, false) };
		fVar2 = vdist2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0xE072601B4380E9DF(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0x69DF961355195C3C(Global_96074))
		{
			...
			if (!func_5(Global_98465, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0xF821F915BC24D246(Global_98465, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
				unk_0x1E9649458B15960F(iLocal_68, false);
				iLocal_172 = 1;
			}
			unk_0xD1F0F33C375B8446(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_98465, iLocal_70, 2))
			...
			unk_0x1BF8B16C32704027(iLocal_70, -8f, 1);
			wait(100);
			if (!func_3(&uVar0))
			{
				unk_0xDD353D0E9C789D0E(&iVar2);
				unk_0xD1F0F33C375B8446(0, iLocal_70, 24, 50);
				unk_0x78A77CDD64392938(0, 2000);
				unk_0xE9362E4D600DD12A(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x75ABDC5F81978924(iVar2);
				unk_0x78ADC381772E3D54(iLocal_68, iVar2);
...
void func_22()
{
	...
	unk_0xAB8E2DDC7AF955E0(iLocal_69, true);
	iLocal_70 = unk_0x6E7D01E16ABEFABB(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0xC844350D5D58C99A(Global_98465) || !unk_0xC844350D5D58C99A(iLocal_70)) || (!unk_0xB87F6CF6E5628C67(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0x56FDC9ADE35F7DB0(iLocal_70, true, true, 0);
		unk_0x71EDC33E5A423750(iLocal_70, 2);
		unk_0xB9FD7450C0DAB575(iLocal_70, 1084227584);
		iLocal_68 = unk_0x852A19533F896693(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0xC743BD39A24D0583(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 17, 1785177548, 1785177548, unk_0x79833B02DBD2A244(-5f, 5f), unk_0x79833B02DBD2A244(-5f, 5f), 0f, unk_0x79833B02DBD2A244(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 144, 1785177548, 1785177548, unk_0x79833B02DBD2A244(-5f, 5f), unk_0x79833B02DBD2A244(-5f, 5f), 0f, unk_0x79833B02DBD2A244(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_109 = 1785177548;
			uParam1->f_110 = 1785177548;
			func_27(uParam1, 43, 1785177548, 1785177548, unk_0x79833B02DBD2A244(-5f, 5f), unk_0x79833B02DBD2A244(-5f, 5f), 0f, unk_0x79833B02DBD2A244(-180f, 180f));
			uParam1->f_118 = 1;
			return 1;
			break;
...
void func_50()
{
	if (!unk_0x437347B10A200C4B(iLocal_68, 0) && unk_0x9C77D2D0559097F0(iLocal_68, 1))
	{
		unk_0x6DAD7906B73F064D(&iLocal_68);
	}
	if (!unk_0x437347B10A200C4B(iLocal_70, 0) && unk_0x9C77D2D0559097F0(iLocal_70, 1))
	{
		unk_0x046C362CF15F1935(&iLocal_70);
	}
	unk_0xAB8E2DDC7AF955E0(iLocal_69, false);
	unk_0x71199B01895C6202(iLocal_69);
