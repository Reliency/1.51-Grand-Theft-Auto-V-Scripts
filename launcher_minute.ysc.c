...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Var0 == 32)
		{
			...
			{
				if (!func_207(329.513f, 3402.691f, 36.258f, unk_0x68F4C0EC296D3901(Var0.f_35[1], true), 1056964608))
				{
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam6) && func_191(unk_0x16F2683693E537C9(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	...
	if (!*uParam8 == 3)
	{
		if (func_178(2))
		{
			if (!func_146())
			{
				if (((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && func_127(iParam0->f_28[1])) && func_191(unk_0x16F2683693E537C9(), vParam1, 1) < 20f)
				{
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0x16F2683693E537C9(), uParam0->f_35[iVar0]))
							{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_35[1]))
			{
				...
				unk_0xC6A6B4DDD6DC073A(uParam0->f_35[1], 0);
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[1]))
			{
				...
				unk_0x9F528B1B53FBC5D9(uParam0->f_41[1], uParam0->f_28[0], unk_0x4A089F2B762B8D33(uParam0->f_28[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_35[0]))
			{
				...
				unk_0xCCD53AC1B5D5E456(uParam0->f_35[0], 14f);
				unk_0xAB8E2DDC7AF955E0(iVar0[0], true);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_35[1]))
			{
				...
				unk_0x05EC10F460C3A4AF(uParam0->f_35[1], 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (unk_0xB4AE0788C1587752("rcmminute1"))
			{
				...
				{
					if (!unk_0xB4ECF989E2C1DAC8(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0xA3BF0AA5A2608191(uParam0->f_28[0]);
						unk_0xC6EB89C59F2AF6B8(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_127(uParam0->f_28[1]))
				{
					...
					unk_0xC6EB89C59F2AF6B8(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x4E885A246A9D983A(uParam0->f_28[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
