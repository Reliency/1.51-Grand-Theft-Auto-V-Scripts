...
int func_2()
{
	...
	fVar0 = vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
void func_20()
{
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			...
			unk_0x3E8E48829F3C7624(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0, 2, 0);
			...
			if (iLocal_83[iVar0] > 0)
			{
				...
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0xBC92C4B04B43E102(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
