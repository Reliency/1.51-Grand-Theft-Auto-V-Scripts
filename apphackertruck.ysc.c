...
void func_4()
{
	...
	{
		if (unk_0xC95D7AEEDEF4946B(uLocal_298))
		{
			iVar0 = unk_0xA52833FE33F41C53(uLocal_298);
			switch (iVar0)
			{
				case 0:
					func_454();
...
void func_6()
{
	...
	while (iVar0 < 5)
	{
		...
		unk_0x7E60C62A7CE58FC8(uLocal_297, "ADD_JOB");
...
{
	unk_0x7E60C62A7CE58FC8(uLocal_297, "SHOW_JOB_OVERLAY");
...
void func_29()
{
	...
	unk_0x7E60C62A7CE58FC8(uLocal_297, "CLEAR_JOBS");
	unk_0x7E60D21B163E9D56();
	iVar0 = 0;
	while (iVar0 < 9)
	{
...
int func_217()
{
	if (Global_1590535[unk_0xD803B885F5E47A62() /*876*/].f_274.f_183[5 /*12*/].f_4 == 1 && !func_23(5))
	{
		return 1;
	}
	return 0;
	...
	else
	{
		...
		else
		{
			...
			if (iVar9 <= 0)
			{
				if (!func_226())
				{
					iVar9 = (Global_262145.f_15096 - unk_0x51D1D19912234EA0(unk_0x519D13E6C1911A0B(unk_0x1C0640BA9A7327B3(), Global_2514606.f_142)));
				}
			}
			if (iVar9 > 0)
			{
		...
		if (func_321(iVar6, 1, 1))
		{
			...
			while (iVar4 < 10)
			{
				if (iVar0[iVar4] != -1)
				{
					...
					if (!func_319(vVar7))
					{
						if (unk_0xE4EDC4B0E92C078B(Global_2416079[iVar6]))
						{
							vVar8 = { unk_0xAC14F6E4B17D7835(Global_2416079[iVar6]) };
						...
						if (!func_319(vVar8))
						{
							if (vdist2(vVar8, vVar7) < (func_262(iParam0, bVar9) * func_262(iParam0, bVar9)))
							{
								iVar0[iVar4] = -1;
								if (!bVar9)
								{
...
Vector3 func_263(int iParam0)
{
	...
	{
		vVar1 = { func_317(func_318(Global_1590535[unk_0xD803B885F5E47A62() /*876*/].f_274.f_28)) };
		if (vmag(vVar1) > 0f)
		{
			return vVar1;
		}
...
{
	unk_0x7E60C62A7CE58FC8(uLocal_297, "SHOW_OVERLAY");
	func_8(sParam0);
...
void func_359(int iParam0)
{
	...
	iLocal_123 = iParam0;
	unk_0x7E60C62A7CE58FC8(uLocal_297, "SHOW_SCREEN");
	unk_0x3CAEA85DA607305E(iParam0);
	unk_0x7E60D21B163E9D56();
}
...
int func_411(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (iParam0 == 4)
	{
		...
		if (iVar5 != 0)
		{
			...
			while (iVar0 < 4)
			{
				Global_1628237[unk_0xD803B885F5E47A62() /*615*/].f_11.f_354[iVar0] = func_417(iVar5);
				iVar0++;
			}
			bVar3 = true;
		}
	...
	if (iParam0 != 4)
	{
		...
		else if (iVar4 >= iParam1)
		{
			...
			while (iVar0 < iParam1)
			{
				Global_1628237[unk_0xD803B885F5E47A62() /*615*/].f_11.f_354[iVar0] = func_412(&iVar1, iVar4, &uVar8);
				iVar0++;
			}
			bVar3 = true;
		}
...
int func_412(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_327(iVar4))
	{
		vVar6 = { Global_1676377.f_488[func_415(func_222(iVar4)) /*3*/] };
		vVar6.z = 0f;
	}
	else
	{
...
int func_426(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	...
	if (iVar3 > 0)
	{
		if (!unk_0x7A7BDE279347E517(iVar3, false, true, 0, -1, 0))
		{
			unk_0x4D7F4CC43D4D0DE3(-1, "Select_Mission_Unavailable", "DLC_GR_MOC_Computer_Sounds", 1);
			return 0;
		}
	...
	if (iVar3 >= 0 && (iVar3 == 0 || (iVar3 > 0 && (func_391() || unk_0x7A7BDE279347E517(iVar3, false, true, 0, -1, 0)))))
	{
		if (iVar3 > 0)
		{
...
void func_454()
{
	unk_0x7E60C62A7CE58FC8(uLocal_297, "HIDE_OVERLAY");
	unk_0x7E60D21B163E9D56();
	func_357(0);
...
void func_455()
{
	if (func_456())
	{
		if (!unk_0xEAE0D21A50E6C7F4(iLocal_116, 3))
		{
			unk_0x7E60C62A7CE58FC8(uLocal_297, "GET_CURRENT_SELECTION");
			uLocal_298 = unk_0x7A8BB56B212464AC();
...
void func_457()
{
	...
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(205), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_462(2, 206, 1);
	if (unk_0xBFC0798A6E3417F9(2, 206))
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(206), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x9E6C8D8976DA0ECD(2))
	{
		...
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_462(2, 187, 1);
		if (unk_0xBFC0798A6E3417F9(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xB9132A06AE472728(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_RELEASE_EVENT", to_float(300), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		if (unk_0xB9132A06AE472728(2, 188))
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_RELEASE_EVENT", to_float(301), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	else
	{
		...
		if (unk_0xBFC0798A6E3417F9(2, 188))
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(188), -1082130432, -1082130432, -1082130432, -1082130432);
		}
		func_462(2, 187, 1);
		if (unk_0xBFC0798A6E3417F9(2, 187))
		{
			unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(187), -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	func_462(2, 189, 1);
	if (unk_0xBFC0798A6E3417F9(2, 189))
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(189), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_462(2, 190, 1);
	if (unk_0xBFC0798A6E3417F9(2, 190))
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(190), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_462(2, 201, 1);
	if (unk_0xBFC0798A6E3417F9(2, 201))
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(201), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_462(2, 202, 1);
	...
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(203), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	func_462(2, 204, 1);
	if (unk_0xBFC0798A6E3417F9(2, 204))
	{
		unk_0x1FF2BF40EEFA5ABC(uLocal_297, "SET_INPUT_EVENT", to_float(204), -1082130432, -1082130432, -1082130432, -1082130432);
	}
	if (unk_0x9E6C8D8976DA0ECD(2))
	{
		unk_0x7E60C62A7CE58FC8(uLocal_297, "SET_MOUSE_INPUT");
	...
	else
	{
		...
		{
			unk_0x7E60C62A7CE58FC8(uLocal_297, "SET_ANALOG_STICK_INPUT");
			iLocal_299 = iVar0;
			iLocal_300 = iVar1;
...
void func_459()
{
	unk_0x7E60C62A7CE58FC8(uLocal_297, "HIDE_JOB_OVERLAY");
	unk_0x7E60D21B163E9D56();
...
void func_464()
{
	...
	unk_0xD9ACBBA59FD5A09E(1);
	unk_0x6567AE843FADBA94(uLocal_297, 255, 255, 255, 255, 0);
	func_475();
	func_468(0);
	func_465(1);
}
...
void func_482(int iParam0)
{
	...
	unk_0x7E60C62A7CE58FC8(uLocal_297, "UPDATE_MISSION");
	iVar0 = iParam0;
	iVar1 = 0;
			...
			while (iVar0 < 6)
			{
				...
				if (func_20(iVar1))
				{
					if (func_27(iVar1) == func_488(iParam0) && func_21(unk_0xD803B885F5E47A62(), iVar1))
					{
						...
						if (Global_1590535[unk_0xD803B885F5E47A62() /*876*/].f_274.f_183[iVar2 /*12*/].f_7 || Global_1370147[iVar2] != 0)
						{
							return Global_1590535[unk_0xD803B885F5E47A62() /*876*/].f_274.f_183[iVar2 /*12*/].f_4 > 0;
						}
					}
				}
				iVar0++;
...
{
	unk_0x7E60C62A7CE58FC8(uLocal_297, "UPDATE_COOLDOWN");
	unk_0x3CAEA85DA607305E(iParam0);
...
{
	func_530();
	uLocal_297 = unk_0xB01F55A0FD1CFD49("hacker_truck_desktop");
	while (!unk_0x83D8570832F172A7(uLocal_297))
	{
		wait(0);
	}
	func_469(1);
...
{
	unk_0xE17FDF9E3068281B(&uLocal_297);
	func_539(iParam0);
	func_541(0);
	func_544();
