...
void func_1()
{
	switch (iLocal_21)
	{
		case 0:
			...
			else if ((unk_0x1C0640BA9A7327B3() - iLocal_187) > 12000 && vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iLocal_188, true)) <= 900f)
			{
				if (func_3(&uLocal_22, "NIGE3AU", "NIGEL3_REACT", 7, 0, 0, 0))
				{
					iLocal_21 = 1;
...
int func_22()
{
	...
	fVar0 = 200f;
	if (vdist2(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), true), unk_0x68F4C0EC296D3901(iLocal_188, true)) >= (fVar0 * fVar0) && !unk_0x0A059E0DB9253280(iLocal_188))
	{
		return 0;
	}
	return 1;
