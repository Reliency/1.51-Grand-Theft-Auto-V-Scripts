...
void func_1()
{
	...
	if (func_283(iLocal_422) && func_283(unk_0x16F2683693E537C9()))
	{
		...
		else if (unk_0xB87D13D0C064E9D1(iLocal_422, unk_0x16F2683693E537C9(), 1))
		{
			...
			unk_0xF3268524E9BE6D6E(iLocal_422, unk_0x16F2683693E537C9(), 80f, -1, 0, 0);
		}
		if (!unk_0xE9FDA1035CFEA94F(iLocal_422))
		{
			if ((func_36(iLocal_422, 1126825984) && !unk_0xB87D13D0C064E9D1(iLocal_422, unk_0x16F2683693E537C9(), 1)) && !func_28(iLocal_422, 1, 0, 0, 0))
			{
				...
				unk_0xA3BF0AA5A2608191(iLocal_422);
				unk_0x0C8C0C840C2D1AD2(iLocal_422, unk_0x16F2683693E537C9(), -1, 0, 2);
				unk_0xF3268524E9BE6D6E(iLocal_422, unk_0x16F2683693E537C9(), 80f, -1, 0, 0);
				iLocal_638 = 1;
			}
		}
	...
	if (unk_0xC844350D5D58C99A(iLocal_422))
	{
		...
		else if (func_34(iLocal_422, 1, 8f, 15f) || func_29(iLocal_422, 5f, 0, 0))
		{
			if (func_283(iLocal_422) && !unk_0xE9FDA1035CFEA94F(iLocal_422))
			{
				...
				unk_0xF3268524E9BE6D6E(iLocal_422, unk_0x16F2683693E537C9(), 500f, -1, 0, 0);
			}
			if (func_283(iLocal_423) && !unk_0xE9FDA1035CFEA94F(iLocal_423))
			{
				unk_0xF3268524E9BE6D6E(iLocal_423, unk_0x16F2683693E537C9(), 500f, -1, 0, 0);
			}
			iLocal_414 = 2;
			iLocal_420 = 0;
			iLocal_419 = 10;
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_283(iLocal_423))
			{
				...
				unk_0x96167B03C5A77156(0, unk_0x68E4ADDDDCD7BDDE(iLocal_423, 0.5f, 1f, 0f), 2.5f, 20000, 1048576000, 0, 1193033728);
			...
			if (func_283(iLocal_422))
			{
				...
				{
					unk_0xA8CC11FF8D2962D4(iLocal_422, iLocal_423, 0f, 0f, 0f, 2f, -1, 3f, 1);
				}
			}
			iLocal_673 = -1;
			iLocal_420 = 1;
...
void func_72()
{
	...
	switch (iLocal_420)
	{
		...
		case 1:
			...
			{
				unk_0xCEAA091B490F8407(-1, "COLLAR", iLocal_423, "NIGEL_1C_SOUNDSET", false, 0);
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (unk_0xEAE0D21A50E6C7F4(Global_76434[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_76434[1 /*14*/] = { func_143(iVar10, 14, uVar12[iVar1], -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_76434[1 /*14*/] = { func_143(iVar10, 14, uVar15[iVar1], -1) };
			func_113(iParam0, Global_76434[1 /*14*/].f_12, Global_76434[1 /*14*/].f_3, Global_76434[1 /*14*/].f_4);
			func_135(14);
			if (Global_76432 == 1)
			{
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_103(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_103(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_115(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_115(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_115(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_115(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_145(int iParam0)
{
	...
	func_146(&(Global_76434[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_152(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_146(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_146(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_103(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
	...
	switch (iLocal_420)
	{
		case 0:
			if (func_283(iLocal_423))
			{
				...
				unk_0xC6EB89C59F2AF6B8(0, sLocal_653, "chop_growl", 8f, -8f, -1, 9, 0, 0, 0, 0);
				unk_0x75ABDC5F81978924(iLocal_617);
				unk_0x78ADC381772E3D54(iLocal_423, iLocal_617);
				unk_0xF82EA857DA10E0CD(&iLocal_617);
...
void func_226()
{
				...
				if (func_228() || func_27(Local_421[0 /*16*/], unk_0x16F2683693E537C9(), 5f, 1))
				{
					if (func_27(Local_421[0 /*16*/], unk_0x16F2683693E537C9(), 12f, 1))
					{
						...
						if (func_88(&uLocal_452, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_1", 7, func_25(), 0))
						{
							...
							unk_0x96167B03C5A77156(0, Local_421[0 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
							unk_0x75ABDC5F81978924(iLocal_617);
			...
			if ((func_283(Local_421[1 /*16*/]) && func_283(unk_0x16F2683693E537C9())) && !unk_0xE9FDA1035CFEA94F(Local_421[1 /*16*/]))
			{
				if (func_27(Local_421[1 /*16*/], unk_0x16F2683693E537C9(), 8f, 1))
				{
					if (func_88(&uLocal_452, "NIG1CAU", "NIG1C_DOG", "NIG1C_DOG_4", 7, func_25(), 0))
					{
						...
						unk_0x0C8C0C840C2D1AD2(0, unk_0x16F2683693E537C9(), -1, 0, 2);
						unk_0xF96A174EE26D7588(0, unk_0x16F2683693E537C9(), 4000);
						unk_0x96167B03C5A77156(0, Local_421[1 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
						unk_0x75ABDC5F81978924(iLocal_617);
	...
	if (iLocal_634 == 1)
	{
		if (func_227() > 40)
		{
			...
			{
				unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), iLocal_423, -1, 0, 2);
				iLocal_634 = 0;
				iLocal_635 = 1;
			}
		}
		...
		if (func_221(Local_445) && func_283(iLocal_423))
		{
			...
			else if (unk_0xB72E131222E66495(iLocal_423))
			{
				if (func_232() == 19)
				{
					...
					unk_0x0C8C0C840C2D1AD2(Local_445.f_1, iLocal_423, -1, 0, 2);
		...
		if (func_221(Local_443) && func_283(iLocal_423))
		{
			...
			else if (unk_0xB72E131222E66495(iLocal_423))
			{
				if (func_232() > 25)
				{
					...
					unk_0x0C8C0C840C2D1AD2(Local_443.f_1, iLocal_423, -1, 0, 2);
					if (func_283(iLocal_429))
					{
						unk_0x0C8C0C840C2D1AD2(iLocal_429, iLocal_423, -1, 0, 2);
					}
				}
			}
			...
			if (iLocal_624 == 0)
			{
				if (unk_0x3D1053F9EB43B7AD(iLocal_423, -662.7688f, -208.3171f, 35.49321f, -674.6289f, -214.6519f, 38.80591f, 6.5f, 0, true, 0))
				{
					...
					if (func_283(Local_421[2 /*16*/]))
					{
						...
						unk_0xC6EB89C59F2AF6B8(0, sLocal_652, "reaction_backward_big_intro_c", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						unk_0xC6EB89C59F2AF6B8(0, sLocal_652, "react_big_variations_a", 8f, -8f, -1, 8192, 0, 0, 0, 0);
						unk_0xC6EB89C59F2AF6B8(0, sLocal_652, "exit_to_generic", 8f, -8f, -1, 8192, 0, 0, 0, 0);
			...
			switch (iLocal_412)
			{
				...
				case 5:
					if (unk_0x9C66D99E63E8E24C(Local_442) < 0.5f && unk_0x9C66D99E63E8E24C(Local_446) < 0.5f)
					{
						...
						unk_0x96167B03C5A77156(0, unk_0x68E4ADDDDCD7BDDE(Local_442.f_1, -1f, 1f, 0f), 1.3f, 20000, 1048576000, 0, 1193033728);
		...
		switch (iLocal_417)
		{
			...
			case 1:
				if (!unk_0xC42A92762C58E1B9(unk_0x16F2683693E537C9(), Local_446, 0))
				{
					...
					{
						unk_0xA3BF0AA5A2608191(Local_446.f_1);
						unk_0xF96A174EE26D7588(Local_446.f_1, unk_0x16F2683693E537C9(), -1);
				...
				if (func_236(Local_446.f_1, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					...
					unk_0xAFF39FB306F8E232(Local_446.f_1, 17, true);
					unk_0xA3BF0AA5A2608191(Local_446.f_1);
					unk_0xF3268524E9BE6D6E(Local_446.f_1, unk_0x16F2683693E537C9(), 60f, -1, 0, 0);
					iLocal_417 = 4;
				}
				break;
			...
			case 2:
				...
				if (func_71(unk_0x16F2683693E537C9(), Local_446.f_1, 1) > 20f)
				{
					...
					unk_0x5B1D360B9C6F0A09(0, Local_446, -1, -1, 1f, 1, 0);
					unk_0x75ABDC5F81978924(iLocal_617);
					unk_0x78ADC381772E3D54(Local_446.f_1, iLocal_617);
					unk_0xF82EA857DA10E0CD(&iLocal_617);
					iLocal_417 = 3;
...
void func_239()
{
	if (func_221(Local_444) && func_283(iLocal_423))
	{
		switch (iLocal_413)
		{
			...
			case 4:
				if ((unk_0xD1960163A3042274(Local_444.f_1, 242628503) != 1 && unk_0xBBA8A868118C90ED(Local_444, -1, 0)) && !unk_0xE9FDA1035CFEA94F(Local_444.f_1))
				{
					unk_0xDD353D0E9C789D0E(&iLocal_617);
					unk_0x96167B03C5A77156(0, unk_0x68E4ADDDDCD7BDDE(Local_444, -2f, 2f, 0f), 2f, 20000, 1048576000, 0, 1193033728);
					if (func_283(Local_441.f_1))
					{
					...
					unk_0x5B1D360B9C6F0A09(0, Local_444, -1, -1, 1.8f, 9, 0);
			...
			case 6:
				...
				unk_0x5B1D360B9C6F0A09(0, Local_444, -1, -1, 2.5f, 9, 0);
...
void func_242()
{
	if (func_283(iLocal_422))
	{
		unk_0xF96A174EE26D7588(iLocal_422, unk_0x16F2683693E537C9(), -1);
	}
	iLocal_420 = 0;
	iLocal_419 = 7;
}
	...
	if (func_283(Local_421[4 /*16*/]) && func_283(iLocal_423))
	{
		if (Local_421[4 /*16*/].f_13 == 0)
		{
			if (unk_0x12DE711B1C681E9E(Local_421[4 /*16*/], iLocal_423, 2.5f, 2.5f, 2f, 0, 1, 0))
			{
				...
				unk_0xDD353D0E9C789D0E(&iLocal_617);
				unk_0x0C8C0C840C2D1AD2(0, iLocal_423, -1, 0, 2);
				unk_0x96167B03C5A77156(0, -631.84f, -153.48f, 36.83f, 1f, 20000, 1048576000, 0, 1193033728);
	...
	if (!Local_421[iParam0 /*16*/].f_14)
	{
		if (func_283(Local_421[iParam0 /*16*/]) && func_283(iLocal_423))
		{
			if (!Local_421[iParam0 /*16*/].f_13)
			{
				if (unk_0xB72E131222E66495(iLocal_423))
				{
					if (func_232() > Local_421[iParam0 /*16*/].f_12)
					{
						...
						unk_0x96167B03C5A77156(0, Local_421[iParam0 /*16*/].f_6, 1f, 20000, 1048576000, 0, 1193033728);
						unk_0x75ABDC5F81978924(iLocal_617);
			...
			else if (func_27(Local_421[iParam0 /*16*/], iLocal_423, 3f, 1))
			{
				...
				if (vVar0.y > 0.7f)
				{
					unk_0xC6EB89C59F2AF6B8(0, sLocal_652, Local_421[iParam0 /*16*/].f_15, 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				else
				{
					unk_0xC6EB89C59F2AF6B8(0, sLocal_652, "avoid_rb", 8f, -4f, -1, 0, 0, 0, 0, 0);
				}
				unk_0xF96A174EE26D7588(0, iLocal_423, 0);
				unk_0x78A77CDD64392938(0, 1000);
				unk_0x96167B03C5A77156(0, Local_421[iParam0 /*16*/].f_9, 1f, 20000, 1048576000, 0, 1193033728);
				unk_0x75ABDC5F81978924(iLocal_617);
				unk_0x78ADC381772E3D54(Local_421[iParam0 /*16*/], iLocal_617);
				unk_0xF82EA857DA10E0CD(&iLocal_617);
...
int func_248()
{
	if (unk_0xE3614539F8B5C807(unk_0x16F2683693E537C9()))
	{
		if (!unk_0xC844350D5D58C99A(Local_441))
		{
			if (unk_0xB87F6CF6E5628C67(Local_441.f_2) && unk_0xB87F6CF6E5628C67(Local_441.f_3))
			{
				...
				Local_441.f_1 = unk_0x852A19533F896693(Local_441, 4, Local_441.f_3, -1, 1, true);
				unk_0x490CE125A7B7CD42(Local_441, 1);
		...
		if (!unk_0xC844350D5D58C99A(Local_442))
		{
			if (unk_0xB87F6CF6E5628C67(iLocal_437) && unk_0xB87F6CF6E5628C67(iLocal_432))
			{
				...
				Local_442.f_1 = unk_0x852A19533F896693(Local_442, 5, iLocal_432, -1, 1, true);
		...
		if (!unk_0xC844350D5D58C99A(Local_443))
		{
			if (unk_0xB87F6CF6E5628C67(iLocal_435) && unk_0xB87F6CF6E5628C67(iLocal_434))
			{
				...
				Local_443.f_1 = unk_0x852A19533F896693(Local_443, 4, iLocal_434, -1, 1, true);
		...
		if (!unk_0xC844350D5D58C99A(Local_445))
		{
			if (unk_0xB87F6CF6E5628C67(iLocal_436) && unk_0xB87F6CF6E5628C67(iLocal_432))
			{
				...
				{
					Local_445.f_1 = unk_0x852A19533F896693(Local_445, 4, iLocal_432, -1, 1, true);
		...
		if (!unk_0xC844350D5D58C99A(Local_446))
		{
			if (unk_0xB87F6CF6E5628C67(iLocal_435) && unk_0xB87F6CF6E5628C67(iLocal_434))
			{
				...
				{
					Local_446.f_1 = unk_0x852A19533F896693(Local_446, 4, iLocal_434, -1, 1, true);
					unk_0xAFF39FB306F8E232(Local_446.f_1, 17, true);
		...
		if (!unk_0xC844350D5D58C99A(Local_444))
		{
			if (unk_0xB87F6CF6E5628C67(iLocal_438) && unk_0xB87F6CF6E5628C67(iLocal_432))
			{
				...
				Local_444.f_1 = unk_0x852A19533F896693(Local_444, 4, iLocal_432, -1, 1, true);
	...
	if (!unk_0xC844350D5D58C99A(Local_447))
	{
		if (unk_0xB87F6CF6E5628C67(Local_447.f_2) && unk_0xB87F6CF6E5628C67(iLocal_434))
		{
			...
			{
				Local_447.f_1 = unk_0x852A19533F896693(Local_447, 4, iLocal_434, -1, 1, true);
	...
	if (!unk_0xC844350D5D58C99A(Local_448))
	{
		if (unk_0xB87F6CF6E5628C67(Local_448.f_2) && unk_0xB87F6CF6E5628C67(Local_448.f_3))
		{
			...
			{
				Local_448.f_1 = unk_0x852A19533F896693(Local_448, 4, Local_448.f_3, -1, 1, true);
	...
	if (!unk_0xC844350D5D58C99A(Local_449))
	{
		if (unk_0xB87F6CF6E5628C67(iLocal_437) && unk_0xB87F6CF6E5628C67(iLocal_434))
		{
			...
			{
				Local_449.f_1 = unk_0x852A19533F896693(Local_449, 4, iLocal_434, -1, 1, true);
...
void func_249()
{
	...
	unk_0xAE317D00A5A55DF6("NIGEL_1C_COLLAR", false, -1);
}
	...
	switch (iLocal_420)
	{
		case 0:
			...
			if (func_283(iLocal_423))
			{
				...
				unk_0xF44B0E19CAC31C33(0, sLocal_426, 0, 616, -1);
				unk_0x75ABDC5F81978924(iLocal_617);
				unk_0x78ADC381772E3D54(iLocal_423, iLocal_617);
				unk_0xF82EA857DA10E0CD(&iLocal_617);
			}
			if ((iLocal_674 != 1 && func_283(iLocal_422)) && func_283(iLocal_423))
			{
				...
				unk_0x96167B03C5A77156(0, vLocal_425, 2.2f, 20000, 1048576000, 0, 1193033728);
				unk_0xBC43ED9FE28DB191(0);
				unk_0xC6EB89C59F2AF6B8(0, sLocal_652, "IDLE_D", 2f, -8f, -1, 8193, 0, 0, 0, 0);
	...
	switch (iLocal_415)
	{
		...
		case 1:
			if (!unk_0x405E212DDE472467(unk_0x16F2683693E537C9(), 0))
			{
				...
				Var1.f_4 = 1f;
				Var1.f_5 = 0.5f;
				Var1.f_16 = unk_0x12AB0310C2281427("BONEMASK_HEAD_NECK_AND_L_ARM");
				Var1.f_20 = 48;
				Var1.f_21 = 1024;
		...
		case 3:
			...
			{
				unk_0x0C8C0C840C2D1AD2(iLocal_422, unk_0x16F2683693E537C9(), -1, 2050, 4);
				unk_0xDD353D0E9C789D0E(&iLocal_617);
				unk_0xF96A174EE26D7588(0, unk_0x16F2683693E537C9(), 0);
				unk_0xC6EB89C59F2AF6B8(0, sLocal_654, "gesture_easy_now", 8f, -8f, -1, 8, 0, 0, 0, 0);
				unk_0x75ABDC5F81978924(iLocal_617);
				unk_0x78ADC381772E3D54(iLocal_422, iLocal_617);
				unk_0xF82EA857DA10E0CD(&iLocal_617);
				iLocal_641 = 1;
...
void func_258()
{
	...
	{
		case 0:
			unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), iLocal_422, -1, 0, 2);
			if (!unk_0xE4EDC4B0E92C078B(iLocal_451))
			{
				unk_0x8B4C4CA774181102(2f, 10f, 1);
				iLocal_451 = func_252(iLocal_423, 1, 1, 5);
	...
	if (Global_76876 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x757EF87A33649210())
			{
				...
				Var4 = { func_264(Global_76877, Global_76879, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
void func_289()
{
	...
	{
		func_291(13, floor(Global_111638.f_10189.f_3853));
	}
...
int func_313(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_76434[1 /*14*/] = { func_143(iVar0, iParam1, uVar6[iParam1], -1) };
...
void func_318(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_319(&sVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
{
	return func_440(&(Global_105187.f_2890), vParam0, fParam1, 0);
}
