...
void func_3(var uParam0, int iParam1)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_5(Global_111638.f_18528[iVar0], &vVar2, &fVar3))
			{
...
struct<4> func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	...
	if ((((!func_111(&(Global_111638.f_19956), 8) && iParam1) && iParam0 != 4) && func_109(3) > 0) && unk_0x79833B02DBD2A244(0f, 1f) < 0.75f)
	{
		iVar1 = 8;
		*uParam3 = 4;
	}
