...
void func_209()
{
	...
	if (((((((Global_41431 == 15 && iLocal_37 != 3) && unk_0xEAE0D21A50E6C7F4(iLocal_49, 5)) && !func_169()) && Global_76619 == -1) && !func_219()) && !func_84(9)) || func_103(35))
	{
		func_218();
		func_217();
		switch (iLocal_39)
...
int func_232(int iParam0, int iParam1, bool bParam2)
{
	...
	else if (unk_0x8CD06866876216F2())
	{
		if (func_96() == 0)
		{
			return unk_0xEAE0D21A50E6C7F4(func_233(func_235(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
