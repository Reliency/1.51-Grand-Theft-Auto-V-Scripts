...
bool func_23(int iParam0)
{
	...
	return unk_0xEAE0D21A50E6C7F4(Global_1377170.f_241.f_136[func_25(10) /*33*/][iParam0], func_24(10));
}
...
void func_176(int iParam0, int iParam1, int iParam2)
{
	if (func_193())
	{
		...
		if (func_15(unk_0xD803B885F5E47A62()))
		{
			...
			Global_1590535[unk_0xD803B885F5E47A62() /*876*/].f_211.f_6 = func_180(iParam0, 1);
		}
	...
	else if (iParam0 == 168)
	{
		if (bParam1)
		{
			if (func_29(unk_0xD803B885F5E47A62()))
			{
				if (uParam2->f_5)
				{
					*iParam3 = (*iParam3 + func_275(Global_1628237[unk_0xD803B885F5E47A62() /*615*/].f_11.f_182));
				}
				else
				{
					*uParam4 = uParam2->f_7;
...
int func_516(int iParam0)
{
	...
	iVar0 = 2;
	bVar1 = ((func_426(iParam0) && !func_454(iParam0)) && !unk_0xEAE0D21A50E6C7F4(Global_1628237[iParam0 /*615*/].f_1, 8));
...
void func_532(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (unk_0xEAE0D21A50E6C7F4(Global_2425662[Global_2439138.f_1894.f_703.f_16 /*421*/].f_404, 0) && func_533())
		{
			iParam0 = 23;
		}
	}
