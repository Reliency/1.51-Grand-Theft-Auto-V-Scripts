			...
			if (Var0 == 22)
			{
				if (unk_0x75EECC9B0572F772())
				{
					if (func_198(Var0.f_28[1]))
					{
						...
						unk_0xA0A8D79ACBBD1CB8("MaryAnnes_Friend", Var0.f_28[1], 0);
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_198(unk_0x16F2683693E537C9()) && func_198(iParam0->f_28[0])) && !func_145()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam6) && func_194(unk_0x16F2683693E537C9(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
int func_195(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	...
	if (func_178(2))
	{
		if (!func_145())
		{
			if (((func_198(unk_0x16F2683693E537C9()) && func_198(iParam0->f_28[0])) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam6) && func_194(unk_0x16F2683693E537C9(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_193(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_191(&uVar0, cParam2, sParam3, 7, 0, 0);
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_216(unk_0x16F2683693E537C9(), uParam0->f_35[iVar0]))
							{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_28[0]))
			{
				...
				{
					unk_0x08841CDB215AE18F(uParam0->f_28[0], -915.6f, 6139.192f, 5.525f, 1, 0, 1);
					unk_0xC023D1C4BF532815(uParam0->f_28[0], 2.52f, 0f, 111.24f, 0, 0);
				}
				else
				{
					bVar2 = false;
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[0]))
			{
				...
				uParam0->f_41[0] = unk_0x7707E48765093646(iVar0[1], vVar3, true, true, false);
				unk_0x08841CDB215AE18F(uParam0->f_41[0], -916.6389f, 6137.046f, 4.7157f, 0, 0, 1);
				unk_0xC023D1C4BF532815(uParam0->f_41[0], 1.7f, 19.1067f, 79.515f, 0, 1);
				unk_0xC4C7FD0EF3FEAB0B(uParam0->f_41[0], -0.0949f, 0.1369f, 0.6325f, 0.7564f);
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[1]))
			{
				...
				uParam0->f_41[1] = unk_0x7707E48765093646(iVar0[2], vVar3, true, true, false);
				unk_0x1E9649458B15960F(uParam0->f_41[1], true);
				unk_0xC023D1C4BF532815(uParam0->f_41[1], -6.625818f, 1.30159f, -1.248891f, 0, 0);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[2]))
			{
				vVar3 = { -915.6122f, 6137.662f, 4.6129f };
				uParam0->f_41[2] = unk_0x7707E48765093646(iVar0[3], vVar3, true, true, false);
				unk_0x08841CDB215AE18F(uParam0->f_41[2], -915.6122f, 6137.662f, 4.6129f, 0, 0, 1);
				unk_0xC023D1C4BF532815(uParam0->f_41[2], -1.6843f, 2.1363f, -0.0913f, 0, 1);
				unk_0xC4C7FD0EF3FEAB0B(uParam0->f_41[2], -0.0147f, 0.0187f, -0.0011f, 0.9997f);
				unk_0x1E9649458B15960F(uParam0->f_41[2], true);
			}
			if (!unk_0xC844350D5D58C99A(uParam0->f_41[3]))
			{
				vVar3 = { -915.4199f, 6137.855f, 4.6221f };
				uParam0->f_41[3] = unk_0x7707E48765093646(iVar0[4], vVar3, true, true, false);
				unk_0x08841CDB215AE18F(uParam0->f_41[3], -915.4199f, 6137.855f, 4.6221f, 0, 0, 1);
				unk_0xC023D1C4BF532815(uParam0->f_41[3], -5.793f, 1.496f, -36.333f, 2, 1);
				unk_0xC4C7FD0EF3FEAB0B(uParam0->f_41[3], -0.0439f, 0.0281f, -0.312f, 0.9487f);
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_28[1]))
			{
				...
				if (func_198(uParam0->f_28[1]))
				{
					...
					unk_0x9A28E8CB86CD4694(uParam0->f_28[1], 0, 0, 0, false);
					unk_0x11AD11297DC58CC7(uParam0->f_28[1], true);
					unk_0x8B66ED74C2DC2E98(uParam0->f_28[1], 3.5f);
				}
				else
				{
					bVar2 = false;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				...
				{
					unk_0xC6A6B4DDD6DC073A(uParam0->f_35[iVar1], iVar1);
				}
				iVar1++;
			}
			...
			if (unk_0xB4AE0788C1587752("rcm_fanatic2"))
			{
				if (func_198(uParam0->f_28[1]))
				{
					unk_0xC6EB89C59F2AF6B8(uParam0->f_28[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
int func_255()
{
	...
	{
		unk_0x6DA3AC47D5DB9EED(joaat("prop_facgate_03_l"), 801.7148f, 1270.138f, 359.2855f, 1, 0f, 0);
		iVar0++;
	}
	if (unk_0xBF75E4DF4C367CD9(802.9195f, 1280.92f, 360.7272f, 6f, joaat("prop_facgate_03_r"), 0))
	{
		unk_0x6DA3AC47D5DB9EED(joaat("prop_facgate_03_r"), 802.9195f, 1280.92f, 360.7272f, 1, 0f, 0);
		iVar0++;
	}
	if (iVar0 == 2)
	{
