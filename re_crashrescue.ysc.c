...
void func_26()
{
	...
	switch (iLocal_53)
	{
		case 0:
			...
			{
				if (unk_0x16102BEDC7435774(iLocal_67) || unk_0x5A91F08DF773C39D(iLocal_67, vLocal_56, Global_22, false, true, 0))
				{
					func_208(1, 0, 1, 0);
...
void func_34()
{
	...
	{
		func_36(13, floor(Global_111638.f_10189.f_3853));
	}
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_107(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_90(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
void func_139(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_90(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (func_221())
			{
				...
				if (bLocal_244)
				{
					...
					else if (unk_0xB87D13D0C064E9D1(iLocal_68, unk_0x16F2683693E537C9(), 1) || func_214(iLocal_68, unk_0x16F2683693E537C9(), 1.25f, 1))
					{
						...
						unk_0xF3268524E9BE6D6E(iLocal_68, unk_0x16F2683693E537C9(), 500f, -1, 0, 0);
						unk_0xFADC0A217229F6B5(iLocal_68, true);
						bLocal_272 = true;
						iLocal_52 = 2;
						iLocal_269 = 0;
					}
					else if (unk_0x5A91F08DF773C39D(unk_0x16F2683693E537C9(), vLocal_56, Global_19, true, true, 0) || unk_0x3D1053F9EB43B7AD(unk_0x16F2683693E537C9(), 1722.09f, 3843f, 33.6f, 1740.11f, 3854.94f, 39.22f, 12f, 0, true, 0))
					{
						iLocal_52 = 1;
						iLocal_53 = 0;
					}
				...
				if (unk_0x0E0E6175453415CB(iLocal_67) && unk_0x0E0E6175453415CB(unk_0x16F2683693E537C9()))
				{
					if (!unk_0x7A649D473D0B6339(iLocal_67))
					{
						...
						if (unk_0xD1960163A3042274(iLocal_67, -2017877118) == 7)
						{
							unk_0xC6EB89C59F2AF6B8(iLocal_67, sLocal_256, "LOOP", 2f, -8f, -1, 1, 0, 0, 0, 0);
						}
					}
				}
			}
...
int func_221()
{
	...
	if (unk_0xBFDE4EE64C4BF2D6(iLocal_67, unk_0x5D08BBCCCC2F43A4(unk_0xD803B885F5E47A62())))
	{
		...
		else if (unk_0xE3614539F8B5C807(unk_0x16F2683693E537C9()))
		{
			...
			{
				if (unk_0xD1960163A3042274(iLocal_67, -828834893) == 7)
				{
					unk_0xA3BF0AA5A2608191(iLocal_67);
	...
	{
		if (unk_0x12DE711B1C681E9E(unk_0x16F2683693E537C9(), iLocal_67, Global_19, 0, 1, 0) && func_230())
		{
	...
	switch (iLocal_63)
	{
		...
		case 4:
			...
			if (iLocal_242)
			{
				...
				unk_0xBD453909DC26A85D(iLocal_67, -1871534317, false, 0, 0);
				unk_0xF895E10BF4C72645(unk_0x16F2683693E537C9(), 0, 0);
				unk_0xF895E10BF4C72645(iLocal_67, 0, 0);
			...
			else
			{
				if (!bLocal_243)
				{
					...
					unk_0xC6EB89C59F2AF6B8(unk_0x16F2683693E537C9(), sVar1, "idle_intro", 8f, -8f, -1, 0, 0, 0, 0, 0);
				}
				...
				switch (iLocal_60)
				{
					...
					case 1:
						if (!func_339())
						{
							...
							unk_0x0C8C0C840C2D1AD2(iLocal_67, unk_0x16F2683693E537C9(), -1, 0, 2);
...
int func_260()
{
	if (!unk_0xEB6A8945D1AC98A1(iLocal_67))
	{
		...
		if (unk_0x681F21BF9F7B449B(-1, unk_0x64430C979F516F7A(iLocal_67, 31086, 0f, 0f, 0f), 8f))
		{
			return 1;
		}
...
void func_261()
{
	...
	if (((((((((unk_0xB87F6CF6E5628C67(iLocal_246) && unk_0xB87F6CF6E5628C67(iLocal_248)) && unk_0xB87F6CF6E5628C67(iLocal_247)) && unk_0xB4AE0788C1587752(sLocal_249)) && unk_0x59F02DA2266A744C(sLocal_250)) && unk_0xB4AE0788C1587752(sLocal_253)) && unk_0xB4AE0788C1587752(sLocal_254)) && unk_0xB4AE0788C1587752(sLocal_255)) && unk_0xB4AE0788C1587752(sLocal_252)) && unk_0x25F7A4D42AF2AB93())
	{
		...
		unk_0xECC26BBDC0AD318B(vLocal_57.x, (vLocal_57.y + 0.1f), (vLocal_57.z + 0.1f), vLocal_57.x, (vLocal_57.y - 0.1f), (vLocal_57.z - 0.1f), 1, 1, joaat("weapon_assaultrifle"), 0, 1, 1, -1082130432);
		unk_0xC6EB89C59F2AF6B8(iLocal_67, sLocal_249, "BASE", 8f, -8f, -1, 9, 0, 0, 0, 0);
		if (func_25(iLocal_67))
		{
		...
		unk_0x3E8E48829F3C7624(iLocal_69, sLocal_252, "dead_ped", 1935.53f, 6291.888f, 41.144f, 0f, 0f, -28.44f, 1000f, -1000f, -1, 2102272, 0, 2, 0);
...
int func_262()
{
	...
	if (!unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (vmag2(unk_0x56E9E0FD5ACCD35D(unk_0x16F2683693E537C9())) > 1369f && !func_269())
		{
			return 0;
		}
	}
...
{
	return (shift_right(iParam0, 26) & 31 * func_292(unk_0xEAE0D21A50E6C7F4(iParam0, 31), -1, 1)) + 2011;
}
