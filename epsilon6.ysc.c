...
void __EntryFunction__()
{
	...
	if (func_478(Local_53.f_28[0]))
	{
		...
		unk_0x11AD11297DC58CC7(Local_62, 1);
		...
		case 1:
			...
			else
			{
				...
				if (func_239())
				{
					...
					{
						unk_0xDD353D0E9C789D0E(&uLocal_125);
						...
						unk_0x25644C31B4B6E9F3(uLocal_125, 1);
						unk_0x75ABDC5F81978924(uLocal_125);
						unk_0x78ADC381772E3D54(Local_61, uLocal_125);
						unk_0xF82EA857DA10E0CD(&uLocal_125);
						iLocal_70 = 2;
					}
					...
					switch (iLocal_111)
					{
						...
						case 2:
							...
							else
							{
								...
								{
									unk_0x56FDC9ADE35F7DB0(vLocal_54.x, true, 1, 0);
								}
								unk_0xF82EA857DA10E0CD(&uLocal_125);
								iLocal_111++;
							}
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar9 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0xF6900DA2D9CD7BC5(iParam3, 7, -1, 0, -1, func_97(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_75(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_75(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 1) || unk_0x1A5A491D253EA7BA(func_75(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0x1A5A491D253EA7BA(iParam3, -1757550583, 0) || unk_0x1A5A491D253EA7BA(func_75(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
void func_115(int iParam0, int iParam1, int iParam2, int iParam3)
{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0x232048AB4B0E0259(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var6;
					func_108(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0x1A5A491D253EA7BA(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		if (iParam3 != -1 && Global_76603)
		{
			...
			func_108(&(Global_76434[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0x1A5A491D253EA7BA(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
			return;
		}
		iVar13 = 0;
		iVar14 = unk_0xF6900DA2D9CD7BC5(iVar1, 7, -1, 0, -1, func_97(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
...
void func_182(int iParam0, int iParam1, int iParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_183(&sVar1, Var0.f_3, Global_98781, iParam1, iParam2);
	}
}
...
void func_242()
{
	if (func_478(Local_61))
	{
		...
		unk_0xF3268524E9BE6D6E(Local_61, unk_0x16F2683693E537C9(), 100f, -1, 0, 0);
	}
}
...
void func_270()
{
	switch (iLocal_69)
	{
		...
		case 5:
			if (!func_481(Local_59))
			{
				Local_59 = unk_0x122AAB0B1D6F55AD(Local_59.f_1, Local_59.f_3, Local_59.f_6, 1, 1, 0);
	...
	unk_0xAB8E2DDC7AF955E0(Local_59.f_1, 1);
	...
	switch (iLocal_69)
	{
		case 0:
			if (func_478(Local_62))
			{
				...
				unk_0xA47B46945FF6DE74(Local_62, -2881.755f, 3188.125f, 10.1136f, 1, 0, 0, 1);
		...
		case 1:
			...
			{
				unk_0xD8F6A53F4799FAFE(Local_62, 254.1723f);
				unk_0xA47B46945FF6DE74(Local_62, -2889.89f, 3198.69f, 10.11f, 1, 0, 0, 1);
				unk_0xA3BF0AA5A2608191(Local_62);
			}
			else
			{
...
void func_282()
{
	...
	unk_0x25C5402CC10F76CD(Local_62, false);
	unk_0xDD353D0E9C789D0E(&uLocal_125);
	unk_0x4AA5B7135D59B3E5(0, -2887.95f, 3194.88f, 10.06f, -2887.95f, 3194.88f, 10.06f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0xC6EB89C59F2AF6B8(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x4AA5B7135D59B3E5(0, -2888.92f, 3203.76f, 10.6f, -2888.92f, 3203.76f, 10.6f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0xC6EB89C59F2AF6B8(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x4AA5B7135D59B3E5(0, -2895.37f, 3199.37f, 10.03f, -2895.37f, 3199.37f, 10.03f, 1.2f, 0, 0.5f, 4f, 1, 0, 0, -957453492);
	unk_0xC6EB89C59F2AF6B8(0, "rcmepsilonism6", "cultist_idle_a", 2f, -2f, -1, 0, 0, 0, 0, 0);
	unk_0x25644C31B4B6E9F3(uLocal_125, 1);
	unk_0x75ABDC5F81978924(uLocal_125);
	unk_0x78ADC381772E3D54(Local_62, uLocal_125);
}
...
void func_283()
{
	switch (iLocal_69)
	{
		case 0:
			...
			vLocal_54.x = unk_0x122AAB0B1D6F55AD(iLocal_625, -2892.93f, 3192.37f, 11.66f, -132.35f, 0, 0, 0);
			...
			unk_0xB422445CBCD0AEFB(vLocal_54.x, 0);
			unk_0x44A200C9B6E1CEA6(vLocal_54.x, true);
			func_480(vLocal_54.x, 0);
		...
		case 2:
			...
			{
				vLocal_54.x = unk_0x122AAB0B1D6F55AD(iLocal_625, 595.7562f, 2926.42f, 173.2301f, 283.3833f, 0, 0, 0);
				unk_0xB9FD7450C0DAB575(vLocal_54.x, 1084227584);
				unk_0x2F625BED8BF7F26A(vLocal_54.x);
				unk_0xC002508A277213DE(vLocal_54.x, 157, 157);
				unk_0x58A0C35FA7CA6162(vLocal_54.x, 157, 5);
				...
				if (!func_268())
				{
					unk_0xF821F915BC24D246(unk_0x16F2683693E537C9(), vLocal_54.x, -1);
				}
				unk_0xB58CA658A628ED02(vLocal_54.x, 3);
				unk_0x1E9649458B15960F(vLocal_54.x, true);
		...
		case 4:
			...
			vLocal_54.x = unk_0x122AAB0B1D6F55AD(vLocal_54.y, 1684.78f, 3255.58f, 41.78f, 284.26f, 1, 1, 0);
			if (func_481(vLocal_54.x))
			{
				unk_0xB9FD7450C0DAB575(vLocal_54.x, 1084227584);
				unk_0x2F625BED8BF7F26A(vLocal_54.x);
		...
		case 5:
			...
			if (!bLocal_80)
			{
				...
				vLocal_54.x = unk_0x122AAB0B1D6F55AD(vLocal_54.y, 1674.91f, 3252.47f, 41.69f, 284.26f, 1, 1, 0);
				if (func_481(vLocal_54.x))
				{
					unk_0xB9FD7450C0DAB575(vLocal_54.x, 1084227584);
					unk_0x2F625BED8BF7F26A(vLocal_54.x);
	...
	unk_0xAB8E2DDC7AF955E0(vLocal_54.y, 1);
}
	...
	switch (iLocal_69)
	{
		...
		case 4:
			if (!func_478(Local_61))
			{
				...
				unk_0x11AD11297DC58CC7(Local_61, 1);
				...
				unk_0xC6EB89C59F2AF6B8(Local_61, Local_61.f_6, Local_61.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
			}
			else
			{
			...
			{
				iLocal_126 = unk_0x7707E48765093646(joaat("p_amb_phone_01"), unk_0x68F4C0EC296D3901(Local_61, true), 1, true, 0);
			}
			...
			if (!bLocal_80)
			{
				if (!func_478(Local_61))
				{
					...
					if (func_478(Local_61) && func_239())
					{
						...
						unk_0x5B1D360B9C6F0A09(0, vLocal_54.x, 20000, -1, 2f, 1, 0);
						unk_0x75ABDC5F81978924(uLocal_125);
						unk_0x78ADC381772E3D54(Local_61, uLocal_125);
						unk_0xF82EA857DA10E0CD(&uLocal_125);
					}
...
int func_329(var uParam0)
{
	if (!unk_0x437347B10A200C4B(unk_0x16F2683693E537C9(), 0) && !unk_0xEB6A8945D1AC98A1(unk_0x16F2683693E537C9()))
	{
		if (func_350())
		{
			*uParam0 = func_334(unk_0x68F4C0EC296D3901(unk_0x16F2683693E537C9(), false), 6, -1, 0, 1, -1);
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_394(1, 1093140480, 0))
			{
				...
				if (func_239())
				{
					unk_0xA47B46945FF6DE74(vLocal_54.x, 1674.91f, 3252.47f, 41.69f, 1, 0, 0, 1);
		...
		case 2:
			...
			{
				unk_0x51F8DBE54C75AE47(uLocal_124);
			}
...
void func_378()
{
	if (unk_0x3148AE92ED70DC30("ep_plane", 0))
	{
		...
		if (func_239())
		{
			unk_0xA47B46945FF6DE74(vLocal_54.x, 1684.78f, 3255.58f, 41.78f, 1, 0, 0, 1);
			unk_0xD8F6A53F4799FAFE(vLocal_54.x, 284.26f);
			unk_0xB9FD7450C0DAB575(vLocal_54.x, 1084227584);
		}
		else
...
void func_379()
{
	if (func_478(Local_61))
	{
		if (unk_0x3148AE92ED70DC30("Jimmy_Boston", 0))
		{
			...
			unk_0xBD453909DC26A85D(Local_61, -530524, 0, 1, 0);
		}
	}
}
...
int func_380()
{
	if (func_478(unk_0x16F2683693E537C9()))
	{
		if (unk_0x3148AE92ED70DC30("Michael", 0))
		{
			...
			unk_0x2FB9A57162E54BAB(0f);
			unk_0xEF6276132B396452(0f, 1065353216);
			unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_61, -1, 0, 2);
...
void func_400()
{
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_239())
			{
				unk_0x56FDC9ADE35F7DB0(vLocal_54.x, false, 0, 0);
			}
			if (!unk_0xE4EDC4B0E92C078B(Local_61.f_1))
			{
				Local_61.f_1 = func_287(Local_61, 1, 1, 9);
...
void func_402()
{
	if (func_238(unk_0x16F2683693E537C9(), Local_61, 1) <= 15f)
	{
		if (!unk_0x8E8B3399C8A28500())
		{
			if (!unk_0x07441E56330B63E3(uLocal_124))
			{
				func_521("Loading streamvol");
				uLocal_124 = unk_0x372C0B8361DDE4D6(1684.85f, 3276.16f, 39.93f, func_403(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
	...
	if (func_478(Local_61))
	{
		if (func_238(unk_0x16F2683693E537C9(), Local_61, 1) <= 15f)
		{
			if (!unk_0xC7E2E6167C09468B(Local_61, unk_0x16F2683693E537C9()))
			{
				...
				unk_0x0C8C0C840C2D1AD2(Local_61, unk_0x16F2683693E537C9(), -1, 2096, 2);
			}
		}
		...
		case 2:
			if (func_481(vLocal_54.x))
			{
				...
				else
				{
					...
					unk_0x56FDC9ADE35F7DB0(vLocal_54.x, true, 0, 0);
					unk_0x71EDC33E5A423750(vLocal_54.x, 1);
					iLocal_70 = 1;
				}
			}
	...
	switch (iLocal_73)
	{
			...
			if (iLocal_74 == 0)
			{
				if (func_478(Local_62))
				{
					...
					if (unk_0xD17F06053799A7CA())
					{
						...
						unk_0x0C8C0C840C2D1AD2(unk_0x16F2683693E537C9(), Local_62, -1, 0, 2);
						unk_0x0C8C0C840C2D1AD2(Local_62, unk_0x16F2683693E537C9(), -1, 0, 2);
		...
		case 3:
			if (iLocal_74 == 0)
			{
				...
				if (iLocal_102 == 0)
				{
					...
					{
						unk_0xA3BF0AA5A2608191(Local_62);
						unk_0xF9B5DB58254657F1(Local_62, -1, unk_0x16F2683693E537C9(), -1, 1);
					}
					iLocal_107 = -1;
					iLocal_74 = 1;
				}
		...
		case 5:
			if (iLocal_74 == 0)
			{
				...
				unk_0xF96A174EE26D7588(Local_62, unk_0x16F2683693E537C9(), -1);
				iLocal_74 = 1;
			}
			else if (iLocal_74 == 1)
			{
			...
			if (iLocal_74 == 0)
			{
				if (func_479(Local_62))
				{
					if (func_421(Local_62, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						...
						unk_0x96167B03C5A77156(0, -2884.934f, 3200.156f, 10.7036f, 1f, 20000, 1048576000, 0, 1193033728);
...
void func_425()
{
	...
	if (func_479(Local_62))
	{
		...
		unk_0xF3268524E9BE6D6E(Local_62, unk_0x16F2683693E537C9(), 500f, -1, 0, 0);
		func_16(&(Local_62.f_1));
	}
}
		...
		switch (iLocal_75)
		{
			...
			case 1:
				if (func_478(Local_62) && func_478(unk_0x16F2683693E537C9()))
				{
					...
					unk_0xDD353D0E9C789D0E(&uLocal_125);
					unk_0x0C8C0C840C2D1AD2(0, unk_0x16F2683693E537C9(), -1, 0, 2);
					unk_0x96167B03C5A77156(0, vLocal_628, 1f, 20000, 1048576000, 0, 1193033728);
					unk_0x75ABDC5F81978924(uLocal_125);
					unk_0x78ADC381772E3D54(Local_62, uLocal_125);
					unk_0xF82EA857DA10E0CD(&uLocal_125);
					iLocal_75 = 2;
	...
	if (func_478(Local_62))
	{
		switch (iLocal_76)
		{
			case 0:
				...
				{
					unk_0xC6EB89C59F2AF6B8(Local_62, "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_76 = 1;
			...
			case 1:
				...
				{
					unk_0x96167B03C5A77156(Local_62, vLocal_78[iLocal_77 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 3:
				unk_0xA3BF0AA5A2608191(Local_62);
				unk_0xC6EB89C59F2AF6B8(Local_62, "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
			...
			case 4:
				if (unk_0xB4ECF989E2C1DAC8(Local_62, "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (unk_0x8CA9406E01C7EE58(Local_62, "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						...
						unk_0xC6EB89C59F2AF6B8(Local_62, "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						unk_0xF895E10BF4C72645(Local_62, 0, 0);
						iLocal_76 = 1;
	...
	switch (iLocal_70)
	{
		case 0:
			...
			if (func_478(Local_62))
			{
				...
				unk_0xCEAA091B490F8407(iLocal_104, "DEVICE", unk_0x77E7AA9D423491DC(Local_62, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
				unk_0xCEAA091B490F8407(iLocal_105, "IDLE_BEEP_NPC", unk_0x77E7AA9D423491DC(Local_62, 1), "EPSILONISM_04_SOUNDSET", 0, 0);
			}
