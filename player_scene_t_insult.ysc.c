...
int func_2()
{
	...
	if (vdist(vVar2, vLocal_243) < 100f)
	{
		return 0;
	}
	iVar0 = 0;
		...
		switch (iLocal_234[iParam1])
		{
			case 0:
				if (unk_0xB4ECF989E2C1DAC8(iParam0, &Local_297, &(Local_307[iParam1 /*16*/]), 2))
				{
					...
					if (unk_0xDC2A248C2CB7B3DB(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&Local_297, &(Local_307[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						...
						if (fVar2 > fVar0)
						{
							...
							unk_0x96167B03C5A77156(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fVar3, -1, (fLocal_248[iParam1] * 0.1f), 0, 1193033728);
				...
				else
				{
					...
					if (unk_0xEA6BC48857E0AC4C(&(Local_308[iParam1 /*16*/])))
					{
						...
						unk_0x96167B03C5A77156(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
						iLocal_234[iParam1] = 1;
					}
					else
					{
			...
			case 1:
				...
				if (unk_0xD1960163A3042274(iParam0, 713668775) != 1)
				{
					...
					{
						fLocal_248[iParam1] = (vmag(vLocal_246[iParam1 /*3*/]) * 0.75f);
					}
					unk_0xA371FDC12D462090(iParam0, vLocal_243 + vLocal_246[iParam1 /*3*/], fLocal_248[iParam1], 1077936128, 1086324736);
		...
		if (unk_0x69DF961355195C3C(Global_96074))
		{
			...
			while (iVar0 < iLocal_233)
			{
				if (!unk_0xEB6A8945D1AC98A1(iLocal_233[iVar0]))
				{
					...
					unk_0x915804B434753CBD(iLocal_233[iVar0], Global_96074, &Local_297, &(Local_307[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_234[iVar0] = 0;
				}
				iVar0++;
			}
			...
			while (iVar0 < iLocal_239)
			{
				if (unk_0xC844350D5D58C99A(iLocal_239[iVar0]))
				{
					...
					{
						unk_0xE14EC663EED44AD5(iLocal_239[iVar0], Global_96074, &(Local_312[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (unk_0x69DF961355195C3C(Global_96073))
	{
		...
		while (iVar0 < iLocal_233)
		{
			if (!unk_0xEB6A8945D1AC98A1(iLocal_233[iVar0]))
			{
				unk_0x915804B434753CBD(iLocal_233[iVar0], Global_96073, &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_239)
		{
			if (unk_0xC844350D5D58C99A(iLocal_239[iVar0]))
			{
				...
				{
					unk_0xE14EC663EED44AD5(iLocal_239[iVar0], Global_96073, &(Local_311[iVar0 /*16*/]), &Local_297, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
...
void func_47()
{
	...
	while (iVar0 < iLocal_233)
	{
		if (iLocal_235[iVar0] != 0)
		{
			...
			unk_0xC6EB89C59F2AF6B8(iLocal_233[iVar0], &Local_297, &(Local_306[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_239)
	{
		if (iLocal_240[iVar0] != 0)
		{
			...
			if (!unk_0xEA6BC48857E0AC4C(&(Local_311[iVar0 /*16*/])))
			{
				unk_0xD65E6E13E145467B(iLocal_239[iVar0], &(Local_311[iVar0 /*16*/]), &Local_297, 8f, true, 0, 0, 0f, 0);
			}
		}
		iVar0++;
	}
