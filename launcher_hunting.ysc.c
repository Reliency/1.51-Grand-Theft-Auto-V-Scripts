...
int func_184(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_127(unk_0x16F2683693E537C9()) && func_127(iParam0->f_28[0])) && !func_146()) && (unk_0x1C0640BA9A7327B3() - iParam0->f_60) > iParam6) && func_188(unk_0x16F2683693E537C9(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
			...
			if (unk_0xC844350D5D58C99A(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_206(unk_0x16F2683693E537C9(), uParam0->f_35[iVar0]))
							{
...
int func_244(var uParam0)
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_243(&iVar0) || !func_245(&(uParam0->f_48))) || !unk_0xB4AE0788C1587752("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0xC844350D5D58C99A(uParam0->f_28[0]))
			{
				...
				{
					unk_0x262EF6C6306BEA6C(uParam0->f_28[0], joaat("weapon_sniperrifle"), 0, true, true);
				}
				else
				{
					bVar2 = false;
		...
		case 3:
			if (func_127(uParam0->f_28[0]))
			{
				unk_0x1F6FCCC72D02C71A(uParam0->f_28[0], joaat("weapon_sniperrifle"), joaat("component_at_ar_supp_02"));
				unk_0x4E885A246A9D983A(uParam0->f_28[0], 104, true);
				unk_0x5745EA6329A91E29(uParam0->f_28[0], joaat("weapon_sniperrifle"), true);
				if (unk_0xB4AE0788C1587752("special_ped@cletus@base"))
				{
					unk_0xC6EB89C59F2AF6B8(uParam0->f_28[0], "special_ped@cletus@base", "cletus_base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
			}
			...
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_HANG_OUT_STREET", 0);
			}
			if (unk_0x035491B0E495A4C1("WORLD_HUMAN_DRINKING"))
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_DRINKING", 0);
			}
			if (unk_0x035491B0E495A4C1("WORLD_HUMAN_SMOKING"))
			{
				unk_0xCD7D80FD792F9954("WORLD_HUMAN_SMOKING", 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
