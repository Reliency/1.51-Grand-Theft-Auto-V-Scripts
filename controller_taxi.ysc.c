					...
					if (iVar1 != 2)
					{
						if ((!unk_0xC8BC75555A67090D() && !bVar0) && !func_74(5))
						{
							...
							if (func_70())
							{
								...
								if (((unk_0x06F8112AA79C53D9(0, 86) && !unk_0x377BE9A1BF38C7CE(unk_0x16F2683693E537C9())) && !Global_30919) && (unk_0x1C0640BA9A7327B3() - iLocal_105) > 3000)
								{
									iVar4 = func_68();
									if (iVar4 == 0)
									{
